...
/** 聊天气泡：面试官靠左白卡细边、考生靠右深色卡（等宽字体便于代码）、system 居中 */
export function MessageBubble({ role, content }: { role: string; content: string }) {
  ...
  if (role === "candidate") {
    return (
      <div className="flex justify-end">
        <div className="max-w-[80%] rounded-2xl rounded-br-sm bg-ink px-4 py-2.5 text-white/95 shadow-soft">
          <div className="mb-1 text-[10px] uppercase tracking-wider text-white/50">考生</div>
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[80%] rounded-2xl rounded-bl-sm border border-line bg-white px-4 py-2.5 shadow-soft">

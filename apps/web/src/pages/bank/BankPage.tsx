...
import { Button, EmptyBox, ErrorBox, Loading, SegmentedControl } from "../../components/ui";
...
export default function BankPage() {
  ...
  return (
    <div className="itv">
      {/* 标题区：与首页同款 hero，操作按钮收纳于 hero-actions */}
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-eyebrow">面试 · 题库</div>
          <h1 className="hero-title">
            <span className="hero-title-accent">题库管理</span>
          </h1>
          <p className="hero-subtitle">维护题目或批量导入。</p>

      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <label className="block text-sm">
            <span className="mb-1 block text-xs text-muted">方向</span>
            <select
              value={category}
          ...
          <label className="block text-sm">
            <span className="mb-1 block text-xs text-muted">难度</span>
            <select
              value={difficulty}
        ...
        <label className="block text-sm">
          <span className="mb-1 block text-xs text-muted">题目内容 *</span>
          <textarea
            value={content}
        ...
        <label className="block text-sm">
          <span className="mb-1 block text-xs text-muted">预设追问（每行一条）</span>
          <textarea
            value={followUps}
        ...
        <label className="block text-sm">
          <span className="mb-1 block text-xs text-muted">考察要点</span>
          <textarea
            value={keyPoints}
        ...
        <div className="grid grid-cols-2 gap-3">
          <label className="block text-sm">
            <span className="mb-1 block text-xs text-muted">标签（逗号分隔）</span>
            <input value={tags} onChange={(e) => setTags(e.target.value)} className={inputCls} />
          </label>
          <label className="block text-sm">
            <span className="mb-1 block text-xs text-muted">来源</span>
            <input
              value={source}

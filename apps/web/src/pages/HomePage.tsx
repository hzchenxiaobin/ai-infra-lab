    ...
    <div className="itv">
      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-eyebrow">面试 · 组卷</div>
          <h1 className="hero-title">
            开始一场<span className="hero-title-accent">新面试</span>
          </h1>
          <p className="hero-subtitle">勾选方向、定好范围与题量，系统即刻为你生成一场限时问答。</p>
        </div>
      </section>
              ...
              {CATEGORIES.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    {active && (
                      <span className="absolute top-3 right-3 grid size-[18px] animate-pop-in place-items-center rounded-full bg-accent-600 text-page">

...
id: "lc:contest:505q4"
type: problem
title: "M 个非重叠子数组最大和 II"
tags: [前缀和, 动态规划, 单调队列, 线段树]
knowledge_points: [dynamic-programming, monotonic-queue, prefix-sum, segment-tree]
updated: 2026-09-03
source: contest
number: 3957
difficulty: hard
...
**题意**：与 Q3 完全相同的题意，但 `n` 从 1000 提升到 **10^5**。选择至少 1 个、至多 m 个互不重叠子数组，每个长度在 `[l, r]` 内，求最大和。
...
![单调队列窗口 [i-r,i-l] 维护 val 最大值](../../images/non_overlap_window.svg)
...
public:
    long long maximumSum(vector<int>& nums, int m, int l, int r) {
        ...
        // dp_prev 对应 j=0 层：选 0 个子数组时任意前缀和均为 0
        vector<long long> dp_prev(n + 1, 0), dp(n + 1, NEG_INF);

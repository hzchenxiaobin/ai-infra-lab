...
输出：5
解释：最长频率平衡子数组是 [2,1,2,3,3]（下标 2-6）。
...
`nums = [1,2,2,1,2,3,3,3]`，固定 `i=2`（值 2），向右扩展：

![频率平衡示例演算](../../images/freq_balance_example.svg)

| j | nums[j] | cnt | freq | keys | 平衡? | 长度 |
|---|---------|-----|------|------|-------|------|
| 2 | 2 | {2:1} | {1:1} | [1] | ✓(只一种元素) | 1 |
| 3 | 1 | {2:1,1:1} | {1:2} | [1] | ✗(freq[1]=2≠1) | - |
| 4 | 2 | {2:2,1:1} | {2:1,1:1} | [1,2] | ✓(2=2×1) | 3 |
| 5 | 3 | {2:2,1:1,3:1} | {2:1,1:2} | [1,2] | ✓(2=2×1) | 4 |
| 6 | 3 | {2:2,1:1,3:2} | {2:2,1:1} | [1,2] | ✓(2=2×1) | 5 |
| 7 | 3 | {2:2,1:1,3:3} | {2:1,1:1,3:1} | [1,2,3] | ✗(三个频率) | - |

最长平衡子数组从 `i=2` 扩展到 `j=6`（`[2,1,2,3,3]`），长度 5。✓

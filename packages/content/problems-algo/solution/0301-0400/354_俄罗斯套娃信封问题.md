...
type: problem
title: 俄罗斯套娃信封问题
tags: [LIS, 二分查找, 动态规划, 排序]
knowledge_points: [binary-search, dynamic-programming, lis, sorting]
updated: 2026-09-03
source: leetcode
number: 354
difficulty: hard
...
judge: none
related_learn: ["learn:w09d01", "learn:w09d07"]
---

# LeetCode 俄罗斯套娃信封问题 题解

## 1. 题目概述

- **标题 / 题号**：俄罗斯套娃信封问题（#354，hard）
- **链接**：https://leetcode.cn/problems/russian-doll-envelopes/
- **难度**：困难
- **标签**：动态规划、二分查找、排序、LIS

**题意**：给定二维整数数组 `envelopes`，`envelopes[i] = [wi, hi]` 表示信封的宽度和高度。当一个信封的宽和高**都大于**另一个信封时，可以套入。求**最多**能嵌套多少个信封（不允许旋转）。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 300 | [最长递增子序列](https://leetcode.cn/problems/longest-increasing-subsequence/)（[题解](../../contest/510/Q4.网格中保持一致的最大列数题解.md)） | 一维 LIS 模板题，本题的基础 |

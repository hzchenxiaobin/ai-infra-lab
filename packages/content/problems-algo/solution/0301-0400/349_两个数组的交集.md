...
type: problem
title: 两个数组的交集
tags: [二分查找, 双指针, 哈希表, 数组]
knowledge_points: [array, binary-search, hash-table, two-pointers]
updated: 2026-09-03
source: leetcode
number: 349
difficulty: easy
...
judge: none
related_learn: ["learn:w01d06", "learn:w01d07"]
---
...
- **标题 / 题号**：两个数组的交集（#349，easy）
- **链接**：https://leetcode.cn/problems/intersection-of-two-arrays/
- **难度**：简单
- **标签**：数组、哈希表、双指针、二分查找

**题意**：给定两个数组 `nums1` 和 `nums2`，返回它们的**交集**。输出结果中的每个元素一定是**唯一**的，不考虑输出顺序。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 350 | [两个数组的交集 II](https://leetcode.cn/problems/intersection-of-two-arrays-ii/) | 允许重复的交集，用 Counter 计数而非 set |
| 1 | [两数之和](https://leetcode.cn/problems/two-sum/)（[题解](../0001-0100/1_两数之和.md)） | 哈希表查存在的同类思路 |
| 2215 | [找出两数组的不同](https://leetcode.cn/problems/find-the-difference-of-two-arrays/) | 集合差集，与交集对称 |
| 2824 | [统计和小于目标的下标对数目](https://leetcode.cn/problems/count-pairs-whose-sum-is-less-than-target/) | 排序 + 双指针的同类模板 |

- [349 → 350 变式]：去重逻辑从 set 改为 Counter 是最常见面试追问
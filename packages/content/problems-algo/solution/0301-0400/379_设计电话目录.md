...
title: 设计电话目录
tags: [哈希, 数组, 设计, 队列]
knowledge_points: [array, design, hash-table, queue]
updated: 2026-09-03
source: leetcode
number: 379
difficulty: medium
...
- **标题 / 题号**：设计电话目录（#379，medium）
- **链接**：https://leetcode.cn/problems/design-phone-directory/
- **难度**：中等
- **标签**：设计、队列、数组、哈希

**题意**：设计一个电话号码目录，初始包含 `maxNumbers` 个号码 `0, 1, ..., maxNumbers - 1`。要求高效支持以下三种操作：
...
| 460 | [LFU 缓存](https://leetcode.cn/problems/lfu-cache/)（[题解](../0401-0500/460_LFU缓存.md)） | 频率桶 + 哈希的进阶设计题，对比本题的「单一 bool 数组 + 队列」与 LFU 的多层结构 |

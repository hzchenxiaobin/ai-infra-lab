...
type: problem
title: "二维区域和检索 - 矩阵可修改"
tags: [二维, 前缀和, 树状数组, 矩阵, 设计]
knowledge_points: [design, fenwick-tree, matrix, prefix-sum, 二维, 矩阵]
updated: 2026-09-03
source: leetcode
number: 308
difficulty: hard
...
# LeetCode 二维区域和检索 - 矩阵可修改 题解

## 1. 题目概述

- **标题 / 题号**：二维区域和检索 - 矩阵可修改（#308，hard）
- **链接**：https://leetcode.cn/problems/range-sum-query-2d-mutable/
- **难度**：困难
- **标签**：设计、树状数组、二维、矩阵、前缀和

**题意**：给定一个二维矩阵 `matrix`，要求实现 `NumMatrix` 类，支持**单点修改**与**多次**子矩阵求和查询：

...
type: problem
title: 重新安排行程
tags: [图, 堆, 欧拉路径, 深度优先搜索]
knowledge_points: [dfs, eulerian-path, graph, heap]
updated: 2026-09-03
source: leetcode
number: 332
difficulty: hard
...
- **标题 / 题号**：重新安排行程（#332，hard）
- **链接**：https://leetcode.cn/problems/reconstruct-itinerary/
- **难度**：困难
- **标签**：深度优先搜索、图、欧拉路径、堆

**题意**：给你一份航线机票列表 `tickets`，其中 `tickets[i] = [fromi, toi]` 表示飞机从 `fromi` 出发飞往 `toi`。所有机场用 3 个大写字母表示。
...
![示例1](https://assets.leetcode.com/uploads/2021/03/14/itinerary1-graph.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/03/14/itinerary2-graph.jpg)

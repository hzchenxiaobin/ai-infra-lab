...
type: problem
title: 矩阵中的最长递增路径
tags: [动态规划, 图, 拓扑排序, 深度优先搜索, 记忆化搜索]
knowledge_points: [dfs, dynamic-programming, graph, memoization, topological-sort]
updated: 2026-09-03
source: leetcode
number: 329
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/01/05/grid1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/01/27/tmp-grid.jpg)

...
title: 文件的最长绝对路径
tags: [字符串, 栈, 深度优先搜索]
knowledge_points: [dfs, stack, string]
updated: 2026-09-03
source: leetcode
number: 388
difficulty: medium
...
# LeetCode 文件的最长绝对路径 题解

## 1. 题目概述

- **标题 / 题号**：文件的最长绝对路径（#388，medium）
- **链接**：https://leetcode.cn/problems/longest-absolute-file-path/
- **难度**：中等
- **标签**：栈、深度优先搜索、字符串

**题意**：给定一个字符串 `input` 表示一个文件系统中所有文件和目录的**层级结构**。其中：
...
![示例1](https://assets.leetcode.com/uploads/2020/08/28/mdir.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/08/28/dir1.jpg)
...
![示例3](https://assets.leetcode.com/uploads/2020/08/28/dir2.jpg)

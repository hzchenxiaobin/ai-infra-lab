...
type: problem
title: 删除无效的括号
tags: [剪枝, 回溯, 字符串, 广度优先搜索]
knowledge_points: [backtracking, bfs, pruning, string]
updated: 2026-09-03
source: leetcode
number: 301
difficulty: hard
...
| 20 | [有效的括号](https://leetcode.cn/problems/valid-parentheses/)（[题解](../0001-0100/20_有效括号.md)） | 括号有效性判定的栈模板，本题 `is_valid` 函数的基础 |

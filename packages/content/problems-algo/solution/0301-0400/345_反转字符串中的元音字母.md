...
title: 反转字符串中的元音字母
tags: [双指针, 字符串]
knowledge_points: [string, two-pointers]
updated: 2026-09-03
source: leetcode
number: 345
difficulty: easy
...
# LeetCode 反转字符串中的元音字母 题解

## 1. 题目概述

- **标题 / 题号**：反转字符串中的元音字母（#345，easy）
- **链接**：https://leetcode.cn/problems/reverse-vowels-of-a-string/
- **难度**：简单
- **标签**：双指针、字符串

**题意**：给你一个字符串 `s`，仅**反转字符串中的所有元音字母**，并返回结果字符串。元音字母包括 `'a'`、`'e'`、`'i'`、`'o'`、`'u'`（大小写均算）。其余字符（辅音、符号等）保持原位不变。

...
type: problem
title: 最大二叉搜索子树
tags: [二叉搜索树, 二叉树, 动态规划, 后序遍历, 树, 深度优先搜索]
knowledge_points: [binary-tree, bst, dfs, dynamic-programming, postorder-traversal, tree]
updated: 2026-09-03
source: leetcode
number: 333
difficulty: medium
...
# LeetCode 最大二叉搜索子树 题解

## 1. 题目概述

- **标题 / 题号**：最大二叉搜索子树（#333，medium）
- **链接**：https://leetcode.cn/problems/largest-bst-subtree/
- **难度**：中等
- **标签**：树、二叉树、二叉搜索树、深度优先搜索、后序遍历、动态规划

**题意**：给定一棵二叉树的根节点 `root`，找出其**最大的二叉搜索子树**（largest BST subtree），并返回该子树的**节点数**。

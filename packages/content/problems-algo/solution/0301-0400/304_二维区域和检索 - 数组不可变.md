...
title: "二维区域和检索 - 数组不可变"
tags: [前缀和, 数组, 矩阵, 设计]
knowledge_points: [array, design, matrix, prefix-sum, 矩阵]
updated: 2026-09-03
source: leetcode
number: 304
difficulty: medium
...
# LeetCode 二维区域和检索 - 数组不可变 题解

## 1. 题目概述

- **标题 / 题号**：二维区域和检索 - 数组不可变（#304，medium）
- **链接**：https://leetcode.cn/problems/range-sum-query-2d-immutable/
- **难度**：中等
- **标签**：设计、数组、矩阵、前缀和

**题意**：给定一个二维矩阵 `matrix`，要求实现 `NumMatrix` 类，能够**多次**查询任意子矩阵的元素和：
...
![示例1](https://pic.leetcode.cn/1626332422-wUpUHT-image.png)

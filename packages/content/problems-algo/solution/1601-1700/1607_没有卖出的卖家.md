...
type: problem
title: 没有卖出的卖家
tags: ["IS NULL", "LEFT JOIN", "NOT EXISTS", "NOT IN 的 NULL 陷阱", "ORDER BY", SQL, "YEAR() vs BETWEEN 的可索引性（sargable）", "反连接（anti-join）", 数据库]
knowledge_points: [anti-join, database, is-null, left-join, not-exists, not-in-null-trap, not-in-的-null-陷阱, order-by, sql, year-vs-between-的可索引性-sargable]
updated: 2026-09-03
source: leetcode
number: 1607
difficulty: medium

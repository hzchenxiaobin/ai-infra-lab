...
title: 改变二叉树的根节点
tags: [二叉树, 指针操作, 树, 模拟]
knowledge_points: [binary-tree, pointer-manipulation, simulation, tree, 指针操作]
updated: 2026-09-03
source: leetcode
number: 1666
difficulty: medium
...
# LeetCode 改变二叉树的根节点 题解

## 1. 题目概述

- **标题 / 题号**：改变二叉树的根节点（#1666，medium）
- **链接**：https://leetcode.cn/problems/change-the-root-of-a-binary-tree/
- **难度**：中等
- **标签**：树、二叉树、指针操作、模拟

**题意**：给定一棵**带父指针**的二叉树的根节点 `root` 和一个叶节点 `leaf`，请更改这棵树，使 `leaf` 成为新的根节点。

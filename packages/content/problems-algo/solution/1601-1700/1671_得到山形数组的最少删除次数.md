...
type: problem
title: 得到山形数组的最少删除次数
tags: [二分查找, 动态规划, "最长递增子序列（LIS）", 贪心]
knowledge_points: [binary-search, dynamic-programming, greedy, 最长递增子序列-lis]
updated: 2026-09-03
source: leetcode
number: 1671
difficulty: hard
...
# LeetCode 得到山形数组的最少删除次数 题解

## 1. 题目概述

- **标题 / 题号**：得到山形数组的最少删除次数（#1671，hard）

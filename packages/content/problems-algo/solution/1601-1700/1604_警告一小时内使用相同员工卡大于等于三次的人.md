...
tags: [哈希表, 排序, 数组, 滑动窗口]
knowledge_points: [array, hash-table, sliding-window, sorting]
updated: 2026-09-03
source: leetcode
number: 1604
difficulty: medium
...
# LeetCode 警告一小时内使用相同员工卡大于等于三次的人 题解

## 1. 题目概述

- **标题 / 题号**：警告一小时内使用相同员工卡大于等于三次的人（#1604，medium）
- **链接**：https://leetcode.cn/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period/
- **难度**：中等
- **标签**：数组、哈希表、排序、滑动窗口

**题意**：力扣员工用员工卡开门，安保系统记录**名字**和**使用时间**。若一个员工在**一小时**内使用员工卡**大于等于三次**，系统自动发布**警告**。

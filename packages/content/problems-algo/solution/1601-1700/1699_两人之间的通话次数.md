...
type: problem
title: 两人之间的通话次数
tags: [COUNT, "GROUP BY", IF/CASE, LEAST/GREATEST, SQL, SUM, "UNION ALL", 双向归一化, 数据库]
knowledge_points: [case-when, count, database, group-by, if-case, least-greatest, sql, sum, union-all, 双向归一化]
updated: 2026-09-03
source: leetcode
number: 1699
difficulty: medium

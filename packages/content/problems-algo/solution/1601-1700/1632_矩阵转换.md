...
title: 矩阵转换
tags: [图, 并查集, 排序, 矩阵]
knowledge_points: [graph, matrix, sorting, union-find, 矩阵]
updated: 2026-09-03
source: leetcode
number: 1632
difficulty: hard
...
- **标题 / 题号**：矩阵转换（#1632，hard）
- **链接**：https://leetcode.cn/problems/rank-transform-of-a-matrix/
- **难度**：困难
- **标签**：并查集、图、矩阵、排序

**题意**：给定一个 $m \times n$ 的整数矩阵 `matrix`，将其中的每个元素替换为它的**秩**（rank）。秩是一个从 $1$ 开始的整数，需满足：
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/10/25/rank1.jpg)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/10/25/rank2.jpg)

...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/11/28/fig1.png)
...
![示例2](https://pic.leetcode.cn/1709608717-NVGojm-image.png)
...
| 82 | [删除排序链表中的重复元素 II](https://leetcode.cn/problems/remove-duplicates-from-sorted-list-ii/)（[题解](../0001-0100/82_删除排序链表中的重复元素II.md)） | 定位前驱 + 整段跳过重复组，按重复值而非下标定位区间 |
| 86 | [分隔链表](https://leetcode.cn/problems/partition-list/)（[题解](../0001-0100/86_分隔链表.md)） | 双子链尾插拼接，哑节点稳定分区 |

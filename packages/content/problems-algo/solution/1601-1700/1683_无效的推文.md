...
type: problem
title: 无效的推文
tags: [CHAR_LENGTH, "LENGTH 字节计数", SQL, "WHERE 过滤", 单表查询, 字符计数, 数据库]
knowledge_points: [char-length, database, length-字节计数, single-table-query, sql, where-filter, where-过滤, 单表查询, 字符计数]
updated: 2026-09-03
source: leetcode
number: 1683
difficulty: easy

...
type: problem
title: 字符串的不同子字符串个数
tags: [后缀数组, 哈希函数, 字典树, 字符串, 滚动哈希]
knowledge_points: [hash-function, rolling-hash, string, suffix-array, trie]
updated: 2026-09-03
source: leetcode
number: 1698
difficulty: medium
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 187 | [重复的 DNA 序列](https://leetcode.cn/problems/repeated-dna-sequences/)（[题解](../0101-0200/187_重复的DNA序列.md)） | 滚动哈希 + 固定窗口去重，与本文字符串哈希解法同源，对照理解「哈希去重」的滑动窗口变体 |

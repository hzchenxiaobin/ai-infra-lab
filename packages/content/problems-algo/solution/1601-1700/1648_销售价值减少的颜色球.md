...
type: problem
title: 销售价值减少的颜色球
tags: [二分查找, "堆（优先队列）", 数学, 数组, 贪心]
knowledge_points: [array, binary-search, greedy, heap, math]
updated: 2026-09-03
source: leetcode
number: 1648
difficulty: medium
...
# LeetCode 销售价值减少的颜色球 题解

## 1. 题目概述

- **标题 / 题号**：销售价值减少的颜色球（#1648，medium）
- **链接**：https://leetcode.cn/problems/sell-diminishing-valued-colored-balls/
- **难度**：中等
- **标签**：贪心、数组、数学、二分查找、堆（优先队列）

**题意**：你有一系列颜色的球，用整数数组 `inventory` 表示，其中 `inventory[i]` 是第 `i` 种颜色球的数量。同色球外观相同。
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/11/08/jj.gif)

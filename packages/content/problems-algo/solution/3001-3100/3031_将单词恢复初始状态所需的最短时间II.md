...
id: "lc:3031"
type: problem
title: "将单词恢复初始状态所需的最短时间 II"
tags: [哈希函数, 字符串, 字符串匹配, 滚动哈希]
knowledge_points: [hash-function, rolling-hash, string, string-matching]
updated: 2026-09-03
source: leetcode
number: 3031
difficulty: hard
...
# LeetCode 将单词恢复初始状态所需的最短时间 II 题解

## 1. 题目概述

- **标题 / 题号**：将单词恢复初始状态所需的最短时间 II（#3031，hard）

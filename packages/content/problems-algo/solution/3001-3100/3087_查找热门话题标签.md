...
type: problem
title: 查找热门话题标签
tags: ["GROUP BY 聚合", SQL, SUBSTRING_INDEX, "Top-K 排序", 字符串处理, 数据库]
knowledge_points: [database, group-by, group-by-聚合, sql, string-processing, substring-index, top-k-排序, 字符串处理]
updated: 2026-09-03
source: leetcode
number: 3087
difficulty: medium
...
# LeetCode 查找热门话题标签 题解

## 1. 题目概述

- **标题 / 题号**：查找热门话题标签（#3087，medium）

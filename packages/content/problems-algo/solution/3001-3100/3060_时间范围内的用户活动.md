...
type: problem
title: 时间范围内的用户活动
tags: ["LAG()", SQL, "TIMESTAMPDIFF()", 数据库, 窗口函数, 自连接]
knowledge_points: [database, lag, self-join, sql, timestampdiff, window-function]
updated: 2026-09-03
source: leetcode
number: 3060
difficulty: hard
...
# LeetCode 时间范围内的用户活动 题解

## 1. 题目概述

- **标题 / 题号**：时间范围内的用户活动（#3060，hard）

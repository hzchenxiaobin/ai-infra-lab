...
title: 最大节点价值之和
tags: [位运算, 动态规划, 树, 贪心]
knowledge_points: [bit-manipulation, dynamic-programming, greedy, tree]
updated: 2026-09-03
source: leetcode
number: 3068
difficulty: hard
...
# LeetCode 最大节点价值之和 题解

## 1. 题目概述

- **标题 / 题号**：最大节点价值之和（#3068，hard）
- **链接**：https://leetcode.cn/problems/find-the-maximum-sum-of-node-values/
- **难度**：困难
- **标签**：贪心、位运算、树、动态规划

**题意**：给定一棵 $n$ 个节点的**无向**树，节点编号 $0$ 到 $n-1$，边以数组 `edges` 给出。再给定**正**整数 $k$ 与非负整数数组 `nums`，其中 $nums[i]$ 是节点 $i$ 的**价值**。
...
![示例1](https://assets.leetcode.com/uploads/2023/11/09/screenshot-2023-11-10-012513.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/01/09/screenshot-2024-01-09-220017.png)
...
![示例3](https://assets.leetcode.com/uploads/2023/11/09/screenshot-2023-11-10-012641.png)

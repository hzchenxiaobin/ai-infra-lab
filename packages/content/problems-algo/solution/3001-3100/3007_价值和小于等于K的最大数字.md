...
tags: [二分查找, 位运算, 动态规划, 数学]
knowledge_points: [binary-search, bit-manipulation, dynamic-programming, math]
updated: 2026-09-03
source: leetcode
number: 3007
difficulty: medium
...
# LeetCode 价值和小于等于 K 的最大数字 题解

## 1. 题目概述

- **标题 / 题号**：价值和小于等于 K 的最大数字（#3007，medium）

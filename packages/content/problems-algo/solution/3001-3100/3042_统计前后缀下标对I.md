...
type: problem
title: "统计前后缀下标对 I"
tags: [字典树, 字符串, 字符串匹配, 数组]
knowledge_points: [array, string, string-matching, trie]
updated: 2026-09-03
source: leetcode
number: 3042
difficulty: easy
...
# LeetCode 统计前后缀下标对 I 题解

## 1. 题目概述

- **标题 / 题号**：统计前后缀下标对 I（#3042，easy）
- **链接**：https://leetcode.cn/problems/count-prefix-and-suffix-pairs-i/
- **难度**：简单
- **标签**：字符串、数组、字符串匹配、字典树

**题意**：给你一个下标从 **0** 开始的字符串数组 `words`。定义一个**布尔**函数 `isPrefixAndSuffix`，它接受两个字符串参数 `str1` 和 `str2`：

...
id: "lc:3032"
type: problem
title: 统计各位数字都不同的数字个数II
tags: [动态规划, 哈希表, 数学]
knowledge_points: [dynamic-programming, hash-table, math]
updated: 2026-09-03
source: leetcode
number: 3032
difficulty: easy
...
# LeetCode 统计各位数字都不同的数字个数II 题解

## 1. 题目概述

- **标题 / 题号**：统计各位数字都不同的数字个数II（#3032，easy）
...
**题意**：给你两个**正整数** `a` 和 `b`，返回**闭区间** `[a, b]` 内**各位数字都不同**的数字个数。

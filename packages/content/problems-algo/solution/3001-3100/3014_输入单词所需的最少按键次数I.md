...
id: "lc:3014"
type: problem
title: "输入单词所需的最少按键次数 I"
tags: [字符串, 数学, 贪心]
knowledge_points: [greedy, math, string]
updated: 2026-09-03
source: leetcode
number: 3014
difficulty: easy
...
# LeetCode 输入单词所需的最少按键次数 I 题解

## 1. 题目概述

- **标题 / 题号**：输入单词所需的最少按键次数 I（#3014，easy）
- **链接**：https://leetcode.cn/problems/minimum-number-of-pushes-to-type-word-i/
- **难度**：简单
- **标签**：贪心、数学、字符串

**题意**：给你一个字符串 `word`，由**互不相同**的小写英文字母组成。
...
![示例1](https://assets.leetcode.com/uploads/2023/12/26/keypaddesc.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/12/26/keypadv1e1.png)

...
tags: [动态规划, "区间 DP", 数组, 记忆化搜索]
knowledge_points: [array, dynamic-programming, interval-dp, memoization]
updated: 2026-09-03
source: leetcode
number: 3040
difficulty: medium
...
# LeetCode 相同分数的最大操作数目II 题解

## 1. 题目概述

- **标题 / 题号**：相同分数的最大操作数目 II（#3040，medium）
- **链接**：https://leetcode.cn/problems/maximum-number-of-operations-with-the-same-score-ii/
- **难度**：中等
- **标签**：数组、动态规划、记忆化搜索、区间 DP

**题意**：给你一个整数数组 `nums`（**至少**包含 2 个元素），每次可以执行以下三种操作中的**任意**一个：

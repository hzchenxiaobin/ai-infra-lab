...
type: problem
title: 最大化商品
tags: [CTE, "FLOOR 整除", IF/IFNULL, "MOD 取模", SQL, "SUM(IF)", "UNION ALL", 数据库, 条件聚合, "除零与 NULL 防御"]
knowledge_points: [conditional-aggregation, conditional-sum, cte, database, floor-整除, if-ifnull, mod-取模, sql, sum-if, union-all, 除零与-null-防御]
updated: 2026-09-03
source: leetcode
number: 3052
difficulty: hard

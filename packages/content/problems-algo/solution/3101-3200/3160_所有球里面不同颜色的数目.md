...
# LeetCode 所有球里面不同颜色的数目 题解

## 1. 题目概述

- **标题 / 题号**：所有球里面不同颜色的数目（#3160，medium）
- **链接**：https://leetcode.cn/problems/find-the-number-of-distinct-colors-among-the-balls/
- **难度**：中等
- **标签**：数组、哈希表、模拟

**题意**：给你一个整数 `limit` 和一个大小为 `n x 2` 的二维数组 `queries`。
...
![示例1](https://assets.leetcode.com/uploads/2024/04/17/ezgifcom-crop.gif)
...
![示例2](https://assets.leetcode.com/uploads/2024/04/17/ezgifcom-crop2.gif)

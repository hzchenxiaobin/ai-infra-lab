...
type: problem
title: "无效的推文 II"
tags: [CHAR_LENGTH, REGEXP, "REPLACE 差值计数", SQL, "WHERE 过滤", 单表查询, "多谓词 OR", 数据库]
knowledge_points: [char-length, database, regexp, replace-差值计数, single-table-query, sql, where-filter, where-过滤, 单表查询, 多谓词-or]
updated: 2026-09-03
source: leetcode
number: 3150
difficulty: easy

...
# LeetCode 包含所有 1 的最小矩形面积 I 题解

## 1. 题目概述

- **标题 / 题号**：包含所有 1 的最小矩形面积 I（#3195，medium）
- **链接**：https://leetcode.cn/problems/find-the-minimum-area-to-cover-all-ones-i/
- **难度**：中等
- **标签**：数组、矩阵

**题意**：给你一个二维**二进制**数组 `grid`。请你找出一个边在**水平方向**和**竖直方向**上、面积**最小**的矩形，并且满足 `grid` 中所有的 1 都在矩形的内部。

返回这个矩形可能的**最小**面积。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2024/05/08/examplerect0.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/05/08/examplerect1.png)

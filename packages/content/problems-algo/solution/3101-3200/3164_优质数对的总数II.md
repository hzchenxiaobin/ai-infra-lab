...
title: "优质数对的总数 II"
tags: [哈希表, 数组, 数论, 枚举]
knowledge_points: [array, enumeration, hash-table, number-theory]
updated: 2026-09-03
source: leetcode
number: 3164
difficulty: medium
...
# LeetCode 优质数对的总数 II 题解

## 1. 题目概述

- **标题 / 题号**：优质数对的总数 II（#3164，medium）
- **链接**：https://leetcode.cn/problems/find-the-number-of-good-pairs-ii/
- **难度**：中等
- **标签**：数组、哈希表、枚举、数论

**题意**：给你两个整数数组 `nums1` 和 `nums2`，长度分别为 `n` 和 `m`。同时给你一个**正整数** `k`。

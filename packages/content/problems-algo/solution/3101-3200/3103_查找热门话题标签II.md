...
type: problem
title: 查找热门话题标签II
tags: ["GROUP BY 聚合", REGEXP_SUBSTR, SQL, "Top-K 排序", 字符串处理, 数据库, "递归 CTE"]
knowledge_points: [database, group-by, group-by-聚合, recursive-cte, regexp-substr, sql, string-processing, top-k-排序, 字符串处理]
updated: 2026-09-03
source: leetcode
number: 3103
difficulty: hard

...
type: problem
title: 物块放置查询
tags: [二分查找, 数组, 有序集合, 树状数组, 线段树]
knowledge_points: [array, binary-search, fenwick-tree, ordered-set, segment-tree]
updated: 2026-09-03
source: leetcode
number: 3161
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2024/04/22/example0block.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/04/22/example1block.png)

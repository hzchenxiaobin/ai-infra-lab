...
type: problem
title: "查找得分最高的学生 II"
tags: [CTE, "GROUP BY + HAVING", "LEFT JOIN", SQL, 关系除法, 学分加权平均, 数据库, 条件聚合]
knowledge_points: [conditional-aggregation, cte, database, group-by-having, left-join, relational-division, sql, 学分加权平均]
updated: 2026-09-03
source: leetcode
number: 3188
difficulty: hard
...
# LeetCode 查找得分最高的学生 II 题解

## 1. 题目概述

- **标题 / 题号**：查找得分最高的学生 II（#3188，hard）

...
type: problem
title: "单面值组合的第 K 小金额"
tags: [二分查找, 位运算, 数学, 数组, 数论, 组合数学]
knowledge_points: [array, binary-search, bit-manipulation, combinatorics, math, number-theory]
updated: 2026-09-03
source: leetcode
number: 3116
difficulty: hard
...
# LeetCode 单面值组合的第 K 小金额 题解

## 1. 题目概述

- **标题 / 题号**：单面值组合的第 K 小金额（#3116，hard）
- **链接**：https://leetcode.cn/problems/kth-smallest-amount-with-single-denomination-combination/
- **难度**：困难
- **标签**：位运算、数组、数学、二分查找、组合数学、数论

**题意**：给你一个整数数组 `coins` 表示**不同面额**的硬币，另给你一个整数 `k`。你有无限量的每种面额的硬币，但是你**不能组合使用不同面额**的硬币。

...
type: problem
title: "发生在周五的交易 III"
tags: ["LEFT JOIN 补零", SQL, 数据库, 日期函数, 笛卡尔积, 维度骨架, "递归 CTE"]
knowledge_points: [cross-join, database, date-function, left-join-补零, recursive-cte, sql, 笛卡尔积, 维度骨架]
updated: 2026-09-03
source: leetcode
number: 3118
difficulty: medium
...
# LeetCode 发生在周五的交易 III 题解

## 1. 题目概述

- **标题 / 题号**：发生在周五的交易 III（#3118，medium）

...
type: problem
title: 最短路径中的边
tags: [图, "堆（优先队列）", 广度优先搜索, 最短路, 深度优先搜索]
knowledge_points: [bfs, dfs, graph, heap, shortest-path]
updated: 2026-09-03
source: leetcode
number: 3123
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2024/03/05/graph35drawio-1.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/03/05/graphhhh.png)

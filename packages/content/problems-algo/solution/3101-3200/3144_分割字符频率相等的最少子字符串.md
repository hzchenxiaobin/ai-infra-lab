...
tags: [动态规划, 哈希表, 字符串, 计数]
knowledge_points: [counting, dynamic-programming, hash-table, string]
updated: 2026-09-03
source: leetcode
number: 3144
difficulty: medium
...
# LeetCode 分割字符频率相等的最少子字符串 题解

## 1. 题目概述

- **标题 / 题号**：分割字符频率相等的最少子字符串（#3144，medium）
- **链接**：https://leetcode.cn/problems/minimum-substring-partition-of-equal-character-frequency/
- **难度**：中等
- **标签**：哈希表，字符串，动态规划，计数

**题意**：给你一个字符串 `s`，需要将它分割成**一个或更多**个**平衡**子字符串。**平衡**字符串的定义：字符串中**所有字符出现的次数都相同**。

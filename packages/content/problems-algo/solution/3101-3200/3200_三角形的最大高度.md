...
title: 三角形的最大高度
tags: [数组, 枚举]
knowledge_points: [array, enumeration]
updated: 2026-09-03
source: leetcode
number: 3200
difficulty: easy
...
# LeetCode 三角形的最大高度 题解

## 1. 题目概述

- **标题 / 题号**：三角形的最大高度（#3200，easy）
- **链接**：https://leetcode.cn/problems/maximum-height-of-a-triangle/
- **难度**：简单
- **标签**：数组、枚举

**题意**：给你两个整数 `red` 和 `blue`，分别表示红球和蓝球的数量。你需要用这些球来构成一个三角形：第 1 行有 1 个球，第 2 行有 2 个球，第 3 行有 3 个球，依此类推。
...
![示例1](https://assets.leetcode.com/uploads/2024/06/16/brb.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/06/16/br.png)
...
![示例3](https://assets.leetcode.com/uploads/2024/06/16/br.png)

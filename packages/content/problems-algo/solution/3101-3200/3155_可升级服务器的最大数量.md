...
title: 可升级服务器的最大数量
tags: [二分查找, 数学, 数组]
knowledge_points: [array, binary-search, math]
updated: 2026-09-03
source: leetcode
number: 3155
difficulty: medium
...
# LeetCode 可升级服务器的最大数量 题解

## 1. 题目概述

- **标题 / 题号**：可升级服务器的最大数量（#3155，medium）
...
**题意**：给你四个下标从 0 开始、长度均为 $n$ 的整数数组 `count`、`upgrade`、`sell` 和 `money`。
...
| 2226 | [每个小孩最多能分到多少糖果](https://leetcode.cn/problems/maximum-candies-allocated-to-k-children/)（[站内题解](../2201-2300/2226_每个小孩最多能分到多少糖果.md)） | 二分答案 + 「每堆取 min」计数验证，check 同为一个不等式 |

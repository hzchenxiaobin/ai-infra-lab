...
type: problem
title: 计算停车费与时长
tags: ["GROUP BY", ROUND, SQL, TIMESTAMPDIFF, 加权平均, 数据库, 聚合]
knowledge_points: [aggregation, database, group-by, round, sql, timestampdiff, weighted-average, 加权平均]
updated: 2026-09-03
source: leetcode
number: 3166
difficulty: medium
...
# LeetCode 计算停车费与时长 题解

## 1. 题目概述

- **标题 / 题号**：计算停车费与时长（#3166，medium）

...
type: problem
title: "最小分割分数 II"
tags: [二分查找, 前缀和, 动态规划, "带权二分（Aliens trick）", "斜率优化（Convex Hull Trick）"]
knowledge_points: [binary-search, dynamic-programming, prefix-sum, 带权二分-aliens-trick, 斜率优化-convex-hull-trick]
updated: 2026-09-03
source: leetcode
number: 3929
difficulty: hard
...
# LeetCode 最小分割分数 II 题解

## 1. 题目概述

- **标题 / 题号**：最小分割分数 II（#3929，hard）
- **链接**：https://leetcode.cn/problems/minimum-partition-score-ii/
- **难度**：困难
...
**题意**：给你一个整数数组 `nums` 和一个整数 `k`。你的任务是将 `nums` 分割成**恰好** $k$ 个子数组，返回所有有效分割方案中**最小可能的分数**。

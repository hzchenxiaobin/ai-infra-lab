...
tags: ["WQS 二分（带权二分）", 二分查找, 前缀和, 动态规划, 单调队列, 滑动窗口]
knowledge_points: [binary-search, dynamic-programming, monotonic-queue, prefix-sum, sliding-window, wqs-binary-search]
updated: 2026-09-03
source: leetcode
number: 3957
difficulty: hard

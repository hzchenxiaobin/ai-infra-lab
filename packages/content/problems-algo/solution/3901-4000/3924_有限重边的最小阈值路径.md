...
type: problem
title: 有限重边的最小阈值路径
tags: [二分查找, 图, 广度优先搜索, "最短路（0-1 BFS）"]
knowledge_points: [bfs, binary-search, graph, 最短路-0-1-bfs]
updated: 2026-09-03
source: leetcode
number: 3924
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2025/10/13/g6.png)
...
![示例2](https://assets.leetcode.com/uploads/2025/10/12/g3_f.png)
...
![示例3](https://assets.leetcode.com/uploads/2025/10/12/g5.png)

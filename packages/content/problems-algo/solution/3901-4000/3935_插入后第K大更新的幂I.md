...
id: "lc:3935"
type: problem
title: "插入后第 K 大更新的幂 I"
tags: ["堆（优先队列）", 快速幂, 排序, 数学, 有序集合]
knowledge_points: [fast-power, heap, math, ordered-set, sorting]
updated: 2026-09-03
source: leetcode
number: 3935
difficulty: medium
...
# LeetCode 插入后第 K 大更新的幂 I 题解

## 1. 题目概述

- **标题 / 题号**：插入后第 K 大更新的幂 I（#3935，medium）
- **链接**：https://leetcode.cn/problems/power-update-after-k-th-largest-insertion-i/
- **难度**：中等

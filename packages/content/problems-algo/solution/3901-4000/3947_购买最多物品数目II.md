...
title: 购买最多物品数目II
tags: [排序, 数组, 计数, 贪心]
knowledge_points: [array, counting, greedy, sorting]
updated: 2026-09-03
source: leetcode
number: 3947
difficulty: medium
...
# LeetCode 购买最多物品数目II 题解

## 1. 题目概述

- **标题 / 题号**：购买最多物品数目II（#3947，medium）
- **链接**：https://leetcode.cn/problems/maximum-number-of-items-from-sale-ii/
- **难度**：中等
- **标签**：贪心、数组、排序、计数

**题意**：给你一个二维整数数组 `items`，其中 `items[i] = [factor_i, price_i]` 表示下标为 `i` 的物品；再给你一个整数 `budget`。

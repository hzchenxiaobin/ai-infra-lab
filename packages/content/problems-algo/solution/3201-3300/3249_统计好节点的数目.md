...
# LeetCode 统计好节点的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计好节点的数目（#3249，medium）
- **链接**：https://leetcode.cn/problems/count-the-number-of-good-nodes/
- **难度**：中等
- **标签**：树、深度优先搜索

**题意**：给你一棵**无向**树，包含 $n$ 个节点，按 $0$ 到 $n-1$ 标记，根节点为 $0$。边数组 `edges` 长度为 $n-1$，其中 `edges[i] = [ai, bi]` 表示节点 $a_i$ 与 $b_i$ 之间存在一条边。
...
![示例1](https://assets.leetcode.com/uploads/2024/05/26/tree1.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/06/03/screenshot-2024-06-03-193552.png)
...
![示例3](https://assets.leetcode.com/uploads/2024/08/08/rob.jpg)

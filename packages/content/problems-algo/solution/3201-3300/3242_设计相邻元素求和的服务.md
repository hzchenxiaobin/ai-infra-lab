...
type: problem
title: 设计相邻元素求和的服务
tags: [哈希表, 数组, 模拟, 矩阵, 设计]
knowledge_points: [array, design, hash-table, matrix, simulation, 矩阵]
updated: 2026-09-03
source: leetcode
number: 3242
difficulty: easy
...
# LeetCode 设计相邻元素求和的服务 题解

## 1. 题目概述

- **标题 / 题号**：设计相邻元素求和的服务（#3242，easy）
- **链接**：https://leetcode.cn/problems/design-neighbor-sum-service/
- **难度**：简单
- **标签**：设计、数组、哈希表、矩阵、模拟

**题意**：给你一个 $n \times n$ 的二维数组 `grid`，包含范围 $[0, n^2-1]$ 内**互不相同**的元素。实现 `neighborSum` 类：
...
![示例1](https://assets.leetcode.com/uploads/2024/06/24/design.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/06/24/designexample0.png)

...
type: problem
title: 奇数和偶数交易
tags: ["CASE WHEN", "GROUP BY", "MOD()", SQL, "SUM()", 位运算, 数据库, 条件聚合, 聚合]
knowledge_points: [aggregation, bit-manipulation, case-when, conditional-aggregation, database, group-by, mod, sql, sum]
updated: 2026-09-03
source: leetcode
number: 3220
difficulty: medium

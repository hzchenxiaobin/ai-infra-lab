...
id: "lc:3215"
type: problem
title: "用偶数异或设置位计数三元组 II"
tags: [位运算, 数组, 计数]
knowledge_points: [array, bit-manipulation, counting]
updated: 2026-09-03
source: leetcode
number: 3215
difficulty: medium
...
# LeetCode 用偶数异或设置位计数三元组 II 题解

## 1. 题目概述

- **标题 / 题号**：用偶数异或设置位计数三元组 II（#3215，medium）
...
**题意**：给你三个整数数组 `a`、`b`、`c`。统计满足 **`a[i] XOR b[j] XOR c[k]` 的二进制表示中 1 的个数为偶数** 的三元组 `(i, j, k)` 的数量。

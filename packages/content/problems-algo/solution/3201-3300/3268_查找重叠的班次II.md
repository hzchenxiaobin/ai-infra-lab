...
type: problem
title: "查找重叠的班次 II"
tags: [LEAD, SQL, TIMESTAMPDIFF, 区间重叠, 扫描线, 数据库, 窗口函数, 自连接]
knowledge_points: [database, interval-overlap, lead, self-join, sql, sweep-line, timestampdiff, window-function, 区间重叠]
updated: 2026-09-03
source: leetcode
number: 3268
difficulty: hard

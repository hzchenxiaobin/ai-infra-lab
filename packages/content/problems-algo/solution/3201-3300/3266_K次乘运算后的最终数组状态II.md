...
id: "lc:3266"
type: problem
title: K次乘运算后的最终数组状态II
tags: ["堆（优先队列）", 数学, 数组, 模拟]
knowledge_points: [array, heap, math, simulation]
updated: 2026-09-03
source: leetcode
number: 3266
difficulty: hard
...
# LeetCode K次乘运算后的最终数组状态II 题解

## 1. 题目概述

- **标题 / 题号**：K次乘运算后的最终数组状态II（#3266，hard）
- **链接**：https://leetcode.cn/problems/final-array-state-after-k-multiplication-operations-ii/
- **难度**：困难
- **标签**：数组、堆（优先队列）、模拟、数学

**题意**：给你一个整数数组 `nums`、一个整数 `k` 和一个整数 `multiplier`。

...
type: problem
title: 客户购买行为分析
tags: [CTE, "GROUP BY", JOIN, "ROW_NUMBER()", SQL, "Top-N per group", 两级聚合, 数据库, 窗口函数]
knowledge_points: [cte, database, group-by, join, row-number, sql, top-n-per-group, window-function, 两级聚合]
updated: 2026-09-03
source: leetcode
number: 3230
difficulty: medium
...
# LeetCode 客户购买行为分析 题解

## 1. 题目概述

- **标题 / 题号**：客户购买行为分析（#3230，medium）

...
tags: ["Z 函数", 动态规划, 字典树, 字符串匹配, 贪心]
knowledge_points: [dynamic-programming, greedy, string-matching, trie, z-function]
updated: 2026-09-03
source: leetcode
number: 3291
difficulty: medium
...
# LeetCode 形成目标字符串需要的最少字符串数 I 题解

- **关联**：3292（版本 II）是本题的数据加强版，解法一脉相承

## 1. 题目概述

- **标题 / 题号**：形成目标字符串需要的最少字符串数 I（#3291，medium）

...
type: problem
title: 最长合法子字符串的长度
tags: [哈希表, 字符串, 数组, 滑动窗口]
knowledge_points: [array, hash-table, sliding-window, string]
updated: 2026-09-03
source: leetcode
number: 2781
difficulty: hard
...
# LeetCode 最长合法子字符串的长度 题解

## 1. 题目概述

- **标题 / 题号**：最长合法子字符串的长度（#2781，hard）
- **链接**：https://leetcode.cn/problems/length-of-the-longest-valid-substring/
- **难度**：困难
- **标签**：数组、哈希表、字符串、滑动窗口

**题意**：给你一个字符串 `word` 和一个字符串数组 `forbidden`。

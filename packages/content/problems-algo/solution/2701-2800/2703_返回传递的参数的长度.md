...
type: problem
title: 返回传递的参数的长度
tags: [JavaScript, "arguments 对象", 剩余参数, 可变参数函数]
knowledge_points: [arguments-对象, javascript, 剩余参数, 可变参数函数]
updated: 2026-09-03
source: leetcode
number: 2703
difficulty: easy

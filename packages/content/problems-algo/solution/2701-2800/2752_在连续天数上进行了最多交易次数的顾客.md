...
id: "lc:2752"
type: problem
title: 在连续天数上进行了最多交易次数的顾客
tags: [CTE, DATE_SUB, "Gaps and Islands", INTERVAL, "ROW_NUMBER()", SQL, 数据库, 窗口函数]
knowledge_points: [cte, database, date-sub, gaps-and-islands, interval, row-number, sql, window-function]
updated: 2026-09-03
source: leetcode
number: 2752
difficulty: hard

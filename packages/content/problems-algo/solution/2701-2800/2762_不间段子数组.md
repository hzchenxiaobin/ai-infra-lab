...
type: problem
title: 不间段子数组
tags: [单调队列, "堆（优先队列）", 数组, 滑动窗口]
knowledge_points: [array, heap, monotonic-queue, sliding-window]
updated: 2026-09-03
source: leetcode
number: 2762
difficulty: medium
...
- **标题 / 题号**：不间段子数组（#2762，medium）
- **链接**：https://leetcode.cn/problems/continuous-subarrays/
- **难度**：中等
- **标签**：数组、滑动窗口、单调队列、堆（优先队列）

**题意**：给定一个下标从 **0** 开始的整数数组 `nums`。如果 `nums` 的一个子数组满足以下条件，则称其为**不间段**的：

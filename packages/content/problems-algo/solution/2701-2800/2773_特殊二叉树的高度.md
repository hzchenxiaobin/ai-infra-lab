...
# LeetCode 特殊二叉树的高度 题解

## 1. 题目概述

- **标题 / 题号**：特殊二叉树的高度（#2773，medium）
...
**题意**：给定一棵「特殊二叉树」的根节点 `root`，返回这棵树的**高度**（从根到最远叶子路径上的节点数；单个叶子高度为 `1`，与 [104. 二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/) 的约定一致）。

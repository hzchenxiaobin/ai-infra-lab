...
type: problem
title: 从两个数组中创建对象
tags: ["zip 配对", 对象, 数组, 键转换]
knowledge_points: [array, object, zip-配对, 对象, 键转换]
updated: 2026-09-03
source: leetcode
number: 2794
difficulty: easy
...
| 2625 | [扁平化嵌套数组](https://leetcode.cn/problems/flatten-deeply-nested-array/)（[题解](../2601-2700/2625_扁平化嵌套数组.md)） | 沿数组递归扁平化，同属「30 天 JS」家族，对照"数组下标 vs 对象键"两种索引维度 |

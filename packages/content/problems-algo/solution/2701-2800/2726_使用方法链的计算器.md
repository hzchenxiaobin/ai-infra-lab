...
type: problem
title: 使用方法链的计算器
tags: ["Fluent Interface", JavaScript, 方法链, 类设计, 面向对象]
knowledge_points: [fluent-interface, javascript, 方法链, 类设计, 面向对象]
updated: 2026-09-03
source: leetcode
number: 2726
difficulty: easy
...
# LeetCode 使用方法链的计算器 题解

## 1. 题目概述

- **标题 / 题号**：使用方法链的计算器（#2726，easy）
- **链接**：https://leetcode.cn/problems/calculator-with-method-chaining/
- **难度**：简单
- **标签**：JavaScript、类设计、方法链、Fluent Interface、面向对象

**题意**：设计一个 `Calculator` 类，提供加法、减法、乘法、除法和乘方等数学运算，并支持**连续操作的方法链式调用**。构造函数接受一个数字作为 `result` 的初始值。

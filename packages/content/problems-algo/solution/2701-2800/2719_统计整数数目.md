...
type: problem
title: 统计整数数目
tags: [动态规划, 字符串, "数位 DP", 数学]
knowledge_points: [digit-dp, dynamic-programming, math, string]
updated: 2026-09-03
source: leetcode
number: 2719
difficulty: hard
...
- **标题 / 题号**：统计整数数目（#2719，hard）
- **链接**：https://leetcode.cn/problems/count-of-integers/
- **难度**：困难
- **标签**：数学、字符串、动态规划、数位 DP

**题意**：给定两个**数字字符串** `num1`、`num2`，以及两个整数 `min_sum`、`max_sum`。如果一个整数 $x$ 满足：

...
title: 使数组中的所有元素都等于零
tags: [前缀和, 差分数组, 数组, 贪心]
knowledge_points: [array, difference-array, greedy, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 2772
difficulty: medium
...
# LeetCode 使数组中的所有元素都等于零 题解

## 1. 题目概述

- **标题 / 题号**：使数组中的所有元素都等于零（#2772，medium）
- **链接**：https://leetcode.cn/problems/apply-operations-to-make-all-array-elements-equal-to-zero/
- **难度**：中等
- **标签**：数组、前缀和、差分数组、贪心

**题意**：给你一个下标从 **0** 开始的整数数组 `nums` 和一个正整数 `k`。你可以对数组执行下述操作 **任意次**：

...
type: problem
title: 计算足够大的节点数
tags: [二叉树, 分治, 树, 深度优先搜索]
knowledge_points: [binary-tree, dfs, divide-and-conquer, tree]
updated: 2026-09-03
source: leetcode
number: 2792
difficulty: hard
...
# LeetCode 计算足够大的节点数 题解

## 1. 题目概述

- **标题 / 题号**：计算足够大的节点数（#2792，hard）
...
**题意**：给定一棵二叉树的根节点 `root` 和一个正整数 `k`。我们称一个节点**「足够大（great enough）」**，当且仅当：

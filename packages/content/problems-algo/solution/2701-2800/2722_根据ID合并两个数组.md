...
title: "根据 ID 合并两个数组"
tags: [哈希表, 对象合并, 排序, 数组]
knowledge_points: [array, hash-table, sorting, 对象合并]
updated: 2026-09-03
source: leetcode
number: 2722
difficulty: medium
...
| 2700 | [两个对象之间的差异](https://leetcode.cn/problems/differences-between-two-objects/)（[题解](../2601-2700/2700_两个对象之间的差异.md)） | 递归求两对象的键值差异，与本题「合并两对象」互为逆操作——一合分一差异 |

...
type: problem
title: 超过5名学生的课
tags: [COUNT, DISTINCT, "GROUP BY", HAVING, SQL, 聚合]
knowledge_points: [aggregation, count, distinct, group-by, having, sql]
updated: 2026-09-03
source: leetcode
number: 596
difficulty: easy
...
# LeetCode 超过5名学生的课 题解

## 1. 题目概述

- **标题 / 题号**：超过5名学生的课（#596，easy）
- **链接**：https://leetcode.cn/problems/classes-more-than-5-students/
- **难度**：简单
- **标签**：SQL、聚合、GROUP BY、HAVING、COUNT、DISTINCT

**题意**：给定 `Courses` 表，每行记录一名学生 (`student`) 及其选修的课程 (`class`)。编写 SQL 查询，报告**所有至少有 5 名学生**的课程。

...
judge: none
related_learn: ["learn:w10d02", "learn:w10d07"]
---
...
- **标题 / 题号**：省份数量（#547，medium）
- **链接**：https://leetcode.cn/problems/number-of-provinces/
- **难度**：中等
- **标签**：并查集、深度优先搜索、图

**题意**：有 `n` 个城市，其中一些彼此相连，另一些没有相连。如果城市 `a` 与城市 `b` 直接相连，且城市 `b` 与城市 `c` 直接相连，那么城市 `a` 与城市 `c` **间接相连**。
...
![示例1](https://assets.leetcode.com/uploads/2020/12/24/graph1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/12/24/graph2.jpg)

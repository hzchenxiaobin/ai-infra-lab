...
title: 标签验证器
tags: [字符串, 栈, 模拟, 规则校验]
knowledge_points: [simulation, stack, string, 规则校验]
updated: 2026-09-03
source: leetcode
number: 591
difficulty: hard
...
- **标题 / 题号**：标签验证器（#591，hard）
- **链接**：https://leetcode.cn/problems/tag-validator/
- **难度**：困难
- **标签**：字符串、栈、模拟、规则校验

**题意**：给定一个表示代码片段的字符串 `code`，实现一个验证器判断它是否**合法**。合法代码需同时满足 8 条规则，核心结构为被合法闭合标签包围的文本：
...
| 224 | [基本计算器](https://leetcode.cn/problems/basic-calculator/)（[题解](../0201-0300/224_基本计算器.md)） | 栈处理嵌套括号与一元符号，与本题的「栈管理嵌套层级」思路同源 |

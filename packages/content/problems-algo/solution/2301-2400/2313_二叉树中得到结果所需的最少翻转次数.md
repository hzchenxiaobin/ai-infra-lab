...
id: "lc:2313"
type: problem
title: 二叉树中得到结果所需的最少翻转次数
tags: [二叉树, 动态规划, 树, 深度优先搜索]
knowledge_points: [binary-tree, dfs, dynamic-programming, tree]
updated: 2026-09-03
source: leetcode
number: 2313
difficulty: hard
...
# LeetCode 二叉树中得到结果所需的最少翻转次数 题解

## 1. 题目概述

- **标题 / 题号**：二叉树中得到结果所需的最少翻转次数（#2313，hard）
- **链接**：https://leetcode.cn/problems/minimum-flips-in-binary-tree-to-get-result/
- **难度**：困难
- **标签**：树、深度优先搜索、动态规划、二叉树

**题意**：给定一棵**二叉树**的根 `root`，节点取值含义如下：

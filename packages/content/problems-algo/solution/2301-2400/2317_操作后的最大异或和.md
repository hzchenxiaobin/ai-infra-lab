...
title: 操作后的最大异或和
tags: [位运算, 数组, 贪心]
knowledge_points: [array, bit-manipulation, greedy]
updated: 2026-09-03
source: leetcode
number: 2317
difficulty: medium
...
# LeetCode 操作后的最大异或和 题解

## 1. 题目概述

- **标题 / 题号**：操作后的最大异或和（#2317，medium）
- **链接**：https://leetcode.cn/problems/maximum-xor-after-operations/
- **难度**：中等
- **标签**：位运算、数组、贪心

**题意**：给定下标从 0 开始的整数数组 `nums`。一次操作中，可以选择**任意**非负整数 `x` 和一个下标 `i`，把 `nums[i]` 更新为：

...
type: problem
title: "产品销售分析 V"
tags: ["GROUP BY", JOIN, "ORDER BY 多列排序", SQL, SUM, USING, "并列 tie-break", 数据库, 聚合派生度量]
knowledge_points: [database, group-by, join, order-by-多列排序, sql, sum, using, 并列-tie-break, 聚合派生度量]
updated: 2026-09-03
source: leetcode
number: 2329
difficulty: easy

...
type: problem
title: "产品销售分析 IV"
tags: ["GROUP BY", JOIN, "ORDER BY + LIMIT", "RANK vs ROW_NUMBER", SQL, SUM, 子查询, 并列处理, 数据库, 窗口函数, "聚合乘积（派生度量）"]
knowledge_points: [database, group-by, join, order-by-limit, rank-vs-row-number, sql, subquery, sum, window-function, 并列处理, 聚合乘积-派生度量]
updated: 2026-09-03
source: leetcode
number: 2324
difficulty: medium

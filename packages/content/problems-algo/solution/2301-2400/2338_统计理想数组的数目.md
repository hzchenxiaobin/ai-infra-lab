...
type: problem
title: 统计理想数组的数目
tags: [动态规划, 数学, 数论, 组合数学]
knowledge_points: [combinatorics, dynamic-programming, math, number-theory]
updated: 2026-09-03
source: leetcode
number: 2338
difficulty: hard
...
# LeetCode 统计理想数组的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计理想数组的数目（#2338，hard）
- **链接**：https://leetcode.cn/problems/count-the-number-of-ideal-arrays/
- **难度**：困难
- **标签**：数学、动态规划、组合数学、数论

**题意**：给定两个整数 `n` 和 `maxValue`。一个长度为 `n` 的下标从 0 开始的整数数组 `arr` 是**理想数组**，当且仅当：

...
type: problem
title: 受限条件下可到达节点的数目
tags: [哈希表, 图, 广度优先搜索, 树, 深度优先搜索]
knowledge_points: [bfs, dfs, graph, hash-table, tree]
updated: 2026-09-03
source: leetcode
number: 2368
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2022/06/15/ex1drawio.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/06/15/ex2drawio.png)

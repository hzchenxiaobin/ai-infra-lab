...
type: problem
title: 查找可享受优惠的用户
tags: [BETWEEN, "CREATE PROCEDURE", DISTINCT, SARGable, SQL, "WHERE 过滤", 去重, 存储过程, 数据库, 日期范围, 结果集]
knowledge_points: [between, create-procedure, database, dedup, distinct, sargable, sql, stored-procedure, where-filter, where-过滤, 日期范围, 结果集]
updated: 2026-09-03
source: leetcode
number: 2230
difficulty: easy

...
type: problem
title: 有资格享受折扣的用户数量
tags: [BETWEEN, "COUNT(DISTINCT)", SARGable, SQL, "WHERE 过滤", 去重计数, 存储函数, 数据库, 日期范围]
knowledge_points: [between, count-distinct, database, distinct-count, sargable, sql, stored-function, where-filter, where-过滤, 日期范围]
updated: 2026-09-03
source: leetcode
number: 2205
difficulty: easy

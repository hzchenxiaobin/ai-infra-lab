...
title: 巫师的总力量和
tags: [前缀和, 单调栈, 数组, 栈]
knowledge_points: [array, monotonic-stack, prefix-sum, stack]
updated: 2026-09-03
source: leetcode
number: 2281
difficulty: hard
...
- **标题 / 题号**：巫师的总力量和（#2281，hard）
- **链接**：https://leetcode.cn/problems/sum-of-total-strength-of-wizards/
- **难度**：困难
- **标签**：栈、数组、单调栈、前缀和

**题意**：给定下标从 $0$ 开始的整数数组 `strength`，其中 `strength[i]` 表示第 $i$ 位巫师的力量值。对于每个**非空连续子数组**（巫师组），其**总力量**定义为：

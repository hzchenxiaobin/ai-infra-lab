...
type: problem
title: 表的动态旋转
tags: [GROUP_CONCAT, "MAX+IF", PREPARE/EXECUTE, Pivot, SQL, "动态 SQL", 数据库, 条件聚合, 行转列]
knowledge_points: [conditional-aggregation, database, dynamic-sql, group-concat, max-if, pivot, prepare-execute, sql]
updated: 2026-09-03
source: leetcode
number: 2252
difficulty: hard

...
title: 用地毯覆盖后的最少白色砖块
tags: [动态规划, 字符串, 记忆化搜索]
knowledge_points: [dynamic-programming, memoization, string]
updated: 2026-09-03
source: leetcode
number: 2209
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2022/02/10/ex1-1.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/02/10/ex2.png)
...
| 132 | [分割回文串 II](https://leetcode.cn/problems/palindrome-partitioning-ii/)（[题解](../0101-0200/132_分割回文串II.md)） | 预处理 + 位置推进 DP，对照"段间代价"与"段内覆盖"的转移写法 |

...
type: problem
title: 数组变为有序的最小操作次数
tags: [动态规划, "堆（优先队列）", 数组, 贪心]
knowledge_points: [array, dynamic-programming, greedy, heap]
updated: 2026-09-03
source: leetcode
number: 2263
difficulty: hard

...
type: problem
title: 包含要求路径的最小带权子图
tags: [Dijkstra, 反向图, 图, 最短路径]
knowledge_points: [dijkstra, graph, shortest-path, 反向图]
updated: 2026-09-03
source: leetcode
number: 2203
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2022/02/17/example1drawio.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/02/17/example2-1drawio.png)

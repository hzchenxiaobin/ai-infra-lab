...
title: 买钢笔和铅笔的方案数
tags: [数学, 枚举]
knowledge_points: [enumeration, math]
updated: 2026-09-03
source: leetcode
number: 2240
difficulty: medium
...
# LeetCode 买钢笔和铅笔的方案数 题解

## 1. 题目概述

- **标题 / 题号**：买钢笔和铅笔的方案数（#2240，medium）
- **链接**：https://leetcode.cn/problems/number-of-ways-to-buy-pens-and-pencils/
- **难度**：中等
- **标签**：数学、枚举

**题意**：给定总钱数 `total`，以及一支钢笔的价格 `cost1` 和一支铅笔的价格 `cost2`。你可以花费**部分或全部**的钱，购买任意数目的两种笔（每种数量 $\ge 0$）。求购买钢笔和铅笔的**不同方案数目**。两种数量组合 $(x, y)$ 不同即视为不同方案。

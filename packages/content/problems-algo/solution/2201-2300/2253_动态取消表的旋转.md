...
type: problem
title: 动态取消表的旋转
tags: [GROUP_CONCAT, PREPARE/EXECUTE, SQL, "UNION ALL", UNPIVOT, information_schema, "动态 SQL", 存储过程, 数据库]
knowledge_points: [database, dynamic-sql, group-concat, information-schema, prepare-execute, sql, stored-procedure, union-all, unpivot]
updated: 2026-09-03
source: leetcode
number: 2253
difficulty: hard

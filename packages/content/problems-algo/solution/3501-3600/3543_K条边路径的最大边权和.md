...
title: "K 条边路径的最大边权和"
tags: [位运算, 动态规划, 哈希表, 图]
knowledge_points: [bit-manipulation, dynamic-programming, graph, hash-table]
updated: 2026-09-03
source: leetcode
number: 3543
difficulty: medium
...
# LeetCode K 条边路径的最大边权和 题解

## 1. 题目概述

- **标题 / 题号**：K 条边路径的最大边权和（#3543，medium）
- **链接**：https://leetcode.cn/problems/maximum-weighted-k-edge-path/
- **难度**：中等
- **标签**：图, 动态规划, 哈希表, 位运算

**题意**：给定 $n$ 个节点（编号 $0 \sim n-1$）的**有向无环图（DAG）**，由二维数组 `edges` 描述，`edges[i] = [u, v, w]` 表示一条从 $u$ 到 $v$ 的有向边，权值为 $w$。再给定两个整数 $k$ 和 $t$。
...
![示例1](https://pic.leetcode.cn/1746838989-LicEZO-screenshot-2025-04-10-at-061326.png)
...
![示例2](https://pic.leetcode.cn/1746838989-dlWmbI-screenshot-2025-04-10-at-061406.png)
...
![示例3](https://pic.leetcode.cn/1746838989-fIoKEG-screenshot-2025-04-10-at-061442.png)

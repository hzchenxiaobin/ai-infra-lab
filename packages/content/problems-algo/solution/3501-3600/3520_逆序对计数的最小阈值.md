...
type: problem
title: 逆序对计数的最小阈值
tags: [二分查找, 分治, 归并排序, 数组, 树状数组, 线段树]
knowledge_points: [array, binary-search, divide-and-conquer, fenwick-tree, merge-sort, segment-tree]
updated: 2026-09-03
source: leetcode
number: 3520
difficulty: medium

...
type: problem
title: 查找消除细菌菌株所需时间
tags: ["堆（优先队列）", 数学, 数组, 贪心]
knowledge_points: [array, greedy, heap, math]
updated: 2026-09-03
source: leetcode
number: 3506
difficulty: hard
...
# LeetCode 查找消除细菌菌株所需时间 题解

- **关联**：1199（本题原型题「建造街区的最短时间」，完全同构：工人 ↔ 白细胞、街区 ↔ 菌株）

## 1. 题目概述

- **标题 / 题号**：查找消除细菌菌株所需时间（#3506，hard）
...
**题意**：给定整数数组 `timeReq` 和整数 `splitTime`。在人体的微观世界里，免疫系统面临一场挑战：对抗快速繁殖的细菌群落。最初只部署**一个**白细胞（WBC）来消除细菌，规则如下：

...
type: problem
title: 季节性销售分析
tags: ["CASE WHEN 条件映射", "GROUP BY 聚合", SQL, "分组 Top-1", 数据库, "窗口函数 ROW_NUMBER()"]
knowledge_points: [case-when-条件映射, database, group-by, group-by-聚合, group-top1, sql, 分组-top-1, 窗口函数-row-number]
updated: 2026-09-03
source: leetcode
number: 3564
difficulty: medium

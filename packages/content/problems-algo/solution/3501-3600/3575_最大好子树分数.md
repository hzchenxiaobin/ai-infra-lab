...
type: problem
title: 最大好子树分数
tags: [位运算, 动态规划, 数组, 树, 深度优先搜索, 状态压缩]
knowledge_points: [array, bit-manipulation, bitmask-dp, dfs, dynamic-programming, tree]
updated: 2026-09-03
source: leetcode
number: 3575
difficulty: hard
...
![示例1](https://pic.leetcode.cn/1749281526-IiXefp-screenshot-2025-04-29-at-150754.png)
...
![示例2](https://pic.leetcode.cn/1749281526-byGNAL-screenshot-2025-04-29-at-151408.png)
...
| 3544 | [子树反转和](https://leetcode.cn/problems/subtree-inversion-sum/) | 另一道「子树独立 + 状态上抛」的树形 DP，状态是 (奇偶, 距离) 二元组而非掩码（题解见[子树反转和](./3544_子树反转和.md)） |

...
tags: [哈希函数, 字符串, 字符串匹配, 数组, 滚动哈希, 矩阵]
knowledge_points: [array, hash-function, matrix, rolling-hash, string, string-matching, 矩阵]
updated: 2026-09-03
source: leetcode
number: 3529
difficulty: medium
...
![示例1](https://pic.leetcode.cn/1745660164-PjoTAy-gridtwosubstringsdrawio.png)
...
![示例2](https://pic.leetcode.cn/1745660201-bMoajW-gridexample2fixeddrawio.png)

...
type: problem
title: "等和矩阵分割 II"
tags: [前缀和, 哈希表, 数组, 枚举, 矩阵]
knowledge_points: [array, enumeration, hash-table, matrix, prefix-sum, 矩阵]
updated: 2026-09-03
source: leetcode
number: 3548
difficulty: hard
...
# LeetCode 等和矩阵分割 II 题解

## 1. 题目概述

- **标题 / 题号**：等和矩阵分割 II（#3548，hard）
- **链接**：https://leetcode.cn/problems/equal-sum-grid-partition-ii/
- **难度**：困难
- **标签**：数组, 哈希表, 枚举, 矩阵, 前缀和

**题意**：给你一个由正整数组成的 `m x n` 矩阵 `grid`。你的任务是判断是否可以通过**一条水平或一条垂直分割线**将矩阵分割成两部分，使得：
...
![示例1](https://pic.leetcode.cn/1746840111-qowVBK-lc.jpeg)
...
![示例2](https://pic.leetcode.cn/1746840111-gqGlwe-chatgpt-image-apr-1-2025-at-05_28_12-pm.png)
...
![示例3](https://pic.leetcode.cn/1746840111-NLKmla-chatgpt-image-apr-2-2025-at-02_50_29-am.png)

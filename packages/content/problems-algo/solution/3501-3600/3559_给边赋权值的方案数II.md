...
type: problem
title: "给边赋权值的方案数 II"
tags: [位运算, 动态规划, 数学, 数组, 树, 深度优先搜索]
knowledge_points: [array, bit-manipulation, dfs, dynamic-programming, math, tree]
updated: 2026-09-03
source: leetcode
number: 3559
difficulty: hard
...
# LeetCode 给边赋权值的方案数 II 题解

## 1. 题目概述

- **标题 / 题号**：给边赋权值的方案数 II（#3559，hard）
- **链接**：https://leetcode.cn/problems/number-of-ways-to-assign-edge-weights-ii/
- **难度**：困难
- **标签**：位运算, 树, 深度优先搜索, 数组, 数学, 动态规划

**题意**：给你一棵 $n$ 个节点的无向树，节点从 $1$ 到 $n$ 编号，以节点 $1$ 为根。树由长度为 $n-1$ 的二维数组 `edges` 给出，`edges[i] = [ui, vi]` 表示节点 $u_i$、$v_i$ 间有一条边。
...
![示例1](https://pic.leetcode.cn/1748074049-lsGWuV-screenshot-2025-03-24-at-060006.png)
...
![示例2](https://pic.leetcode.cn/1748074095-sRyffx-screenshot-2025-03-24-at-055820.png)

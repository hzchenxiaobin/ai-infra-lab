...
type: problem
title: 查找类别推荐对
tags: [CTE, "DISTINCT 去重", "GROUP BY", HAVING, SQL, 数据库, 组合枚举, "自连接（Self Join）"]
knowledge_points: [combination-enumeration, cte, database, distinct-去重, group-by, having, sql, 自连接-self-join]
updated: 2026-09-03
source: leetcode
number: 3554
difficulty: hard

...
- **标题 / 题号**：两地调度（#1029，medium）
- **链接**：https://leetcode.cn/problems/two-city-scheduling/
- **难度**：中等
- **标签**：贪心、数组、排序

**题意**：公司计划面试 $2n$ 人。给定数组 `costs`，其中 `costs[i] = [aCostᵢ, bCostᵢ]`，表示第 $i$ 人飞往 **a 市**的费用为 `aCostᵢ`、飞往 **b 市**的费用为 `bCostᵢ`。需要把每个人都派往 a、b 中的一座城市，且**每座城市恰好有 $n$ 人抵达**。返回最低总费用。

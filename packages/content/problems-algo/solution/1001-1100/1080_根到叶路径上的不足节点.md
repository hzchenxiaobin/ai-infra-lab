...
type: problem
title: 根到叶路径上的不足节点
tags: [二叉树, 后序遍历, 树, 深度优先搜索]
knowledge_points: [binary-tree, dfs, postorder-traversal, tree]
updated: 2026-09-03
source: leetcode
number: 1080
difficulty: medium
...
# LeetCode 根到叶路径上的不足节点 题解

## 1. 题目概述

- **标题 / 题号**：根到叶路径上的不足节点（#1080，medium）
- **链接**：https://leetcode.cn/problems/insufficient-nodes-in-root-to-leaf-paths/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索、后序遍历

**题意**：给定二叉树的根节点 `root` 和一个整数 `limit`，同时删除树中所有**不足节点**，返回最终二叉树的根节点。
...
![示例1](https://assets.leetcode.com/uploads/2019/06/05/insufficient-11.png)
...
![示例2](https://assets.leetcode.com/uploads/2019/06/05/insufficient-3.png)
...
![示例3](https://assets.leetcode.com/uploads/2019/06/11/screen-shot-2019-06-11-at-83301-pm.png)
...
| 236 | [二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)（[题解](../0201-0300/236_二叉树的最近公共祖先.md)） | 后序传递「子树是否含 p/q」，在节点处聚合判定 LCA，同套后序布尔传递骨架 |

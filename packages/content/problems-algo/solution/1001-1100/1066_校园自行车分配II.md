...
type: problem
title: "校园自行车分配 II"
tags: [位运算, 分配问题, 动态规划, 状态压缩]
knowledge_points: [bit-manipulation, bitmask-dp, dynamic-programming, 分配问题]
updated: 2026-09-03
source: leetcode
number: 1066
difficulty: medium
...
| 526 | [优美的排列](https://leetcode.cn/problems/beautiful-arrangement/)（[题解](../0501-0600/526_优美的排列.md)） | 状压 DP 入门，`mask` 表示已放数字集合，与本题「`mask` 表示已用车集合」同构 |

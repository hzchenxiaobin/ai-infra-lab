...
- **标题 / 题号**：视频拼接（#1024，medium）
- **链接**：https://leetcode.cn/problems/video-stitching/
- **难度**：中等
- **标签**：贪心、数组、动态规划

**题意**：你将获得一系列视频片段，这些片段来自一项持续时长为 `time` 秒的体育赛事。片段可能重叠，也可能长度不一。
...
> 💡 **识别信号**：题目求「用最少数量的区间覆盖完整范围」，且区间可自由裁剪 → 想「贪心区间覆盖」。与 [45. 跳跃游戏 II](../0001-0100/45_跳跃游戏%20II.md) 的贪心完全同构——那里是"从当前位置能跳到的最远位置"，这里是"从已覆盖区域能扩展到的最远终点"。

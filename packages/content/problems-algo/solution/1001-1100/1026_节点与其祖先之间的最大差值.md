...
![示例1](https://assets.leetcode.com/uploads/2020/11/09/tmp-tree.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/11/09/tmp-tree-1.jpg)
...
> 💡 这是一道「**祖先-后代**」型树题。关键不在遍历方式（任何 DFS 都行），而在于**把"和所有祖先两两比较"这个 $O(n^2)$ 直觉，压缩成"只追踪路径上的 min/max"的 $O(n)$ 优化**。这种"极值决定差值"的归约思想，与 [121. 买卖股票的最佳时机](../0101-0200/121_买卖股票的最佳时机.md) 中"只追踪历史最小价"是同一种范式。
...
5. **方法和 [121. 买卖股票的最佳时机](../0101-0200/121_买卖股票的最佳时机.md) 有何相通？**
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 121 | [买卖股票的最佳时机](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/)（[题解](../0101-0200/121_买卖股票的最佳时机.md)） | 同样"和前面元素求最大差"，单向极值消除枚举，$O(n)$ 一遍遍历 |

...
id: "lc:4034"
type: problem
title: 象到达目标格子的最少移动步数
tags: [广度优先搜索, 数学, 棋盘模拟]
knowledge_points: [bfs, math, 棋盘模拟]
updated: 2026-09-03
source: leetcode
number: 4034
difficulty: medium
...
**题意**：给你一个 `8 x 8` 的棋盘，行和列的**下标从 1 开始**。给你一个数组 `source = [sr, sc]`，表示**象**的起始位置，以及一个数组 `target = [tr, tc]`。
...
![示例1](https://assets.leetcode.com/uploads/2026/08/31/111.png)
...
![示例2](https://assets.leetcode.com/uploads/2026/08/31/22-ezgifcom-invert-colors.png)

...
tags: [二分查找, 动态规划, 数组, 矩阵]
knowledge_points: [array, binary-search, dynamic-programming, matrix, 矩阵]
updated: 2026-09-03
source: leetcode
number: 4016
difficulty: medium
...
# LeetCode 两个不重叠子正方形的最大面积 题解

## 1. 题目概述

- **标题 / 题号**：两个不重叠子正方形的最大面积（#4016，medium）
- **链接**：https://leetcode.cn/problems/maximum-area-of-two-non-overlapping-square-submatrices/
- **难度**：中等
- **标签**：数组、二分查找、动态规划、矩阵

**题意**：给你一个大小为 $m \times n$ 的二维整数矩阵 `mat`，其中 `mat[r][c] == 1` 表示位于行 $r$、列 $c$ 的单元格**可用**，`mat[r][c] == 0` 表示不可用。
...
![示例1](https://assets.leetcode.com/uploads/2026/06/13/image.png)
...
![示例2](https://assets.leetcode.com/uploads/2026/06/13/screenshot-2026-06-13-at-83728pm.png)
...
![示例3](https://assets.leetcode.com/uploads/2026/06/13/screenshot-2026-06-13-at-83751pm.png)

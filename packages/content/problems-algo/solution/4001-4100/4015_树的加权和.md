...
**题意**：给你一个长度为 $n$ 的整数数组 `parent`，表示一棵**以节点 0 为根**的有根树（节点编号 $0 \sim n-1$）：`parent[0] = -1`，对其余节点 $i$，`parent[i]` 表示节点 $i$ 的父节点。
...
![示例1](https://assets.leetcode.com/uploads/2026/06/09/t1.png)
...
![示例2](https://assets.leetcode.com/uploads/2026/06/09/t2.png)

...
id: "lc:4004"
type: problem
title: "使循环数组余额非负的最少移动次数 II"
tags: [图, 数学, 数组, 最小费用流]
knowledge_points: [array, graph, math, min-cost-flow]
updated: 2026-09-03
source: leetcode
number: 4004
difficulty: hard
...
# LeetCode 使循环数组余额非负的最少移动次数 II 题解

## 1. 题目概述

- **标题 / 题号**：使循环数组余额非负的最少移动次数 II（#4004，hard）
- **链接**：https://leetcode.cn/problems/minimum-moves-to-balance-circular-array-ii/
- **难度**：困难
- **标签**：图、数组、数学、最小费用流

> ⚠️ 本题为 LeetCode 付费题，题意描述根据官方示例用例与 hints 重建，可能与官方题面有出入。

**题意**：给定长度为 $n$ 的**环形**数组 `balance`，`balance[i]` 是第 $i$ 个人的净余额。**一次移动**中，一个人可以将**正好 1 个单位**的余额转移给他的左邻居或右邻居（首尾相邻）。

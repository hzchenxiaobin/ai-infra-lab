...
type: problem
title: 查找僵尸会话
tags: ["GROUP BY", HAVING, SQL, TIMESTAMPDIFF, pandas, 数据库, 条件聚合, 聚合函数]
knowledge_points: [aggregate-function, conditional-aggregation, database, group-by, having, pandas, sql, timestampdiff]
updated: 2026-09-03
source: leetcode
number: 3673
difficulty: hard

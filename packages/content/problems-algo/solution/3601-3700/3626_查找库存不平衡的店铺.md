...
type: problem
title: 查找库存不平衡的店铺
tags: ["GROUP BY", "ROUND()", "ROW_NUMBER()", SQL, pandas, 数据库, 条件聚合, 窗口函数]
knowledge_points: [conditional-aggregation, database, group-by, pandas, round, row-number, sql, window-function]
updated: 2026-09-03
source: leetcode
number: 3626
difficulty: medium

...
type: problem
title: 拆分合并数组
tags: [哈希表, "广度优先搜索（BFS）", 状态空间搜索]
knowledge_points: [bfs, hash-table, state-space-search]
updated: 2026-09-03
source: leetcode
number: 3690
difficulty: medium

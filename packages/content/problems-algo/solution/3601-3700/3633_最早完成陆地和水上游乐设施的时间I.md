...
id: "lc:3633"
type: problem
title: "最早完成陆地和水上游乐设施的时间 I"
tags: [二分查找, 双指针, 排序, 数组, 贪心]
knowledge_points: [array, binary-search, greedy, sorting, two-pointers]
updated: 2026-09-03
source: leetcode
number: 3633
difficulty: easy
...
# LeetCode 最早完成陆地和水上游乐设施的时间 I 题解

## 1. 题目概述

- **标题 / 题号**：最早完成陆地和水上游乐设施的时间 I（#3633，easy）
- **链接**：https://leetcode.cn/problems/earliest-finish-time-for-land-and-water-rides-i/
- **难度**：简单
- **标签**：贪心、数组、双指针、二分查找、排序

**题意**：游乐园有两类项目，游客必须从**每个类别中各体验恰好一个**设施，顺序不限：

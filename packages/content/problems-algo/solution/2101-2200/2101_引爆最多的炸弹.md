...
knowledge_points: [bfs, dfs, graph]
updated: 2026-09-03
source: leetcode
number: 2101
difficulty: medium
...
- **标题 / 题号**：引爆最多的炸弹（#2101，medium）
- **链接**：https://leetcode.cn/problems/detonate-the-maximum-bombs/
- **难度**：中等
- **标签**：图、广度优先搜索、深度优先搜索

**题意**：给定 `n` 个炸弹 `bombs[i] = [xi, yi, ri]`，其中 `(xi, yi)` 是炸弹坐标、`ri` 是爆炸半径。任选**一个**炸弹引爆，爆炸范围内的所有炸弹会被连锁引爆，链式传播。返回在只引爆一个炸弹的前提下，**最多**能引爆的炸弹数目。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2021/11/06/desmos-eg-3.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/11/06/desmos-eg-2.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/11/07/desmos-eg1.png)

...
id: "lc:2152"
type: problem
title: 穿过所有点所需的最少直线数量
tags: [位运算, 几何, 动态规划, 哈希表, 回溯, 数学, 数组, 状态压缩]
knowledge_points: [array, backtracking, bit-manipulation, bitmask-dp, dynamic-programming, geometry, hash-table, math]
updated: 2026-09-03
source: leetcode
number: 2152
difficulty: medium

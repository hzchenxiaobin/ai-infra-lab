...
type: problem
title: 统计隐藏数组数目
tags: [前缀和, 区间求交, 差分数组, 数组]
knowledge_points: [array, difference-array, prefix-sum, 区间求交]
updated: 2026-09-03
source: leetcode
number: 2145
difficulty: medium
...
# LeetCode 统计隐藏数组数目 题解

## 1. 题目概述

- **标题 / 题号**：统计隐藏数组数目（#2145，medium）
- **链接**：https://leetcode.cn/problems/count-the-hidden-sequences/
- **难度**：中等
- **标签**：数组、前缀和、差分数组、区间求交

**题意**：给定长度为 `n` 的整数数组 `differences`，它描述一个长度为 `n + 1` 的**隐藏数组** `hidden` 中**相邻元素之间的差值**：

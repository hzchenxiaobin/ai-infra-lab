...
type: problem
title: 查找给定哈希值的子串
tags: [字符串, 数学, 滑动窗口, 滚动哈希]
knowledge_points: [math, rolling-hash, sliding-window, string]
updated: 2026-09-03
source: leetcode
number: 2156
difficulty: hard
...
| 718 | [最长重复子数组](https://leetcode.cn/problems/maximum-length-of-repeated-subarray/)（[题解](../0701-0800/718_最长重复子数组.md)） | DP 求最长公共子串，也可用滚动哈希 + 二分，对照本题的滚动哈希套路 |

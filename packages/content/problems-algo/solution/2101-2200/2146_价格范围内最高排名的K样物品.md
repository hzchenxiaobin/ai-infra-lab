...
id: "lc:2146"
type: problem
title: "价格范围内最高排名的 K 样物品"
tags: [BFS, 广度优先搜索, 排序, 矩阵]
knowledge_points: [bfs, matrix, sorting, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2146
difficulty: medium
...
# LeetCode 价格范围内最高排名的 K 样物品 题解

## 1. 题目概述

- **标题 / 题号**：价格范围内最高排名的 K 样物品（#2146，medium）
- **链接**：https://leetcode.cn/problems/k-highest-ranked-items-within-a-price-range/
- **难度**：中等
- **标签**：广度优先搜索、BFS、排序、矩阵

**题意**：给定一个 `m x n` 的二维整数数组 `grid`，表示商店的物品分布图：
...
![示例1](https://assets.leetcode.com/uploads/2021/12/16/example1drawio.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/12/16/example2drawio1.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/12/30/example3.png)

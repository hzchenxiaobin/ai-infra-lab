...
type: problem
title: 分别排序两列
tags: [CTE, JOIN, ROW_NUMBER, SQL, 数据库, 独立排序, 窗口函数]
knowledge_points: [cte, database, join, row-number, sql, window-function, 独立排序]
updated: 2026-09-03
source: leetcode
number: 2159
difficulty: medium

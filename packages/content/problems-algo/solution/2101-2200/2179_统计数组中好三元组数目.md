...
title: 统计数组中好三元组数目
tags: [排序, 数组, 树状数组]
knowledge_points: [array, fenwick-tree, sorting]
updated: 2026-09-03
source: leetcode
number: 2179
difficulty: hard
...
> 💡 另一个角度：本题也等价于求 $A$ 的「长度为 3 的递增子序列」的总数。[300. 最长递增子序列](../0201-0300/300_最长递增子序列.md) 求的是最长长度，而本题求的是长度恰为 3 的递增子序列的**个数**。统计个数时，固定中间元素 + 乘法原理是最直接的套路。
...
| 300 | [最长递增子序列](https://leetcode.cn/problems/longest-increasing-subsequence/)（[题解](../0201-0300/300_最长递增子序列.md)） | 求 LIS 长度，2179 是其「统计长度为 3 的递增子序列个数」的变体 |

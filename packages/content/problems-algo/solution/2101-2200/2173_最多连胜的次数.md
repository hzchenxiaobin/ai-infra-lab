...
type: problem
title: 最多连胜的次数
tags: [COALESCE, CTE, LAG, "LEFT JOIN", ROW_NUMBER, SQL, gaps-and-islands, 数据库, 窗口函数]
knowledge_points: [coalesce, cte, database, gaps-and-islands, lag, left-join, row-number, sql, window-function]
updated: 2026-09-03
source: leetcode
number: 2173
difficulty: hard

...
type: problem
title: 搜索推荐系统
tags: [二分查找, 双指针, 字典树, 字符串, 排序]
knowledge_points: [binary-search, sorting, string, trie, two-pointers]
updated: 2026-09-03
source: leetcode
number: 1268
difficulty: medium
...
> 💡 **「最多 3 个 + 字典序最小」**：要求只取字典序最小的至多 3 个，强烈暗示**先排序再扫描**——排序后同一前缀的产品天然连续，且连续段的前 3 个正是答案。这与 [692. 前 K 个高频单词](../0601-0700/692_前K个高频单词.md)、[502. IPO](../0501-0600/502_IPO.md) 同属「排序解锁 + 取前 K」范式。
...
| 392 | [判断子序列](https://leetcode.cn/problems/is-subsequence/)（[题解](../0301-0400/392_判断子序列.md)） | 双指针只前进不回退的经典，与本题双指针夹窗口同构 |

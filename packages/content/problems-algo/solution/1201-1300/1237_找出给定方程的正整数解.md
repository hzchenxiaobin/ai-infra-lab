...
title: 找出给定方程的正整数解
tags: [二分查找, 交互, 双指针, 数学]
knowledge_points: [binary-search, interactive, math, two-pointers, 交互]
updated: 2026-09-03
source: leetcode
number: 1237
difficulty: easy
...
# LeetCode 找出给定方程的正整数解 题解

## 1. 题目概述

- **标题 / 题号**：找出给定方程的正整数解（#1237，easy）
- **链接**：https://leetcode.cn/problems/find-positive-integer-solution-for-a-given-equation/
- **难度**：简单
- **标签**：数学、双指针、二分查找、交互

**题意**：给出一个**隐藏实现**的函数 `f(x, y)` 和一个整数 `z`。函数 `f` 关于 `x` 和 `y` **严格单调递增**：

...
- **标题 / 题号**：缀点成线（#1232，easy）
- **链接**：https://leetcode.cn/problems/check-if-it-is-a-straight-line/
- **难度**：简单
- **标签**：几何、数组、数学

**题意**：给定一个点集 `coordinates`，其中 `coordinates[i] = [xi, yi]` 表示二维平面上一个点的坐标。判断这些点是否**全部落在同一条直线上**。

**示例 1**：

![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/10/19/untitled-diagram-2.jpg)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/10/19/untitled-diagram-1.jpg)

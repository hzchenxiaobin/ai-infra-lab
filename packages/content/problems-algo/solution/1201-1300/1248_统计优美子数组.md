...
type: problem
title: "统计「优美子数组」"
tags: [前缀和, 哈希表, 数组, 滑动窗口]
knowledge_points: [array, hash-table, prefix-sum, sliding-window]
updated: 2026-09-03
source: leetcode
number: 1248
difficulty: medium
...
# LeetCode 统计「优美子数组」 题解

## 1. 题目概述

- **标题 / 题号**：统计「优美子数组」（#1248，medium）
- **链接**：https://leetcode.cn/problems/count-number-of-nice-subarrays/
- **难度**：中等
- **标签**：数组、滑动窗口、前缀和、哈希表

**题意**：给你一个整数数组 `nums` 和一个整数 `k`。如果某个**连续子数组**中恰好有 `k` 个奇数，则称该子数组为「优美子数组」。请返回优美子数组的**数目**。

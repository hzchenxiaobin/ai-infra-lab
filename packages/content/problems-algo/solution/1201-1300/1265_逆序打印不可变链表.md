...
title: 逆序打印不可变链表
tags: [双指针, 递归, 链表]
knowledge_points: [linked-list, recursion, two-pointers]
updated: 2026-09-03
source: leetcode
number: 1265
difficulty: medium
...
# LeetCode 逆序打印不可变链表 题解

## 1. 题目概述

- **标题 / 题号**：逆序打印不可变链表（#1265，medium）
- **链接**：https://leetcode.cn/problems/print-immutable-linked-list-in-reverse/
- **难度**：中等
- **标签**：链表、递归、双指针

**题意**：给定一个**不可变链表**（immutable linked list），要求将其所有节点值**逆序打印**出来。你**不能修改链表**本身，只能通过以下两个接口访问节点：
...
| 92 | [反转链表 II](https://leetcode.cn/problems/reverse-linked-list-ii/)（[题解](../0001-0100/92_反转链表%20II.md)） | 区间翻转，指针操作进阶，同为链表逆序主题 |

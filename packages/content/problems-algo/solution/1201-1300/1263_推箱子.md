...
type: problem
title: 推箱子
tags: ["嵌套 BFS", 广度优先搜索, 矩阵]
knowledge_points: [bfs, matrix, 嵌套-bfs, 矩阵]
updated: 2026-09-03
source: leetcode
number: 1263
difficulty: hard
...
**题意**：在一个 $m \times n$ 的网格上进行「推箱子」游戏。网格中每个单元格是以下字符之一：
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/11/16/sample_1_1620.png)

...
tags: [位运算, 广度优先搜索, 枚举, 状态压缩]
knowledge_points: [bfs, bit-manipulation, bitmask-dp, enumeration]
updated: 2026-09-03
source: leetcode
number: 1284
difficulty: hard
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/12/13/matrix.png)

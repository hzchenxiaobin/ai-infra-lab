...
title: 交换字符串中的元素
tags: [哈希表, 字符串, 并查集, 排序]
knowledge_points: [hash-table, sorting, string, union-find]
updated: 2026-09-03
source: leetcode
number: 1202
difficulty: medium
...
# LeetCode 交换字符串中的元素 题解

## 1. 题目概述

- **标题 / 题号**：交换字符串中的元素（#1202，medium）
- **链接**：https://leetcode.cn/problems/smallest-string-with-swaps/
- **难度**：中等
- **标签**：并查集、哈希表、字符串、排序

**题意**：给你一个字符串 `s`，以及该字符串中的一些「索引对」数组 `pairs`，其中 `pairs[i] = [a, b]` 表示字符串中的两个索引（编号从 0 开始）。

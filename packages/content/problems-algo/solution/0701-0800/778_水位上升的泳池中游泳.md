...
type: problem
title: 水位上升的泳池中游泳
tags: [Dijkstra, 二分查找, 图, 堆/优先队列, 并查集, 最短路径]
knowledge_points: [binary-search, dijkstra, graph, heap, shortest-path, union-find]
updated: 2026-09-03
source: leetcode
number: 778
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/06/29/swim1-grid.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/29/swim2-grid-1.jpg)

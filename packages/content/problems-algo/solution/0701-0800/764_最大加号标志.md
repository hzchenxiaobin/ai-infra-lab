...
title: 最大加号标志
tags: [动态规划, 数组]
knowledge_points: [array, dynamic-programming]
updated: 2026-09-03
source: leetcode
number: 764
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2021/06/13/plus1-grid.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/13/plus2-grid.jpg)
...
| 304 | [二维区域和检索 - 数组不可变](https://leetcode.cn/problems/range-sum-query-2d-immutable/)（[题解](../0301-0400/304_二维区域和检索%20-%20数组不可变.md)） | 二维预处理的另一经典形态，体会「预计算表 + O(1) 查询」的范式 |

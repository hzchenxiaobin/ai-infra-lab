...
![示例1](https://assets.leetcode.com/uploads/2020/11/04/ex1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/11/04/ex2.jpg)
...
| 303 | [区域和检索 - 数组不可变](https://leetcode.cn/problems/range-sum-query-immutable/)（[题解](../0301-0400/304_二维区域和检索%20-%20数组不可变.md)） | 矩阵预处理思想对照，体会「逐格扫描」与「预处理」不同侧重 |

...
title: 二进制表示中质数个置位
tags: [位运算, 数学]
knowledge_points: [bit-manipulation, math]
updated: 2026-09-03
source: leetcode
number: 762
difficulty: easy
...
# LeetCode 二进制表示中质数个置位 题解

## 1. 题目概述

- **标题 / 题号**：二进制表示中质数个置位（#762，easy）
- **链接**：https://leetcode.cn/problems/prime-number-of-set-bits-in-binary-representation/
- **难度**：简单
- **标签**：位运算、数学

**题意**：给定两个整数 `left` 和 `right`，返回区间 `[left, right]`（含两端）内**二进制表示中 `1` 的个数为质数**的整数数目。

...
title: 最大栈
tags: [堆, 懒删除, 栈, 设计]
knowledge_points: [design, heap, stack, 懒删除]
updated: 2026-09-03
source: leetcode
number: 716
difficulty: hard
...
| 460 | [LFU 缓存](https://leetcode.cn/problems/lfu-cache/)（[题解](../0401-0500/460_LFU缓存.md)） | 频率桶 + 双向链表，同样依赖"链表 $O(1)$ 删中间 + 额外索引定位"，复杂度更进一阶的设计题 |

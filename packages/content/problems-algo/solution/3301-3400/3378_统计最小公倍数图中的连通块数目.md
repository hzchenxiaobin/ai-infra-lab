...
tags: [哈希表, 并查集, 数论, 最小公倍数, "枚举倍数（调和级数）"]
knowledge_points: [hash-table, lcm, number-theory, union-find, 枚举倍数-调和级数]
updated: 2026-09-03
source: leetcode
number: 3378
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2024/10/31/example0.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/10/31/example1.png)

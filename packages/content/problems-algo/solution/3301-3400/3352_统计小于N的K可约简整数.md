...
id: "lc:3352"
type: problem
title: "统计小于 N 的 K 可约简整数"
tags: [动态规划, 字符串, "数位 DP", 数学, 组合数学]
knowledge_points: [combinatorics, digit-dp, dynamic-programming, math, string]
updated: 2026-09-03
source: leetcode
number: 3352
difficulty: hard
...
# LeetCode 统计小于N的K可约简整数 题解

## 1. 题目概述

- **标题 / 题号**：统计小于 N 的 K 可约简整数（#3352，hard）
- **链接**：https://leetcode.cn/problems/count-k-reducible-numbers-less-than-n/
- **难度**：困难
- **标签**：数学、字符串、动态规划、组合数学、数位 DP

**题意**：给你一个**二进制**字符串 `s`，它表示数字 `n` 的二进制形式；同时给你一个整数 `k`。

...
type: problem
title: "首字母大写 II"
tags: ["CROSS JOIN", GROUP_CONCAT, SQL, SUBSTRING_INDEX, 字符串处理, 数据库, "递归 CTE"]
knowledge_points: [cross-join, database, group-concat, recursive-cte, sql, string-processing, substring-index, 字符串处理]
updated: 2026-09-03
source: leetcode
number: 3374
difficulty: hard
...
# LeetCode 首字母大写 II 题解

## 1. 题目概述

- **标题 / 题号**：首字母大写 II（#3374，hard）

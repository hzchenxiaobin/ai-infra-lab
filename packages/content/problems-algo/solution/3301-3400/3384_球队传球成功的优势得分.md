...
type: problem
title: 球队传球成功的优势得分
tags: ["GROUP BY", JOIN, SQL, 字符串字典序比较, 数据库, 条件聚合, 等值连接]
knowledge_points: [conditional-aggregation, database, group-by, join, sql, 字符串字典序比较, 等值连接]
updated: 2026-09-03
source: leetcode
number: 3384
difficulty: hard

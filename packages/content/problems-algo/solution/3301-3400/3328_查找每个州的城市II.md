...
type: problem
title: "查找每个州的城市 II"
tags: ["GROUP BY", GROUP_CONCAT, HAVING, "LEFT()", SQL, "SUM(IF)", 数据库, 条件聚合]
knowledge_points: [conditional-aggregation, conditional-sum, database, group-by, group-concat, having, left, sql, sum-if]
updated: 2026-09-03
source: leetcode
number: 3328
difficulty: medium
...
| 1527 | [患某种疾病的患者](https://leetcode.cn/problems/patients-with-a-condition/)（[站内题解](../1501-1600/1527_患某种疾病的患者.md)） | `LIKE 'DI\_%'` 按开头字母筛选——本题「首字母匹配」的行级版对照 |

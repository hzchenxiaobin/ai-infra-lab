...
type: problem
title: 查询排序后的最大公约数
tags: [二分查找, 前缀和, 数组, 数论, 计数]
knowledge_points: [array, binary-search, counting, number-theory, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 3312
difficulty: hard
...
# LeetCode 查询排序后的最大公约数 题解

## 1. 题目概述

- **标题 / 题号**：查询排序后的最大公约数（#3312，hard）
- **链接**：https://leetcode.cn/problems/sorted-gcd-pair-queries/
- **难度**：困难
- **标签**：数组、数论、计数、二分查找、前缀和

**题意**：给你一个长度为 $n$ 的整数数组 `nums` 和一个整数数组 `queries`。

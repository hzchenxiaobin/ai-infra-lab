...
type: problem
title: 设计数组统计跟踪器
tags: [二分查找, 哈希表, "堆（优先队列）", 数据流, 有序集合, 设计, 队列]
knowledge_points: [binary-search, data-stream, design, hash-table, heap, ordered-set, queue]
updated: 2026-09-03
source: leetcode
number: 3369
difficulty: hard
...
# LeetCode 设计数组统计跟踪器 题解

## 1. 题目概述

- **标题 / 题号**：设计数组统计跟踪器（#3369，hard）
...
**题意**：设计一个数据结构 `StatisticsTracker`，对一个不断变化的整数数组跟踪统计量，支持以下操作：

...
type: problem
title: "破解锁的最少时间 II"
tags: [二分图匹配, 图, 广度优先搜索, 数组, 最小费用最大流]
knowledge_points: [array, bfs, bipartite-matching, graph, min-cost-max-flow]
updated: 2026-09-03
source: leetcode
number: 3385
difficulty: hard
...
**题意**：Bob 被困在地窖里，需要破解 $n$ 个锁才能逃出。数组 `strength` 中 `strength[i]` 表示打开第 $i$ 把锁所需的**能量**。

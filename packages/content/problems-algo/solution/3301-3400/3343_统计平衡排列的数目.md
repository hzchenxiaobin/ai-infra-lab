...
type: problem
title: 统计平衡排列的数目
tags: [动态规划, 数学, 组合数学, "计数 DP"]
knowledge_points: [combinatorics, counting-dp, dynamic-programming, math]
updated: 2026-09-03
source: leetcode
number: 3343
difficulty: hard
...
# LeetCode 统计平衡排列的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计平衡排列的数目（#3343，hard）
- **链接**：https://leetcode.cn/problems/count-number-of-balanced-permutations/
- **难度**：困难
- **标签**：数学、动态规划、组合数学、计数 DP

**题意**：给你一个数字字符串 `num`。如果一个数字字符串的**奇数位下标**的数字之和与**偶数位下标**的数字之和相等，那么称这个数字字符串是**平衡的**。

...
tags: [哈希表, 数组, 有序集合, 矩阵, 设计]
knowledge_points: [array, design, hash-table, matrix, ordered-set, 矩阵]
updated: 2026-09-03
source: leetcode
number: 3391
difficulty: medium
...
- **标题 / 题号**：设计一个高效的层跟踪三维二进制矩阵（#3391，medium）
...
**题意**：设计一个 $n \times n \times n$ 的三维二进制矩阵（元素非 0 即 1，初始全 0），支持三种操作：

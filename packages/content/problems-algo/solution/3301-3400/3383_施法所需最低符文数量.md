...
type: problem
title: 施法所需最低符文数量
tags: [图, 广度优先搜索, 拓扑排序, 数组, 深度优先搜索]
knowledge_points: [array, bfs, dfs, graph, topological-sort]
updated: 2026-09-03
source: leetcode
number: 3383
difficulty: hard
...
**题意**：Alice 刚从巫师学校毕业，想施一个魔法咒语庆祝。咒语包含 $n$ 个需要集中魔力的**焦点**，其中一些焦点上放有作为能量源的**魔法水晶**。焦点之间用**有向符文**连接，符文把魔力流从一个焦点传输到另一个焦点。

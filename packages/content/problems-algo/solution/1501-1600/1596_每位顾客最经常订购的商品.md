...
type: problem
title: 每位顾客最经常订购的商品
tags: ["GROUP BY + COUNT", JOIN, "MAX + IN 子查询", RANK, SQL, "Top-1 per group", 并列保留, 数据库, 窗口函数, 聚合后排名]
knowledge_points: [database, group-by-count, group-top1, join, max-in-子查询, rank, sql, top-1-per-group, window-function, 并列保留, 聚合后排名]
updated: 2026-09-03
source: leetcode
number: 1596
difficulty: medium

...
type: problem
title: "统计全 1 子矩形"
tags: [动态规划, 单调栈, 数组, 栈, 矩阵]
knowledge_points: [array, dynamic-programming, matrix, monotonic-stack, stack, 矩阵]
updated: 2026-09-03
source: leetcode
number: 1504
difficulty: medium
...
# LeetCode 统计全 1 子矩形 题解

## 1. 题目概述

- **标题 / 题号**：统计全 1 子矩形（#1504，medium）
- **链接**：https://leetcode.cn/problems/count-submatrices-with-all-ones/
- **难度**：中等
- **标签**：栈、数组、动态规划、单调栈、矩阵

**题意**：给定一个 `m × n` 的二进制矩阵 `mat`，返回元素**全部为 1**的**子矩形**数量。子矩形是由矩阵中一段连续的行和列所围成的矩形区域。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2021/10/27/ones1-grid.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/10/27/ones2-grid.jpg)
...
> 💡 本题是 [85. 最大矩形](../0001-0100/85_最大矩形.md) 的**计数版**——85 题求最大面积，本题求全 1 子矩形的总数。两者共享「逐行构建高度直方图」的核心思想，但本题需要把「求最大」换成「求和」，恰好对应 [907. 子数组的最小值之和](../0901-1000/907_子数组的最小值之和.md)。

...
title: "找到 N 叉树的根节点"
tags: [位运算, 哈希表, 树]
knowledge_points: [bit-manipulation, hash-table, tree]
updated: 2026-09-03
source: leetcode
number: 1506
difficulty: medium
...
# LeetCode 找到 N 叉树的根节点 题解

## 1. 题目概述

- **标题 / 题号**：找到 N 叉树的根节点（#1506，medium）
- **链接**：https://leetcode.cn/problems/find-root-of-n-ary-tree/
- **难度**：中等
- **标签**：树、哈希表、位运算

**题意**：给定一棵 **N 叉树** 的**所有节点**（节点顺序任意打乱），每个节点有一个**唯一**的整数值。请你找出并返回这棵树的**根节点**。

...
type: problem
title: 最多的不重叠子字符串
tags: [区间调度, 哈希表, 字符串, 贪心]
knowledge_points: [greedy, hash-table, interval-scheduling, string]
updated: 2026-09-03
source: leetcode
number: 1520
difficulty: hard
...
# LeetCode 最多的不重叠子字符串 题解

## 1. 题目概述

- **标题 / 题号**：最多的不重叠子字符串（#1520，hard）
- **链接**：https://leetcode.cn/problems/maximum-number-of-non-overlapping-substrings/
- **难度**：困难
- **标签**：贪心、区间调度、字符串、哈希表

**题意**：给定只含小写字母的字符串 `s`，选出**最多数目**的非空子字符串，满足：

...
title: 所有奇数长度子数组的和
tags: [前缀和, 数学, 数组, 贡献计数]
knowledge_points: [array, contribution-technique, math, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 1588
difficulty: easy
...
# LeetCode 所有奇数长度子数组的和 题解

## 1. 题目概述

- **标题 / 题号**：所有奇数长度子数组的和（#1588，easy）
- **链接**：https://leetcode.cn/problems/sum-of-all-odd-length-subarrays/
- **难度**：简单
- **标签**：数组、前缀和、数学、贡献计数

**题意**：给定一个**正整数**数组 `arr`，返回数组中**所有奇数长度非空连续子数组**的元素之和。

...
type: problem
title: 进店却未进行过交易的顾客
tags: [COUNT, "GROUP BY", "IS NULL", "LEFT JOIN", "NOT EXISTS", "NOT IN 的 NULL 陷阱", SQL, "反连接（anti-join）", 数据库]
knowledge_points: [anti-join, count, database, group-by, is-null, left-join, not-exists, not-in-null-trap, not-in-的-null-陷阱, sql]
updated: 2026-09-03
source: leetcode
number: 1581
difficulty: easy

...
title: 经营摩天轮的最大利润
tags: [数组, 模拟, 贪心]
knowledge_points: [array, greedy, simulation]
updated: 2026-09-03
source: leetcode
number: 1599
difficulty: medium
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/09/26/wheeldiagram12.png)
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 121 | [买卖股票的最佳时机](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/)（[题解](../0101-0200/121_买卖股票的最佳时机.md)） | 一次遍历跟踪前缀最值，本题同样「线性扫描累计、取最大」的套路 |

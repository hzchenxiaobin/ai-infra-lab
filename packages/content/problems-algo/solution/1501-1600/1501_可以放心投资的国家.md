...
type: problem
title: 可以放心投资的国家
tags: ["AVG 聚合", "GROUP BY", SQL, "多表 JOIN", 子查询]
knowledge_points: [avg, avg-聚合, group-by, multi-join, sql, subquery]
updated: 2026-09-03
source: leetcode
number: 1501
difficulty: medium
...
# LeetCode 可以放心投资的国家 题解

## 1. 题目概述

- **标题 / 题号**：可以放心投资的国家（#1501，medium）
- **链接**：https://leetcode.cn/problems/countries-you-can-safely-invest-in/
- **难度**：中等
- **标签**：SQL、多表 JOIN、GROUP BY、AVG 聚合、子查询

**题意**：一家电信公司想在新的国家投资。该公司打算投资于**该国通话的平均时长严格大于全局平均通话时长**的国家。给定 `Person`、`Country`、`Calls` 三张表，编写 SQL 查询返回可投资的国家名，结果列名为 `country`，顺序任意。

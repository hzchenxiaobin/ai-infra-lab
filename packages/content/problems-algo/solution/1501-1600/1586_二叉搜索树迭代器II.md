...
type: problem
title: 二叉搜索树迭代器II
tags: [BST, 中序遍历, 栈, 树, 设计, 迭代器]
knowledge_points: [bst, design, inorder-traversal, iterator, stack, tree]
updated: 2026-09-03
source: leetcode
number: 1586
difficulty: medium
...
# LeetCode 二叉搜索树迭代器II 题解

## 1. 题目概述

- **标题 / 题号**：二叉搜索树迭代器II（#1586，medium）
- **链接**：https://leetcode.cn/problems/binary-search-tree-iterator-ii/
- **难度**：中等
- **标签**：树、BST、栈、设计、中序遍历、迭代器

**题意**：实现一个**二叉搜索树（BST）双向迭代器** `BSTIterator`，按**中序遍历**的升序序列支持**前后双向移动**：

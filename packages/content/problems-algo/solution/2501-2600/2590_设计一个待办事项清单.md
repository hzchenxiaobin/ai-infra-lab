...
type: problem
title: 设计一个待办事项清单
tags: [哈希表, 字符串, 排序, 数组, 设计]
knowledge_points: [array, design, hash-table, sorting, string]
updated: 2026-09-03
source: leetcode
number: 2590
difficulty: medium
...
# LeetCode 设计一个待办事项清单 题解

## 1. 题目概述

- **标题 / 题号**：设计一个待办事项清单（#2590，medium）
- **链接**：https://leetcode.cn/problems/design-a-todo-list/
- **难度**：中等
- **标签**：设计、数组、哈希表、字符串、排序

**题意**：设计一个待办事项清单，用户可以添加**任务**、标记任务为**完成**、获取未完成任务列表，还能为任务打**标签**并按标签筛选。实现 `TodoList` 类：

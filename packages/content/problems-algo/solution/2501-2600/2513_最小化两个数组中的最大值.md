...
type: problem
title: 最小化两个数组中的最大值
tags: [二分查找, 容斥原理, 数学, 数论]
knowledge_points: [binary-search, inclusion-exclusion, math, number-theory]
updated: 2026-09-03
source: leetcode
number: 2513
difficulty: medium
...
# LeetCode 最小化两个数组中的最大值 题解

## 1. 题目概述

- **标题 / 题号**：最小化两个数组中的最大值（#2513，medium）
- **链接**：https://leetcode.cn/problems/minimize-the-maximum-of-two-arrays/
- **难度**：中等
- **标签**：二分查找、数学、数论、容斥原理

**题意**：给定四个整数 `divisor1`、`divisor2`、`uniqueCnt1`、`uniqueCnt2`。你需要往两个一开始都为空的数组 `arr1`、`arr2` 中添加正整数，使满足：

...
id: "lc:2557"
type: problem
title: "从一个范围内选择最多整数 II"
tags: [二分查找, 排序, 数组, 贪心]
knowledge_points: [array, binary-search, greedy, sorting]
updated: 2026-09-03
source: leetcode
number: 2557
difficulty: medium
...
# LeetCode 从一个范围内选择最多整数 II 题解

## 1. 题目概述

- **标题 / 题号**：从一个范围内选择最多整数 II（#2557，medium）
- **链接**：https://leetcode.cn/problems/maximum-number-of-integers-to-choose-from-a-range-ii/
- **难度**：中等
- **标签**：贪心、数组、二分查找、排序

**题意**：给你一个整数数组 `banned` 和两个整数 `n`、`maxSum`。需要按以下规则从 `[1, n]` 中选择一些整数：

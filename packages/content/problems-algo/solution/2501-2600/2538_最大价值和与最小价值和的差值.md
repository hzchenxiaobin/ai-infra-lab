...
tags: [动态规划, 数组, 树, "树形 DP", 深度优先搜索]
knowledge_points: [array, dfs, dynamic-programming, tree, tree-dp]
updated: 2026-09-03
source: leetcode
number: 2538
difficulty: hard
...
# LeetCode 最大价值和与最小价值和的差值 题解

## 1. 题目概述

- **标题 / 题号**：最大价值和与最小价值和的差值（#2538，hard）
- **链接**：https://leetcode.cn/problems/difference-between-maximum-and-minimum-price-sum/
- **难度**：困难
- **标签**：树、深度优先搜索、数组、动态规划、树形 DP

**题意**：给定一棵 $n$ 个节点的无向树，节点编号 $0$ 到 $n-1$。每个节点 $i$ 有价值 $\text{price}[i]$。一条**路径的价值和**是路径上所有节点价值之和。
...
![示例1](https://assets.leetcode.com/uploads/2022/12/01/example14.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/11/24/p1_example2.png)

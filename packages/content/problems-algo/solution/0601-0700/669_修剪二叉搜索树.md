...
title: 修剪二叉搜索树
tags: [DFS, 二叉搜索树, 树, 递归]
knowledge_points: [bst, dfs, recursion, tree]
updated: 2026-09-03
source: leetcode
number: 669
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2020/09/09/trim1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/09/09/trim2.jpg)
...
| 98 | [验证二叉搜索树](https://leetcode.cn/problems/validate-binary-search-tree/)（[题解](../0001-0100/98_验证二叉搜索树.md)） | BST 有序性判定题，理解"左<根<右"传递性是做 669 整子树丢弃判定的前提 |

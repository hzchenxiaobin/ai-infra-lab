...
type: problem
title: "K 个关闭的灯泡"
tags: [单调队列, 数组, 滑动窗口, 逆排列]
knowledge_points: [array, monotonic-queue, sliding-window, 逆排列]
updated: 2026-09-03
source: leetcode
number: 683
difficulty: hard
...
# LeetCode K 个关闭的灯泡 题解

## 1. 题目概述

- **标题 / 题号**：K 个关闭的灯泡（#683，hard）
- **链接**：https://leetcode.cn/problems/k-empty-slots/
- **难度**：困难
- **标签**：数组、滑动窗口、单调队列、逆排列

**题意**：有 `N` 盏灯泡排成一行，编号 `1` 到 `N`。初始全部关闭。每天**恰好点亮一盏**，`N` 天后全部点亮。

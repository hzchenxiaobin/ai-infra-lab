...
type: problem
title: 二叉搜索树中的搜索
tags: [二分查找, 二叉搜索树, 树, 递归]
knowledge_points: [binary-search, bst, recursion, tree]
updated: 2026-09-03
source: leetcode
number: 700
difficulty: easy
...
![示例1](https://assets.leetcode.com/uploads/2021/01/12/tree1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/01/12/tree2.jpg)
...
>
> ⚠️ 对比 [94. 中序遍历](../0001-0100/94_二叉树的中序遍历.md) 的迭代版需要显式栈——因为遍历要访问所有节点、需要回溯到父节点再走另一侧；而 BST 搜索只走一条路径，无需栈。能否去栈的关键在于"是否需要回溯"。

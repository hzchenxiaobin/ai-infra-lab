...
type: problem
title: 二级关注者
tags: ["GROUP BY", JOIN, "ORDER BY", SQL, 社交网络, 自连接]
knowledge_points: [group-by, join, order-by, self-join, sql, 社交网络]
updated: 2026-09-03
source: leetcode
number: 614
difficulty: medium
...
- **标题 / 题号**：二级关注者（#614，medium）
- **链接**：https://leetcode.cn/problems/second-degree-follower/
- **难度**：中等
- **标签**：SQL、自连接、JOIN、GROUP BY、ORDER BY、社交网络

**题意**：在 Facebook、Twitter 等社交网络中，用户之间可以相互关注，形成复杂的关系图。给定 `Follow` 表记录「谁关注谁」，编写 SQL 查询，对**每个被关注的人**，找出其所有的**二级关注者**（即其关注者的关注者）。

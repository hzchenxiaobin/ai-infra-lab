...
type: problem
title: "平均工资：部门与公司比较"
tags: [AVG, CASE, JOIN, SQL, 分组, 窗口函数, 聚合, 自连接]
knowledge_points: [aggregation, avg, case, join, self-join, sql, window-function, 分组]
updated: 2026-09-03
source: leetcode
number: 615
difficulty: hard
...
| 569 | [员工薪水中位数](../0501-0600/569_员工薪水中位数.md) | SQL 窗口函数 + 按部门分组，承接 615 的「按部门分组窗口计算统计量」，从均值换成中位数（`ROW_NUMBER`/`COUNT` 帧计算） |

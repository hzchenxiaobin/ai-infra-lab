...
title: 合并二叉树
tags: [DFS, 二叉树, 树, 递归]
knowledge_points: [binary-tree, dfs, recursion, tree]
updated: 2026-09-03
source: leetcode
number: 617
difficulty: easy
...
- **标题 / 题号**：合并二叉树（#617，easy）
- **链接**：https://leetcode.cn/problems/merge-two-binary-trees/
- **难度**：简单
- **标签**：树、二叉树、递归、DFS

**题意**：给你两棵二叉树 `root1` 和 `root2`，将它们**重叠合并**为一棵新树。合并规则：
...
![示例1](https://assets.leetcode.com/uploads/2021/02/05/merge.jpg)
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 100 | [相同的树](https://leetcode.cn/problems/same-tree/)（[题解](../0001-0100/100_相同的树.md)） | 两棵树同步递归判定的母题，骨架与本题一致 |

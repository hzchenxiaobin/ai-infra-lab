...
title: 给字符串添加加粗标签
tags: [区间合并, 字符串, 数组]
knowledge_points: [array, interval-merge, string]
updated: 2026-09-03
source: leetcode
number: 616
difficulty: medium
...
# LeetCode 给字符串添加加粗标签 题解

## 1. 题目概述

- **标题 / 题号**：给字符串添加加粗标签（#616，medium）
- **链接**：https://leetcode.cn/problems/add-bold-tag-in-string/
- **难度**：中等
- **标签**：字符串、数组、区间合并

**题意**：给定一个字符串 `s` 和一个单词字典 `dict`，需要用一对加粗标签 `<b>` 和 `</b>` 包裹 `s` 中所有出现在 `dict` 里的子串。规则：

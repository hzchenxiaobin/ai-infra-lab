...
type: problem
title: 用三种不同颜色为网格涂色
tags: [动态规划, 状态压缩, 矩阵快速幂]
knowledge_points: [bitmask-dp, dynamic-programming, matrix-fast-power]
updated: 2026-09-03
source: leetcode
number: 1931
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/06/22/colorthegrid.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/22/copy-of-colorthegrid.png)

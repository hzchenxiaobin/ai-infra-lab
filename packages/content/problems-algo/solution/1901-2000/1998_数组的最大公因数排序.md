...
type: problem
title: 数组的最大公因数排序
tags: [并查集, 排序, 数学, 质因数分解]
knowledge_points: [math, prime-factorization, sorting, union-find]
updated: 2026-09-03
source: leetcode
number: 1998
difficulty: hard
...
# LeetCode 数组的最大公因数排序 题解

## 1. 题目概述

- **标题 / 题号**：数组的最大公因数排序（#1998，hard）
- **链接**：https://leetcode.cn/problems/gcd-sort-of-an-array/
- **难度**：困难
- **标签**：并查集、数学、质因数分解、排序

**题意**：给定一个整数数组 `nums`，可以对它执行**任意次**如下操作：

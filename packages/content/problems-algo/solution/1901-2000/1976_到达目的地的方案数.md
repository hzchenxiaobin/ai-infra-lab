...
type: problem
title: 到达目的地的方案数
tags: [Dijkstra, 图, 最短路径, 计数]
knowledge_points: [counting, dijkstra, graph, shortest-path]
updated: 2026-09-03
source: leetcode
number: 1976
difficulty: medium
...
# LeetCode 到达目的地的方案数 题解

## 1. 题目概述

- **标题 / 题号**：到达目的地的方案数（#1976，medium）
- **链接**：https://leetcode.cn/problems/number-of-ways-to-arrive-at-destination/
- **难度**：中等
- **标签**：图、最短路径、Dijkstra、计数

**题意**：城市由 $n$ 个路口组成（编号 $0$ 到 $n-1$），某些路口之间有**双向**道路。保证图连通，且任意两路口之间最多一条路。
...
![示例1](https://assets.leetcode.com/uploads/2025/02/14/1976_corrected.png)

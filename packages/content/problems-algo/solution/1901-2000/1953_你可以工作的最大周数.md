...
title: 你可以工作的最大周数
tags: [数学, 计数, 贪心]
knowledge_points: [counting, greedy, math]
updated: 2026-09-03
source: leetcode
number: 1953
difficulty: medium
...
# LeetCode 你可以工作的最大周数 题解

## 1. 题目概述

- **标题 / 题号**：你可以工作的最大周数（#1953，medium）
- **链接**：https://leetcode.cn/problems/maximum-number-of-weeks-for-which-you-can-work/
- **难度**：中等
- **标签**：贪心、数学、计数

**题意**：给你 $n$ 个项目，编号从 $0$ 到 $n-1$。同时给你一个整数数组 `milestones`，其中每个 `milestones[i]` 表示第 $i$ 个项目中的阶段任务数量。

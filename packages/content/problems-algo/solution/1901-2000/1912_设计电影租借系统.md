...
title: 设计电影租借系统
tags: [哈希表, 有序集合, 设计]
knowledge_points: [design, hash-table, ordered-set]
updated: 2026-09-03
source: leetcode
number: 1912
difficulty: hard
...
# LeetCode 设计电影租借系统 题解

## 1. 题目概述

- **标题 / 题号**：设计电影租借系统（#1912，hard）
- **链接**：https://leetcode.cn/problems/design-movie-rental-system/
- **难度**：困难
- **标签**：设计、哈希表、有序集合

**题意**：你有一个电影租借公司和 $n$ 个电影商店，想要实现一个支持**查询、预订、返还和报告**的电影租借系统。
...
| 460 | [LFU 缓存](https://leetcode.cn/problems/lfu-cache/)（[题解](../0401-0500/460_LFU缓存.md)） | 更复杂的设计题，频率桶 + 哈希表，对比本题的有序集合选型 |

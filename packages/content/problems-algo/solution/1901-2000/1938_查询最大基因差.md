...
type: problem
title: 查询最大基因差
tags: [位运算, 字典树, 树, 深度优先搜索, 离线查询]
knowledge_points: [bit-manipulation, dfs, offline-queries, tree, trie]
updated: 2026-09-03
source: leetcode
number: 1938
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/06/29/c1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/29/c2.png)

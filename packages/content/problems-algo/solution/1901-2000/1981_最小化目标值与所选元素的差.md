...
type: problem
title: 最小化目标值与所选元素的差
tags: [bitset, 动态规划, "可达和 DP"]
knowledge_points: [bitset, dynamic-programming, reachable-sum-dp]
updated: 2026-09-03
source: leetcode
number: 1981
difficulty: medium
...
# LeetCode 最小化目标值与所选元素的差 题解

## 1. 题目概述

- **标题 / 题号**：最小化目标值与所选元素的差（#1981，medium）
- **链接**：https://leetcode.cn/problems/minimize-the-difference-between-target-and-chosen-elements/
- **难度**：中等
- **标签**：动态规划、可达和 DP、bitset

**题意**：给定大小为 $m \times n$ 的整数矩阵 `mat` 和整数 `target`。从矩阵的**每一行**中选择一个整数，使所有选中元素之**和**与 `target` 的**绝对差**最小。返回该最小绝对差。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2021/08/03/matrix1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/08/03/matrix1-1.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/08/03/matrix1-3.png)

...
type: problem
title: 丢失信息的雇员
tags: ["GROUP BY", HAVING, "IS NULL", "LEFT JOIN", "NOT IN 的 NULL 陷阱", SQL, "UNION ALL", "对称差（symmetric difference）", 数据库]
knowledge_points: [database, group-by, having, is-null, left-join, not-in-null-trap, not-in-的-null-陷阱, sql, union-all, 对称差-symmetric-difference]
updated: 2026-09-03
source: leetcode
number: 1965
difficulty: easy

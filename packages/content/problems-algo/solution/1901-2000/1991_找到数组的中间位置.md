...
title: 找到数组的中间位置
tags: [前缀和, 数组]
knowledge_points: [array, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 1991
difficulty: easy
...
# LeetCode 找到数组的中间位置 题解

## 1. 题目概述

- **标题 / 题号**：找到数组的中间位置（#1991，easy）
- **链接**：https://leetcode.cn/problems/find-the-middle-index-in-array/
- **难度**：简单
- **标签**：数组、前缀和

**题意**：给你一个下标从 **0** 开始的整数数组 `nums`，请你找到 **最左边** 的中间位置 `middleIndex`（也就是所有可能中间位置下标最小的一个）。

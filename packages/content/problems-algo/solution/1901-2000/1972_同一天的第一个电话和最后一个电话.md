...
id: "lc:1972"
type: problem
title: 同一天的第一个电话和最后一个电话
tags: [CTE, "MIN/MAX 聚合", ROW_NUMBER, SQL, "UNION ALL（角色展开 / 逆透视 UNPIVOT）", 数据库, 窗口函数, "自连接（Self-Join）"]
knowledge_points: [cte, database, min-max-聚合, row-number, self-join, sql, union-all-角色展开-逆透视-unpivot, window-function]
updated: 2026-09-03
source: leetcode
number: 1972
difficulty: hard

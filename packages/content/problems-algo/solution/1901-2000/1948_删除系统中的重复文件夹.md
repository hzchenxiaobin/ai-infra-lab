...
type: problem
title: 删除系统中的重复文件夹
tags: [哈希函数, 哈希表, 字典树, 字符串, 排序, 深度优先搜索]
knowledge_points: [dfs, hash-function, hash-table, sorting, string, trie]
updated: 2026-09-03
source: leetcode
number: 1948
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/07/19/lc-dupfolder1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/07/19/lc-dupfolder2.jpg)
...
![示例3](https://assets.leetcode.com/uploads/2021/07/19/lc-dupfolder3.jpg)
...
![示例4](https://assets.leetcode.com/uploads/2021/07/19/lc-dupfolder4_.jpg)

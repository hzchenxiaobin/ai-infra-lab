...
type: problem
title: 你能穿过矩阵的最后一天
tags: [二分查找, 并查集, 广度优先搜索, 网格, 连通性]
knowledge_points: [bfs, binary-search, connectivity, grid, union-find, 网格]
updated: 2026-09-03
source: leetcode
number: 1970
difficulty: hard
...
# LeetCode 你能穿过矩阵的最后一天 题解

## 1. 题目概述

- **标题 / 题号**：你能穿过矩阵的最后一天（#1970，hard）
- **链接**：https://leetcode.cn/problems/last-day-where-you-can-still-cross/
- **难度**：困难
- **标签**：并查集、二分查找、广度优先搜索、网格、连通性

**题意**：给你一个下标从 **1** 开始的二进制矩阵，`0` 表示陆地、`1` 表示水域。矩阵有 `row` 行 `col` 列。一开始（第 `0` 天）整个矩阵都是陆地；每一天都会有一块陆地被水淹没变成水域。
...
![示例1](https://assets.leetcode.com/uploads/2021/07/27/1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/07/27/2.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/07/27/3.png)

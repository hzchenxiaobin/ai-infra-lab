...
type: problem
title: 主动请求确认消息的用户
tags: [DISTINCT, SQL, TIMESTAMPDIFF, 数据库, 时间差比较, "窗口函数 LAG", "自连接（self-join）"]
knowledge_points: [database, distinct, self-join, sql, timestampdiff, window-lag, 时间差比较, 窗口函数-lag]
updated: 2026-09-03
source: leetcode
number: 1939
difficulty: easy

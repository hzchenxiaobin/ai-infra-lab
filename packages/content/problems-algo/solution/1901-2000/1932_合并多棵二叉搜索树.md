...
type: problem
title: 合并多棵二叉搜索树
tags: [二叉搜索树, 哈希表, 树, 深度优先搜索]
knowledge_points: [bst, dfs, hash-table, tree]
updated: 2026-09-03
source: leetcode
number: 1932
difficulty: hard
...
# LeetCode 合并多棵二叉搜索树 题解

## 1. 题目概述

- **标题 / 题号**：合并多棵二叉搜索树（#1932，hard）
- **链接**：https://leetcode.cn/problems/merge-bsts-to-create-single-bst/
- **难度**：困难
- **标签**：树、二叉搜索树、深度优先搜索、哈希表

**题意**：给你 $n$ 个**二叉搜索树的根节点**，存储在数组 `trees` 中。每棵 BST 最多有 $3$ 个节点，且不存在值相同的两个根节点。
...
![示例1](https://assets.leetcode.com/uploads/2021/06/08/d1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/24/diagram.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/06/24/diagram-2.png)

...
title: 树上的操作
tags: [树, 深度优先搜索, 设计]
knowledge_points: [design, dfs, tree]
updated: 2026-09-03
source: leetcode
number: 1993
difficulty: medium
...
- **标题 / 题号**：树上的操作（#1993，medium）
- **链接**：https://leetcode.cn/problems/operations-on-tree/
- **难度**：中等
- **标签**：设计、树、深度优先搜索

**题意**：给你一棵 $n$ 个节点的树，编号 $0$ 到 $n-1$，以父节点数组 `parent` 给出（`parent[i]` 是节点 $i$ 的父节点，`parent[0] = -1` 表示根）。要求设计数据结构 `LockingTree`，支持三种操作：
...
![示例1](https://assets.leetcode.com/uploads/2021/07/29/untitled.png)
...
| 236 | [二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)（[题解](../0201-0300/236_二叉树的最近公共祖先.md)） | 树的后序 DFS + 祖先链判定，与本题 upgrade 的「上溯祖先」同源 |

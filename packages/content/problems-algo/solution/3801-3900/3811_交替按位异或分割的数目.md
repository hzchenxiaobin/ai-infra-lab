...
type: problem
title: 交替按位异或分割的数目
tags: [位运算, 动态规划, 哈希表, 数组]
knowledge_points: [array, bit-manipulation, dynamic-programming, hash-table]
updated: 2026-09-03
source: leetcode
number: 3811
difficulty: medium
...
# LeetCode 交替按位异或分割的数目 题解

## 1. 题目概述

- **标题 / 题号**：交替按位异或分割的数目（#3811，medium）
- **链接**：https://leetcode.cn/problems/number-of-alternating-xor-partitions/
- **难度**：中等
- **标签**：位运算、数组、哈希表、动态规划

**题意**：给你一个整数数组 `nums` 以及两个**互不相同**的整数 `target1` 和 `target2`。

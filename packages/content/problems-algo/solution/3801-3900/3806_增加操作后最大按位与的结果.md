...
title: 增加操作后最大按位与的结果
tags: [位运算, 排序, 数组, 贪心]
knowledge_points: [array, bit-manipulation, greedy, sorting]
updated: 2026-09-03
source: leetcode
number: 3806
difficulty: hard
...
# LeetCode 增加操作后最大按位与的结果 题解

## 1. 题目概述

- **标题 / 题号**：增加操作后最大按位与的结果（#3806，hard）
...
**约束**：$1 \le n = nums.length \le 5 \times 10^4$，$1 \le nums[i] \le 10^9$，$1 \le k \le 10^9$，$1 \le m \le n$。

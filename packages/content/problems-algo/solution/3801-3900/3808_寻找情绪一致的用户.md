...
type: problem
title: 寻找情绪一致的用户
tags: ["GROUP BY", "ROUND 舍入", SQL, 数据库, "窗口函数（SUM(COUNT(*)) OVER）", 组内占比过滤]
knowledge_points: [database, group-by, round-舍入, sql, 窗口函数-sum-count-over, 组内占比过滤]
updated: 2026-09-03
source: leetcode
number: 3808
difficulty: medium
...
# LeetCode 寻找情绪一致的用户 题解

## 1. 题目概述

- **标题 / 题号**：寻找情绪一致的用户（#3808，medium）

...
type: problem
title: 统计区间内奇妙数的数目
tags: [容斥原理, 数位动态规划, 数学, 状态压缩枚举]
knowledge_points: [inclusion-exclusion, math, 数位动态规划, 状态压缩枚举]
updated: 2026-09-03
source: leetcode
number: 3869
difficulty: hard
...
# LeetCode 统计区间内奇妙数的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计区间内奇妙数的数目（#3869，hard）
- **链接**：https://leetcode.cn/problems/count-fancy-numbers-in-a-range/
- **难度**：困难
- **标签**：数学、数位动态规划、状态压缩枚举、容斥原理

**题意**：给你两个整数 $l$ 和 $r$。定义两类数：

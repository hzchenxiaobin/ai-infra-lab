...
type: problem
title: 最小分割分数
tags: [分治, 前缀和, 动态规划, 单调队列, "斜率优化（Convex Hull Trick）"]
knowledge_points: [divide-and-conquer, dynamic-programming, monotonic-queue, prefix-sum, 斜率优化-convex-hull-trick]
updated: 2026-09-03
source: leetcode
number: 3826
difficulty: hard

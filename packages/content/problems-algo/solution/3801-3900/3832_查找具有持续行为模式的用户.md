...
type: problem
title: 查找具有持续行为模式的用户
tags: ["COUNT(*) OVER", CTE, DATE_SUB, "Gaps and Islands（间隙与孤岛）", "ROW_NUMBER()", SQL, "Top-1 per group", 数据库, 窗口函数]
knowledge_points: [count-over, cte, database, date-sub, gaps-and-islands-间隙与孤岛, group-top1, row-number, sql, top-1-per-group, window-function]
updated: 2026-09-03
source: leetcode
number: 3832
difficulty: hard

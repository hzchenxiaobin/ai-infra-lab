...
type: problem
title: 不违反限制的最大请求数
tags: [哈希表, 排序, 数组, 滑动窗口, 贪心]
knowledge_points: [array, greedy, hash-table, sliding-window, sorting]
updated: 2026-09-03
source: leetcode
number: 3851
difficulty: medium
...
# LeetCode 不违反限制的最大请求数 题解

## 1. 题目概述

- **标题 / 题号**：不违反限制的最大请求数（#3851，medium）
- **链接**：https://leetcode.cn/problems/maximum-requests-without-violating-the-limit/
- **难度**：中等

...
id: "lc:3859"
type: problem
title: 统计包含K个不同整数的子数组
tags: [哈希表, 数组, 滑动窗口, 计数]
knowledge_points: [array, counting, hash-table, sliding-window]
updated: 2026-09-03
source: leetcode
number: 3859
difficulty: hard
...
# LeetCode 统计包含K个不同整数的子数组 题解

## 1. 题目概述

- **标题 / 题号**：统计包含K个不同整数的子数组（#3859，hard）
- **链接**：https://leetcode.cn/problems/count-subarrays-with-k-distinct-integers/
- **难度**：困难
- **标签**：数组、哈希表、计数、滑动窗口

...
id: "lc:3835"
type: problem
title: "开销小于等于 K 的子数组数目"
tags: [单调队列, 数组, 滑动窗口, 队列]
knowledge_points: [array, monotonic-queue, queue, sliding-window]
updated: 2026-09-03
source: leetcode
number: 3835
difficulty: medium
...
# LeetCode 开销小于等于 K 的子数组数目 题解

## 1. 题目概述

- **标题 / 题号**：开销小于等于 K 的子数组数目（#3835，medium）
- **链接**：https://leetcode.cn/problems/count-subarrays-with-cost-less-than-or-equal-to-k/
- **难度**：中等
- **标签**：队列、数组、滑动窗口、单调队列

**题意**：给你一个整数数组 `nums` 和一个整数 `k`。对于任意子数组 `nums[l..r]`，其**开销**定义为：

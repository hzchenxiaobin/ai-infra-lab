...
type: problem
title: 最优账单平衡
tags: [位掩码, 位运算, 动态规划, 回溯, 数组]
knowledge_points: [array, backtracking, bit-manipulation, bitmask, dynamic-programming]
updated: 2026-09-03
source: leetcode
number: 465
difficulty: hard
...
| 526 | [优美的排列](https://leetcode.cn/problems/beautiful-arrangement/)（[题解](../0501-0600/526_优美的排列.md)） | `mask` 状压 + 记忆化的计数型 DP，与本题同属位掩码状态空间设计，对比「计数」与「最优化」两类目标 |

...
type: problem
title: 统计重复个数
tags: [动态规划, 子序列匹配, 字符串, 循环节]
knowledge_points: [dynamic-programming, string, subsequence-matching, 子序列匹配, 循环节]
updated: 2026-09-03
source: leetcode
number: 466
difficulty: hard
...
| 202 | [快乐数](https://leetcode.cn/problems/happy-number/)（[题解](../0201-0300/202_快乐数.md)） | 数位平方和序列，状态为当前数，Floyd 判圈，同为「隐式链表判环」 |

...
type: problem
title: 祖玛游戏
tags: [回溯, 字符串, 深度优先搜索, 记忆化搜索]
knowledge_points: [backtracking, dfs, memoization, string]
updated: 2026-09-03
source: leetcode
number: 488
difficulty: hard
...
| 652 | [寻找重复子树](https://leetcode.cn/problems/find-duplicate-subtrees/)（[题解](../0601-0700/652_寻找重复的子树.md)） | 树结构序列化编码 + 哈希去重，记忆化思想的另一形态 |

...
title: 青蛙过河
tags: [动态规划, 哈希表, 数组]
knowledge_points: [array, dynamic-programming, hash-table]
updated: 2026-09-03
source: leetcode
number: 403
difficulty: hard
...
| 45 | [跳跃游戏 II](https://leetcode.cn/problems/jump-game-ii/)（[题解](../0001-0100/45_跳跃游戏%20II.md)） | 同模型求最少步数，贪心维护当前能达最远 |
| 139 | [单词拆分](https://leetcode.cn/problems/word-break/)（[题解](../0101-0200/139_单词拆分.md)） | 前向 DP + 哈希查询，结构相似的「前向传播」 |

...
type: problem
title: 我能赢吗
tags: [位运算, 博弈, 极小化极大, 状态压缩, 记忆化搜索]
knowledge_points: [bit-manipulation, bitmask-dp, game-theory, memoization, minimax]
updated: 2026-09-03
source: leetcode
number: 464
difficulty: medium
...
| 526 | [优美的排列](https://leetcode.cn/problems/beautiful-arrangement/)（[题解](../0501-0600/526_优美的排列.md)） | `mask` + 记忆化搜索的**计数型**状压 DP，与本题同模板、不同目标（计数 vs 博弈判定） |

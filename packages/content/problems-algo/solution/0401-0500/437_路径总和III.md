...
type: problem
title: "路径总和 III"
tags: [前缀和, 哈希表, 树, 深度优先搜索]
knowledge_points: [dfs, hash-table, prefix-sum, tree]
updated: 2026-09-03
source: leetcode
number: 437
difficulty: medium
...
judge: none
related_learn: ["learn:w07d01", "learn:w07d07"]
---

# LeetCode 路径总和 III 题解

## 1. 题目概述

- **标题 / 题号**：路径总和 III（#437，medium）
- **链接**：https://leetcode.cn/problems/path-sum-iii/
- **难度**：中等
- **标签**：树、深度优先搜索、前缀和、哈希表

**题意**：给定一棵二叉树的根节点 `root` 和一个整数 `targetSum`，求该树中**节点值之和等于 `targetSum`** 的**向下路径**的数目。

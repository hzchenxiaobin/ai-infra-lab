...
type: problem
title: 最短独占单词缩写
tags: [位运算, 回溯, 字符串, 深度优先搜索]
knowledge_points: [backtracking, bit-manipulation, dfs, string]
updated: 2026-09-03
source: leetcode
number: 411
difficulty: hard
...
| 526 | [优美的排列](https://leetcode.cn/problems/beautiful-arrangement/)（[题解](../0501-0600/526_优美的排列.md)） | 同样用位掩码 + DFS 剪枝枚举方案，$n \le 15$ 的状态压缩甜区 |

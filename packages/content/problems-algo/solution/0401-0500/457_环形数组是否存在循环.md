...
type: problem
title: 环形数组是否存在循环
tags: ["Floyd 判圈", 双指针, 数组]
knowledge_points: [array, floyd-cycle-detection, two-pointers]
updated: 2026-09-03
source: leetcode
number: 457
difficulty: medium
...
![示例1](https://pic.leetcode.cn/1723688159-qYjpWT-image.png)
...
![示例2](https://pic.leetcode.cn/1723688183-lRSkjp-image.png)
...
![示例3](https://pic.leetcode.cn/1723688199-nhaMuF-image.png)
...
| 142 | [环形链表 II](https://leetcode.cn/problems/linked-list-cycle-ii/)（[题解](../0101-0200/142_环形链表%20II.md)） | Floyd 找环入口，公式推导 a = c - b |

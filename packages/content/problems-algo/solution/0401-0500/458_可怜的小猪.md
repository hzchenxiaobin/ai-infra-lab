...
title: 可怜的小猪
tags: [信息论, 对数, 思维题, 数学]
knowledge_points: [constructive-thinking, logarithm, math, 信息论, 对数]
updated: 2026-09-03
source: leetcode
number: 458
difficulty: hard
...
- **标题 / 题号**：可怜的小猪（#458，hard）
- **链接**：https://leetcode.cn/problems/poor-pigs/
- **难度**：困难
- **标签**：数学、信息论、对数、思维题

**题意**：有 `buckets` 桶液体，其中**正好有一桶**含有毒药，其余装的都是水，外观无法区分。你只有 `minutesToTest` 分钟来确定哪一桶有毒。喂猪规则：

...
type: problem
title: 序列化和反序列化二叉搜索树
tags: [二叉搜索树, 树, 深度优先搜索, 设计]
knowledge_points: [bst, design, dfs, tree]
updated: 2026-09-03
source: leetcode
number: 449
difficulty: medium
...
# LeetCode 序列化和反序列化二叉搜索树 题解

## 1. 题目概述

- **标题 / 题号**：序列化和反序列化二叉搜索树（#449，medium）
- **链接**：https://leetcode.cn/problems/serialize-and-deserialize-bst/
- **难度**：中等
- **标签**：树、二叉搜索树、深度优先搜索、设计

**题意**：设计一个算法来**序列化**与**反序列化**一棵**二叉搜索树（BST）**。序列化是把 BST 转为字符串，反序列化是从该字符串重建出原来的 BST。要求对空树也能正确处理。

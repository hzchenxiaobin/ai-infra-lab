...
type: problem
title: "接雨水 II"
tags: [优先队列, 图, 堆, 广度优先搜索]
knowledge_points: [bfs, graph, heap]
updated: 2026-09-03
source: leetcode
number: 407
difficulty: hard
...
- **标题 / 题号**：接雨水 II（#407，hard）
- **链接**：https://leetcode.cn/problems/trapping-rain-water-ii/
- **难度**：困难
- **标签**：堆、优先队列、广度优先搜索、图

**题意**：给定一个 `m x n` 的非负整数矩阵 `heightMap`，每个元素表示该位置柱子的高度。下雨后，水会被周围更高的柱子挡住，计算这个**二维高度图**能接多少雨水。

这是 [42. 接雨水](../0001-0100/42_接雨水.md) 的二维版本：从「一维数组的左右两边界」升级到「二维网格的四周一圈边界」。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2021/04/08/trap1-3d.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/04/08/trap2-3d.jpg)

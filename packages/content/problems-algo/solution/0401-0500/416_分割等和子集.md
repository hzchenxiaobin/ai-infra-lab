...
title: 分割等和子集
tags: [动态规划, 数组, 背包]
knowledge_points: [array, dynamic-programming, knapsack]
updated: 2026-09-03
source: leetcode
number: 416
difficulty: medium
...
- **标题 / 题号**：分割等和子集（#416，medium）
- **链接**：https://leetcode.cn/problems/partition-equal-subset-sum/
- **难度**：中等
- **标签**：数组、动态规划、背包

**题意**：给定一个**只含正整数**的非空数组 `nums`，请你判断是否能将其**分割成两个子集**，使两个子集的元素之和相等。
...
| 1049 | [最后一块石头的重量 II](https://leetcode.cn/problems/last-stone-weight-ii/)（[题解](../1001-1100/1049_最后一块石头的重量II.md)） | 转化为尽量装满一半 |
| 322 | [零钱兑换](https://leetcode.cn/problems/coin-change/)（[题解](../0301-0400/322_零钱兑换.md)） | 完全背包版（物品可重复用） |

...
tags: [中序遍历, 二叉搜索树, 树, 链表]
knowledge_points: [bst, inorder-traversal, linked-list, tree]
updated: 2026-09-03
source: leetcode
number: 426
difficulty: medium
...
# LeetCode 将二叉搜索树转化为排序的双向链表 题解

## 1. 题目概述

- **标题 / 题号**：将二叉搜索树转化为排序的双向链表（#426，medium）
- **链接**：https://leetcode.cn/problems/convert-binary-search-tree-to-sorted-doubly-linked-list/
- **难度**：中等
- **标签**：树、链表、二叉搜索树、中序遍历

**题意**：给定一棵**二叉搜索树（BST）**的根节点 `root`。请将其转化为一个**排序的循环双向链表**，要求：

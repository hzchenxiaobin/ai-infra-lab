...
type: problem
title: 按日期分组销售产品
tags: ["COUNT(DISTINCT)", DISTINCT, "GROUP BY", GROUP_CONCAT, "ORDER BY", SQL, 聚合函数]
knowledge_points: [aggregate-function, count-distinct, distinct, group-by, group-concat, order-by, sql]
updated: 2026-09-03
source: leetcode
number: 1484
difficulty: easy

...
- **标题 / 题号**：摘樱桃 II（#1463，hard）
- **链接**：https://leetcode.cn/problems/cherry-pickup-ii/
- **难度**：困难
- **标签**：数组、动态规划、网格 DP

**题意**：给定一个 `rows x cols` 的矩阵 `grid` 表示樱桃地，每个格子的数字表示该位置的樱桃数目。两个机器人从第一行同时出发：
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/05/30/sample_1_1802.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/05/30/sample_2_1802.png)

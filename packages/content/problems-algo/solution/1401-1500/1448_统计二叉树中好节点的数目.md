...
type: problem
title: 统计二叉树中好节点的数目
tags: [二叉树, 前序遍历, 树, 深度优先搜索]
knowledge_points: [binary-tree, dfs, preorder-traversal, tree]
updated: 2026-09-03
source: leetcode
number: 1448
difficulty: medium
...
# LeetCode 统计二叉树中好节点的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计二叉树中好节点的数目（#1448，medium）
- **链接**：https://leetcode.cn/problems/count-good-nodes-in-binary-tree/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索、前序遍历

**题意**：给定一棵二叉树的根节点 `root`，统计其中**好节点**的数量。

> **好节点**：在从根到该节点 `X` 的路径上，**没有任何节点的值大于** `X.val`（即 `X` 是该路径上的最大值，等值不算「更大」）。

**示例 1**：

![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/05/16/test_sample_1.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/05/16/test_sample_2.png)

...
title: 数组中的字符串匹配
tags: [字符串, 排序, 暴力]
knowledge_points: [brute-force, sorting, string]
updated: 2026-09-03
source: leetcode
number: 1408
difficulty: easy
...
# LeetCode 数组中的字符串匹配 题解

## 1. 题目概述

- **标题 / 题号**：数组中的字符串匹配（#1408，easy）
- **链接**：https://leetcode.cn/problems/string-matching-in-an-array/
- **难度**：简单
- **标签**：字符串、暴力、排序

**题意**：给你一个字符串数组 `words`，数组中的每个字符串都可以看作是一个单词。请你按**任意顺序**返回 `words` 中是其他单词的**子字符串**的所有单词。

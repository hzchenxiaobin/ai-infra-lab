...
type: problem
title: 计算税后工资
tags: ["CASE WHEN", "GROUP BY", JOIN, ROUND, SQL, 分级税率, 子查询, "窗口函数 MAX OVER", 聚合]
knowledge_points: [aggregation, case-when, group-by, join, round, sql, subquery, 分级税率, 窗口函数-max-over]
updated: 2026-09-03
source: leetcode
number: 1468
difficulty: medium

...
type: problem
title: 活跃用户
tags: [DATE_SUB/DATEDIFF, DISTINCT, "GROUP BY + HAVING", JOIN, ROW_NUMBER, SQL, 数据库, 窗口函数, 连续区间分组]
knowledge_points: [database, date-sub-datediff, distinct, group-by-having, join, row-number, sql, window-function, 连续区间分组]
updated: 2026-09-03
source: leetcode
number: 1454
difficulty: medium

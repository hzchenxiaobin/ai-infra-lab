...
type: problem
title: 最大数量高于平均水平的订单
tags: ["ALL 量词", "GROUP BY", SQL, 两趟聚合, 子查询, 数据库, "窗口函数 MAX() OVER()", "聚合函数 MAX/AVG"]
knowledge_points: [all-量词, database, group-by, sql, subquery, 两趟聚合, 窗口函数-max-over, 聚合函数-max-avg]
updated: 2026-09-03
source: leetcode
number: 1867
difficulty: medium

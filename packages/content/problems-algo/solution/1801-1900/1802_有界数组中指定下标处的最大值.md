...
tags: [二分查找, 数学, 贪心]
knowledge_points: [binary-search, greedy, math]
updated: 2026-09-03
source: leetcode
number: 1802
difficulty: medium
...
# LeetCode 有界数组中指定下标处的最大值 题解

## 1. 题目概述

- **标题 / 题号**：有界数组中指定下标处的最大值（#1802，medium）
- **链接**：https://leetcode.cn/problems/maximum-value-at-a-given-index-in-a-bounded-array/
- **难度**：中等
- **标签**：二分查找、贪心、数学

**题意**：给你三个正整数 `n`、`index` 和 `maxSum`。你需要构造一个满足下述条件的长为 `n` 的下标从 0 开始的正整数数组 `nums`：

...
# LeetCode 最少操作使数组递增 题解

## 1. 题目概述

- **标题 / 题号**：最少操作使数组递增（#1827，easy）
- **链接**：https://leetcode.cn/problems/minimum-operations-to-make-the-array-increasing/
- **难度**：简单
- **标签**：数组、贪心

**题意**：给你一个整数数组 `nums`（**下标从 0 开始**）。每一次操作中，你可以选择数组中**一个**元素，并将它**增加 1**。请你返回使 `nums` **严格递增**的**最少**操作次数。
...
| 45 | [跳跃游戏 II](https://leetcode.cn/problems/jump-game-ii/)（[站内题解](../0001-0100/45_跳跃游戏%20II.md)） | 贪心维护当前可达范围，同为「一次遍历 + 局部最优拼全局最优」的贪心招牌题 |

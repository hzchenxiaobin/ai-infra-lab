...
title: 使字符串有序的最少操作次数
tags: [字符串, 数学, 组合数学, 逆元]
knowledge_points: [combinatorics, math, string, 逆元]
updated: 2026-09-03
source: leetcode
number: 1830
difficulty: hard
...
# LeetCode 使字符串有序的最少操作次数 题解

## 1. 题目概述

- **标题 / 题号**：使字符串有序的最少操作次数（#1830，hard）
- **链接**：https://leetcode.cn/problems/minimum-number-of-operations-to-make-string-sorted/
- **难度**：困难
- **标签**：数学、组合数学、字符串、逆元

**题意**：给定字符串 `s`（下标从 0 开始），反复执行以下操作直到 `s` 变为有序（非降序）：
...
| 172 | [阶乘后的零](https://leetcode.cn/problems/factorial-trailing-zeroes/)（[题解](../0101-0200/172_阶乘后的零.md)） | 阶乘的数论性质，巩固模运算与阶乘相关的组合计数基础 |

...
type: problem
title: 计算特殊奖金
tags: ["CASE WHEN", "LIKE 模式匹配", "ORDER BY", SQL, 取模运算, 条件表达式]
knowledge_points: [case-when, like-模式匹配, modular-arithmetic, order-by, sql, 条件表达式]
updated: 2026-09-03
source: leetcode
number: 1873
difficulty: easy

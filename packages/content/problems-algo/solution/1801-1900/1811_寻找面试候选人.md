...
type: problem
title: 寻找面试候选人
tags: ["GROUP BY + HAVING", JOIN, SQL, "UNION ALL（逆透视 UNPIVOT）", 数据库, "窗口函数 LEAD", "自连接（Self-Join）", 连续区间判定]
knowledge_points: [database, gaps-and-islands, group-by-having, join, self-join, sql, union-all-逆透视-unpivot, 窗口函数-lead]
updated: 2026-09-03
source: leetcode
number: 1811
difficulty: medium
...
**题意**：自 2018 年起，Google 通过举办 Kickstart 比赛招募新员工。每场比赛的**金、银、铜牌**得主记录在 `Contests` 表中。现需从中筛选**面试候选人**——满足以下**任一**条件即入选：

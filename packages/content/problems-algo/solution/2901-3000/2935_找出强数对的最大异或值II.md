...
id: "lc:2935"
type: problem
title: "找出强数对的最大异或值 II"
tags: [位运算, "字典树（0-1 Trie）", 数组, 滑动窗口]
knowledge_points: [01-trie, array, bit-manipulation, sliding-window]
updated: 2026-09-03
source: leetcode
number: 2935
difficulty: hard
...
# LeetCode 找出强数对的最大异或值 II 题解

## 1. 题目概述

- **标题 / 题号**：找出强数对的最大异或值 II（#2935，hard）

...
tags: [二分查找, 哈希表, 字符串, 滑动窗口, 计数]
knowledge_points: [binary-search, counting, hash-table, sliding-window, string]
updated: 2026-09-03
source: leetcode
number: 2981
difficulty: medium
...
# LeetCode 找出出现至少三次的最长特殊子字符串 I 题解

## 1. 题目概述

- **标题 / 题号**：找出出现至少三次的最长特殊子字符串 I（#2981，medium）

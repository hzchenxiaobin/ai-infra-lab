...
id: "lc:2975"
type: problem
title: 移除栅栏得到的正方形田地的最大面积
tags: [哈希表, 数组, 枚举]
knowledge_points: [array, enumeration, hash-table]
updated: 2026-09-03
source: leetcode
number: 2975
difficulty: medium
...
# LeetCode 移除栅栏得到的正方形田地的最大面积 题解

## 1. 题目概述

- **标题 / 题号**：移除栅栏得到的正方形田地的最大面积（#2975，medium）
- **链接**：https://leetcode.cn/problems/maximum-square-area-by-removing-fences-from-a-field/
- **难度**：中等
- **标签**：数组、哈希表、枚举

**题意**：有一个大型的 $(m-1) \times (n-1)$ 矩形田地，两个对角分别为 $(1, 1)$ 和 $(m, n)$，田地内部有一些水平栅栏和垂直栅栏，分别由数组 `hFences` 和 `vFences` 给出：
...
![示例1](https://assets.leetcode.com/uploads/2023/11/05/screenshot-from-2023-11-05-22-40-25.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/11/22/maxsquareareaexample1.png)

...
type: problem
title: 贷款类型
tags: ["GROUP BY", HAVING, INTERSECT, SQL, "SUM(布尔表达式)", 数据库, 条件聚合, 集合交集判定]
knowledge_points: [conditional-aggregation, database, group-by, having, intersect, sql, sum-布尔表达式, 集合交集判定]
updated: 2026-09-03
source: leetcode
number: 2990
difficulty: easy

...
type: problem
title: "发生在周五的交易 II"
tags: ["LEFT JOIN", SQL, 数据库, 日历骨架, 日期函数, "递归 CTE"]
knowledge_points: [database, date-function, left-join, recursive-cte, sql, 日历骨架]
updated: 2026-09-03
source: leetcode
number: 2994
difficulty: hard
...
# LeetCode 发生在周五的交易 II 题解

## 1. 题目概述

- **标题 / 题号**：发生在周五的交易 II（#2994，hard）
- **链接**：https://leetcode.cn/problems/friday-purchases-ii/
- **难度**：困难

...
id: "lc:2967"
type: problem
title: 使数组成为等数数组的最小代价
tags: [二分查找, 排序, 数学, 数组, 贪心]
knowledge_points: [array, binary-search, greedy, math, sorting]
updated: 2026-09-03
source: leetcode
number: 2967
difficulty: medium
...
# LeetCode 使数组成为等数数组的最小代价 题解

## 1. 题目概述

- **标题 / 题号**：使数组成为等数数组的最小代价（#2967，medium）
- **链接**：https://leetcode.cn/problems/minimum-cost-to-make-array-equalindromic/
- **难度**：中等
- **标签**：贪心、数组、数学、二分查找、排序

**题意**：给你一个长度为 $n$、下标从 **0** 开始的整数数组 `nums`。你可以执行**特殊操作任意次**（也可以 0 次），每次操作依次执行：

...
title: 最贵的无法购买的商品
tags: [动态规划, 数学, 数论]
knowledge_points: [dynamic-programming, math, number-theory]
updated: 2026-09-03
source: leetcode
number: 2979
difficulty: medium
...
# LeetCode 最贵的无法购买的商品 题解

## 1. 题目概述

- **标题 / 题号**：最贵的无法购买的商品（#2979，medium）
...
**题意**：一家商店只收两种面值的硬币：`primeOne` 元和 `primeTwo` 元，且**不找零**。一件价格为 `v` 的商品是**可购买**的，当且仅当存在非负整数 $x, y$ 使得

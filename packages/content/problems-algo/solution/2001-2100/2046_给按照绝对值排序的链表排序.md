...
title: 给按照绝对值排序的链表排序
tags: [双指针, 排序, 链表]
knowledge_points: [linked-list, sorting, two-pointers]
updated: 2026-09-03
source: leetcode
number: 2046
difficulty: medium
...
# LeetCode 给按照绝对值排序的链表排序 题解

## 1. 题目概述

- **标题 / 题号**：给按照绝对值排序的链表排序（#2046，medium）
- **链接**：https://leetcode.cn/problems/sort-linked-list-already-sorted-using-absolute-values
- **难度**：中等
- **标签**：链表、双指针、排序

**题意**：给你一个链表的头结点 `head`，这个链表已经根据结点的**绝对值**进行**升序**排序。请你返回重新根据**结点的值**进行**升序**排序后的链表。

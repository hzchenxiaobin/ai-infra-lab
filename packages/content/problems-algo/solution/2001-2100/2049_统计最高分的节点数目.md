...
![示例1](https://assets.leetcode.com/uploads/2021/10/03/example-1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/10/03/example-2.png)
...
| 236 | [二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)（[题解](../0201-0300/236_二叉树的最近公共祖先.md)） | 后序 DFS 返回子树信息向上汇总，与本题 `size` 自底向上累加同源 |

...
type: problem
title: 解出数学表达式的学生分数
tags: [动态规划, "区间 DP", 字符串, 数学, 数组]
knowledge_points: [array, dynamic-programming, interval-dp, math, string]
updated: 2026-09-03
source: leetcode
number: 2019
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/09/17/student_solving_math.png)

...
tags: [数组, 网格, 贪心]
knowledge_points: [array, greedy, grid, 网格]
updated: 2026-09-03
source: leetcode
number: 2087
difficulty: medium
...
# LeetCode 网格图中机器人回家的最小代价 题解

## 1. 题目概述

- **标题 / 题号**：网格图中机器人回家的最小代价（#2087，medium）
- **链接**：https://leetcode.cn/problems/minimum-cost-homecoming-of-a-robot-in-a-grid/
- **难度**：中等
- **标签**：贪心、数组、网格

**题意**：给定一个 $m \times n$ 的网格图，左上角为 $(0,0)$，右下角为 $(m-1, n-1)$。机器人初始在 `startPos = [startrow, startcol]`，家在 `homePos = [homerow, homecol]`。机器人每一步可往**上、下、左、右**四个方向移动一格，不能越界。
...
![示例1](https://assets.leetcode.com/uploads/2021/10/11/eg-1.png)

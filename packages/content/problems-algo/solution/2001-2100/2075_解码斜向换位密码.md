...
title: 解码斜向换位密码
tags: [字符串, 模拟, 矩阵]
knowledge_points: [matrix, simulation, string, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2075
difficulty: medium
...
# LeetCode 解码斜向换位密码 题解

## 1. 题目概述

- **标题 / 题号**：解码斜向换位密码（#2075，medium）
- **链接**：https://leetcode.cn/problems/decode-the-slanted-ciphertext/
- **难度**：中等
- **标签**：字符串、矩阵、模拟

**题意**：字符串 `originalText` 使用**斜向换位密码**，经由行数固定为 `rows` 的矩阵辅助，加密得到字符串 `encodedText`。加密分两步：
...
![示例1](https://assets.leetcode.com/uploads/2021/11/07/exa11.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/11/07/exa12.png)
...
![示例3](https://assets.leetcode.com/uploads/2021/10/25/desc2.png)
...
![示例4](https://assets.leetcode.com/uploads/2021/10/26/exam1.png)

...
type: problem
title: 赢得比赛的大学
tags: ["CASE WHEN", COUNT, SQL, "WHERE 过滤", 数据库, 标量子查询, "笛卡尔积（隐式 CROSS JOIN）"]
knowledge_points: [case-when, count, database, sql, where-filter, where-过滤, 标量子查询, 笛卡尔积-隐式-cross-join]
updated: 2026-09-03
source: leetcode
number: 2072
difficulty: easy

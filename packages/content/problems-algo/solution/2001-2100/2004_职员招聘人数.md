...
type: problem
title: 职员招聘人数
tags: [CTE, IFNULL, "ORDER BY", SQL, "UNION ALL", 窗口函数, "累计求和（Running Sum）", 贪心]
knowledge_points: [cte, greedy, ifnull, order-by, sql, union-all, window-function, 累计求和-running-sum]
updated: 2026-09-03
source: leetcode
number: 2004
difficulty: hard

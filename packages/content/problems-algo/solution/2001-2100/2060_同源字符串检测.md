...
title: 同源字符串检测
tags: [动态规划, 双指针, 记忆化搜索]
knowledge_points: [dynamic-programming, memoization, two-pointers]
updated: 2026-09-03
source: leetcode
number: 2060
difficulty: hard
...
| 97 | [交错字符串](https://leetcode.cn/problems/interleaving-string/)（[题解](../0001-0100/97_交错字符串.md)） | 双串同步消费合并为第三串，状态 $(i, j)$ 追踪双指针位置，对比本题增加差值维度 |

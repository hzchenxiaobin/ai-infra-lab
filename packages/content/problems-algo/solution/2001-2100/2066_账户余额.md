...
type: problem
title: 账户余额
tags: ["CASE WHEN", "PARTITION BY", SQL, "SUM() OVER", 数据库, 窗口函数, 累计求和, 自连接]
knowledge_points: [case-when, database, partition-by, running-sum, self-join, sql, sum-over, window-function, 累计求和]
updated: 2026-09-03
source: leetcode
number: 2066
difficulty: medium

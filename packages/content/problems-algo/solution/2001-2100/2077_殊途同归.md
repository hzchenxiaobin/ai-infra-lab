...
title: 殊途同归
tags: [哈希表, 图]
knowledge_points: [graph, hash-table]
updated: 2026-09-03
source: leetcode
number: 2077
difficulty: medium
...
- **标题 / 题号**：殊途同归（#2077，medium）
- **链接**：https://leetcode.cn/problems/paths-in-maze-that-lead-to-same-room/
- **难度**：中等
- **标签**：图、哈希表

**题意**：迷宫由 `n` 个从 `1` 到 `n` 的房间组成，有些房间由走廊连接。给定二维整数数组 `corridors`，其中 `corridors[i] = [room1_i, room2_i]` 表示一条**双向**走廊连接 `room1_i` 与 `room2_i`。

...
type: problem
title: "重复 K 次的最长子序列"
tags: [子序列匹配, 字符串, 广度优先搜索, 贪心]
knowledge_points: [bfs, greedy, string, subsequence-matching, 子序列匹配]
updated: 2026-09-03
source: leetcode
number: 2014
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/08/30/longest-subsequence-repeat-k-times.png)

...
type: problem
title: 排序数组
tags: [分治, 归并排序, 快速排序, 数组]
knowledge_points: [array, divide-and-conquer, merge-sort, quicksort]
updated: 2026-09-03
source: leetcode
number: 912
difficulty: medium
...
judge: none
related_learn: ["learn:w01d04", "learn:w01d07"]
---
...
- **标题 / 题号**：排序数组（#912，medium）
- **链接**：https://leetcode.cn/problems/sort-an-array/
- **难度**：中等
- **标签**：数组、分治、快速排序、归并排序

**题意**：给你一个整数数组 `nums`，请你将该数组**升序**排列，并返回排序后的数组。

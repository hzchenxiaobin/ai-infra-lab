...
title: 由斜杠划分区域
tags: [图, 并查集, 深度优先搜索]
knowledge_points: [dfs, graph, union-find]
updated: 2026-09-03
source: leetcode
number: 959
difficulty: medium
...
- **标题 / 题号**：由斜杠划分区域（#959，medium）
- **链接**：https://leetcode.cn/problems/regions-cut-by-slashes/
- **难度**：中等
- **标签**：并查集、图、深度优先搜索

**题意**：在由 `1 x 1` 方格组成的 `n x n` 网格 `grid` 中，每个 `1 x 1` 方块由 `' '`、`'/'` 或 `'\'` 构成。这些字符会将方块划分为一些**共边的区域**。
...
![示例1](https://assets.leetcode.com/uploads/2018/12/15/1.png)
...
![示例2](https://assets.leetcode.com/uploads/2018/12/15/2.png)
...
![示例3](https://assets.leetcode.com/uploads/2018/12/15/4.png)
...
| 200 | [岛屿数量](https://leetcode.cn/problems/number-of-islands/)（[题解](../0101-0200/200_岛屿数量.md)） | DFS/BFS 求连通分量，可与本题像素放大法对照 |

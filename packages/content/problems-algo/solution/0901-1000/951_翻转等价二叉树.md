...
- **标题 / 题号**：翻转等价二叉树（#951，medium）
- **链接**：https://leetcode.cn/problems/flip-equivalent-binary-trees/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索

**题意**：定义「翻转操作」：选择二叉树中任意一个节点，交换它的左右子树。给定两棵二叉树的根节点 `root1` 和 `root2`，判断它们是否**翻转等价**——即能否通过若干次翻转操作（在任意一棵树上、任意节点处）使两棵树变得完全相同。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2018/11/29/tree_ex.png)

...
type: problem
title: 猫和老鼠
tags: [动态规划, 博弈论, 图, 广度优先搜索, 拓扑排序]
knowledge_points: [bfs, dynamic-programming, game-theory, graph, topological-sort]
updated: 2026-09-03
source: leetcode
number: 913
difficulty: hard
...
**题意**：猫和老鼠在一张**无向图**上博弈，轮流行动。`graph[a]` 给出节点 `a` 的所有邻居。老鼠从节点 `1` 出发且**先手**，猫从节点 `2` 出发且**后手**，节点 `0` 是洞。每回合玩家**必须**沿一条边移动；猫**不能进入洞**（节点 `0`）。游戏在三种情形下结束：
...
![示例1](https://assets.leetcode.com/uploads/2020/11/17/cat1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2020/11/17/cat2.jpg)

...
type: problem
title: 重新排列日志文件
tags: [字符串, 排序, 数组, 自定义比较]
knowledge_points: [array, sorting, string, 自定义比较]
updated: 2026-09-03
source: leetcode
number: 937
difficulty: medium
...
# LeetCode 重新排列日志文件 题解

## 1. 题目概述

- **标题 / 题号**：重新排列日志文件（#937，medium）
- **链接**：https://leetcode.cn/problems/reorder-data-in-log-files/
- **难度**：中等
- **标签**：数组、字符串、排序、自定义比较

**题意**：给你一个日志数组 `logs`，每条日志都是以空格分隔的字串，其第一个字为字母与数字混合的 **标识符**。日志分两类：

...
type: problem
title: 完全二叉树插入器
tags: [二叉树, "广度优先搜索（BFS）", 树, 设计]
knowledge_points: [bfs, binary-tree, design, tree]
updated: 2026-09-03
source: leetcode
number: 919
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2021/08/03/lc-treeinsert.jpg)
...
> 💡 编号法是 [222. 完全二叉树的节点个数](https://leetcode.cn/problems/count-complete-tree-nodes/) 与 [958 完全性检验](./958_二叉树的完全性检验.md) 编号解法的同源思路，适合「**给定编号定位节点**」类问题；本题的痛点是「**在线高频插入**」，队列法的 `O(1)` 摊还更契合。

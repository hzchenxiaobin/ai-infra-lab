...
title: 蛇梯棋
tags: [广度优先搜索, 最短路径, 矩阵]
knowledge_points: [bfs, matrix, shortest-path, 矩阵]
updated: 2026-09-03
source: leetcode
number: 909
difficulty: medium
...
- **标题 / 题号**：蛇梯棋（#909，medium）
- **链接**：https://leetcode.cn/problems/snakes-and-ladders/
- **难度**：中等
- **标签**：广度优先搜索、矩阵、最短路径

**题意**：给定 $n \times n$ 棋盘 `board`，方格按 **Boustrophedon（牛耕式）编号**：从左下角 `board[n-1][0]` 为 1 号，每行交替方向（底行从左到右，上一行从右到左，依此类推），到右上角为 $n^2$ 号。
...
![示例1](https://assets.leetcode.com/uploads/2018/09/23/snakes.png)

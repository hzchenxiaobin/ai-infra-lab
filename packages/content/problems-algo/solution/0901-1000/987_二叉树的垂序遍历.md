...
type: problem
title: 二叉树的垂序遍历
tags: [二叉树, 哈希表, 排序, 树, "深度优先搜索（DFS）"]
knowledge_points: [binary-tree, dfs, hash-table, sorting, tree]
updated: 2026-09-03
source: leetcode
number: 987
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/01/29/vtree1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/01/29/vtree2.jpg)
...
![示例3](https://assets.leetcode.com/uploads/2021/01/29/vtree3.jpg)

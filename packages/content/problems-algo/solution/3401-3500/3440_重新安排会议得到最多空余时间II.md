...
id: "lc:3440"
type: problem
title: "重新安排会议得到最多空余时间 II"
tags: [数组, 枚举, 贪心]
knowledge_points: [array, enumeration, greedy]
updated: 2026-09-03
source: leetcode
number: 3440
difficulty: medium
...
# LeetCode 重新安排会议得到最多空余时间 II 题解

## 1. 题目概述

- **标题 / 题号**：重新安排会议得到最多空余时间 II（#3440，medium）
- **链接**：https://leetcode.cn/problems/reschedule-meetings-for-maximum-free-time-ii/
- **难度**：中等
- **标签**：贪心、数组、枚举

**题意**：给你一个整数 `eventTime` 表示一个活动的总时长，这个活动开始于 $t = 0$，结束于 $t = \text{eventTime}$。
...
![示例1](https://assets.leetcode.com/uploads/2024/12/22/example0_rescheduled.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/12/22/rescheduled_example0.png)
...
![示例3](https://assets.leetcode.com/uploads/2025/01/28/image3.png)

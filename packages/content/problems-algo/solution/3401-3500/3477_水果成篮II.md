...
type: problem
title: "水果成篮 II"
tags: [二分查找, 数组, 有序集合, 模拟, 线段树]
knowledge_points: [array, binary-search, ordered-set, segment-tree, simulation]
updated: 2026-09-03
source: leetcode
number: 3477
difficulty: easy
...
- **标题 / 题号**：水果成篮 II（#3477，easy）
- **链接**：https://leetcode.cn/problems/fruits-into-baskets-ii/
- **难度**：简单
- **标签**：数组、模拟、线段树、二分查找、有序集合

**题意**：给你两个长度为 `n` 的整数数组 `fruits` 和 `baskets`，其中 `fruits[i]` 表示第 `i` 种水果的**数量**，`baskets[j]` 表示第 `j` 个篮子的**容量**。

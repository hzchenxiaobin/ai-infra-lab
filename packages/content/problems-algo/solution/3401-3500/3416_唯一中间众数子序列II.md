...
title: "唯一中间众数子序列 II"
tags: [哈希表, 数学, 数组, 组合数学]
knowledge_points: [array, combinatorics, hash-table, math]
updated: 2026-09-03
source: leetcode
number: 3416
difficulty: hard
...
**题意**：给你一个整数数组 `nums`，请你求出 `nums` 中**大小为 5 的子序列**的数目，使得它是**唯一中间众数序列**。答案对 $10^9 + 7$ 取余后返回。

...
type: problem
title: 寻找环形礼物交换链
tags: [LEAST, ROW_NUMBER, SQL, "WITH RECURSIVE", 函数图找环, 图遍历, 数据库, 窗口函数, "递归 CTE"]
knowledge_points: [database, least, recursive-cte, row-number, sql, window-function, 函数图找环, 图遍历]
updated: 2026-09-03
source: leetcode
number: 3401
difficulty: hard
...
# LeetCode 寻找环形礼物交换链 题解

## 1. 题目概述

- **标题 / 题号**：寻找环形礼物交换链（#3401，hard）

...
id: "lc:3428"
type: problem
title: 最多K个元素的子序列的最值之和
tags: [排序, 数组, 模逆元, 组合数学, 贡献法]
knowledge_points: [array, combinatorics, contribution-technique, mod-inverse, sorting]
updated: 2026-09-03
source: leetcode
number: 3428
difficulty: medium
...
# LeetCode 最多K个元素的子序列的最值之和 题解

## 1. 题目概述

- **标题 / 题号**：最多K个元素的子序列的最值之和（#3428，medium）
- **链接**：https://leetcode.cn/problems/maximum-and-minimum-sums-of-at-most-size-k-subsequences/
- **难度**：中等
- **标签**：数组、排序、组合数学、贡献法、模逆元

**题意**：给你一个整数数组 `nums` 和一个正整数 `k`，返回所有**长度至多为 `k`** 的**子序列**中 **最大值** 与 **最小值** 之和的总和。

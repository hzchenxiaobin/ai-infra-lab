...
title: 一张长椅上的最多学生
tags: [哈希表, 数组]
knowledge_points: [array, hash-table]
updated: 2026-09-03
source: leetcode
number: 3450
difficulty: easy
...
# LeetCode 一张长椅上的最多学生 题解

## 1. 题目概述

- **标题 / 题号**：一张长椅上的最多学生（#3450，easy）
...
**题意**：给定一个包含学生数据的二维数组 `students`，其中 `students[i] = [student_id, bench_id]` 表示学生 `student_id` 正坐在长椅 `bench_id` 上。

...
id: "lc:3461"
type: problem
title: "判断操作后字符串中的数字是否相等 I"
tags: [字符串, 数学, 数论, 模拟, 组合数学]
knowledge_points: [combinatorics, math, number-theory, simulation, string]
updated: 2026-09-03
source: leetcode
number: 3461
difficulty: easy
...
# LeetCode 判断操作后字符串中的数字是否相等 I 题解

## 1. 题目概述

- **标题 / 题号**：判断操作后字符串中的数字是否相等 I（#3461，easy）

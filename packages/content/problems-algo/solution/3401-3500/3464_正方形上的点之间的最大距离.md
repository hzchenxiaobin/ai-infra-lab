...
title: 正方形上的点之间的最大距离
tags: [二分查找, 几何, 排序, 贪心]
knowledge_points: [binary-search, geometry, greedy, sorting]
updated: 2026-09-03
source: leetcode
number: 3464
difficulty: hard
...
# LeetCode 正方形上的点之间的最大距离 题解

## 1. 题目概述

- **标题 / 题号**：正方形上的点之间的最大距离（#3464，hard）
- **链接**：https://leetcode.cn/problems/maximize-the-distance-between-points-on-a-square/
- **难度**：困难
- **标签**：几何、二分查找、贪心、排序

**题意**：给你一个整数 `side`，表示一个正方形的边长，正方形的四个角分别位于笛卡尔平面的 `(0, 0)`、`(0, side)`、`(side, 0)` 和 `(side, side)` 处。
...
![示例1](https://pic.leetcode.cn/1740269079-gtqSpE-4080_example0_revised.png)
...
![示例2](https://pic.leetcode.cn/1740269089-KXdOVN-4080_example1_revised.png)
...
![示例3](https://pic.leetcode.cn/1740269096-PNkeev-4080_example2_revised.png)

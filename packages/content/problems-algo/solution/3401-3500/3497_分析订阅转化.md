...
type: problem
title: 分析订阅转化
tags: [AVG, "CASE WHEN", "GROUP BY", HAVING, ROUND, SQL, 数据库, 条件聚合, "聚合函数忽略 NULL"]
knowledge_points: [avg, case-when, conditional-aggregation, database, group-by, having, round, sql, 聚合函数忽略-null]
updated: 2026-09-03
source: leetcode
number: 3497
difficulty: medium

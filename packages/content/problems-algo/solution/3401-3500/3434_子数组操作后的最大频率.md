...
type: problem
title: 子数组操作后的最大频率
tags: [前缀和, 动态规划, 数组, 枚举, 贪心]
knowledge_points: [array, dynamic-programming, enumeration, greedy, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 3434
difficulty: medium
...
# LeetCode 子数组操作后的最大频率 题解

## 1. 题目概述

- **标题 / 题号**：子数组操作后的最大频率（#3434，medium）
- **链接**：https://leetcode.cn/problems/maximum-frequency-after-subarray-operation/
- **难度**：中等
- **标签**：贪心、数组、枚举、动态规划、前缀和

**题意**：给你一个长度为 $n$ 的数组 `nums` 和一个整数 $k$。你可以对 `nums` 执行以下操作**一次**：

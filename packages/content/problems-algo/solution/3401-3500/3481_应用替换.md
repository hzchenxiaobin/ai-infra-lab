...
type: problem
title: 应用替换
tags: [哈希表, 图, 字符串, 广度优先搜索, 拓扑排序, 数组, 深度优先搜索, 记忆化]
knowledge_points: [array, bfs, dfs, graph, hash-table, memoization, string, topological-sort]
updated: 2026-09-03
source: leetcode
number: 3481
difficulty: medium

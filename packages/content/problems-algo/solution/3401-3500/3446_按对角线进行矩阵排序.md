...
title: 按对角线进行矩阵排序
tags: [排序, 数组, 矩阵]
knowledge_points: [array, matrix, sorting, 矩阵]
updated: 2026-09-03
source: leetcode
number: 3446
difficulty: medium
...
# LeetCode 按对角线进行矩阵排序 题解

## 1. 题目概述

- **标题 / 题号**：按对角线进行矩阵排序（#3446，medium）
- **链接**：https://leetcode.cn/problems/sort-matrix-by-diagonals/
- **难度**：中等
- **标签**：数组、矩阵、排序

**题意**：给你一个大小为 `n x n` 的整数方阵 `grid`。返回一个经过如下调整的矩阵：
...
![示例1](https://assets.leetcode.com/uploads/2024/12/29/4052example1drawio.png)
...
![示例2](https://assets.leetcode.com/uploads/2024/12/29/4052example2adrawio.png)

...
type: problem
title: 查找进步的学生
tags: [FIRST_VALUE, "GROUP BY", "PARTITION BY", SQL, "pandas groupby", 数据库, 窗口函数, 自连接]
knowledge_points: [database, first-value, group-by, pandas-groupby, partition-by, self-join, sql, window-function]
updated: 2026-09-03
source: leetcode
number: 3421
difficulty: medium

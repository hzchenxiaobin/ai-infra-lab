...
type: problem
title: 岛屿数量
tags: [BFS, DFS, 图, 并查集, 连通分量]
knowledge_points: [bfs, connected-components, dfs, graph, union-find]
updated: 2026-09-03
source: leetcode
number: 200
difficulty: medium
...
judge: none
related_learn: ["learn:w06d05", "learn:w07d04", "learn:w07d07"]
---
...
- **标题 / 题号**：岛屿数量（#200，medium）
- **链接**：https://leetcode.cn/problems/number-of-islands/
- **难度**：中等
- **标签**：图、DFS、BFS、连通分量、并查集

**题意**：给你一个由 `'1'`（陆地）和 `'0'`（水）组成的二维网格 `grid`，请你计算网格中**岛屿的数量**。
...
> 💡 与 [Day5 Mini Engine v1](../../../learn/daily/week6/day5/README.md) 的请求分组同构——v1 每轮把多个请求组成一个 batch 一起 forward，类似把相邻的 `'1'` 归为同一岛屿（连通分量）。DFS 标记连通块 = Scheduler 把同轮可调度的请求归入同一 batch。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 130 | [被围绕的区域](https://leetcode.cn/problems/surrounded-regions/) | DFS/BFS 标记 |
| 695 | [岛屿的最大面积](https://leetcode.cn/problems/max-area-of-island/) | DFS 求面积 |
| 200 | [岛屿数量](https://leetcode.cn/problems/number-of-islands/)（题解） | DFS/BFS 计数 |

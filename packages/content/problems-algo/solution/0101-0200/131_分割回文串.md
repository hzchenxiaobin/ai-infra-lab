...
title: 分割回文串
tags: [动态规划, 回溯, 字符串]
knowledge_points: [backtracking, dynamic-programming, string]
updated: 2026-09-03
source: leetcode
number: 131
difficulty: medium
...
judge: none
related_learn: ["lc:topic:backtracking", "lc:topic:interval-dp", "learn:w07d06", "learn:w07d07"]
---
...
- **标题 / 题号**：分割回文串（#131，medium）
- **链接**：https://leetcode.cn/problems/palindrome-partitioning/
- **难度**：中等
- **标签**：字符串、回溯、动态规划

**题意**：给定一个字符串 `s`，请你将 `s` 分割成若干子串，使**每个子串都是回文串**。返回 `s` 所有可能的分割方案。
...
![分割回文串回溯流程](../images/palindrome_partition_flow.svg)
...
| 139 | [单词拆分](https://leetcode.cn/problems/word-break/)（[题解](139_单词拆分.md)） | 判定能否拆分（DP 求可行性） |
| 78 | [子集](https://leetcode.cn/problems/subsets/)（[题解](../0001-0100/78_子集.md)） | 回溯模板的另一典型应用 |

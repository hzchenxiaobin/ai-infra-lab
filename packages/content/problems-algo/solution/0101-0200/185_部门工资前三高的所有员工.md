...
type: problem
title: 部门工资前三高的所有员工
tags: [DENSE_RANK, "PARTITION BY", SQL, "分组 Top-K", 相关子查询, 窗口函数]
knowledge_points: [correlated-subquery, dense-rank, group-topk, partition-by, sql, window-function, 分组-top-k]
updated: 2026-09-03
source: leetcode
number: 185
difficulty: hard

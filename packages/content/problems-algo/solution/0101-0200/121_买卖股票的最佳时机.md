...
title: 买卖股票的最佳时机
tags: [一次遍历, 动态规划, 数组]
knowledge_points: [array, dynamic-programming, one-pass, 一次遍历]
updated: 2026-09-03
source: leetcode
number: 121
difficulty: easy
...
judge: none
related_learn: ["lc:topic:greedy", "learn:w05d02", "learn:w05d07", "learn:w06d06"]
---

# LeetCode 买卖股票的最佳时机 题解

## 1. 题目概述

- **标题 / 题号**：买卖股票的最佳时机（#121，easy）
- **链接**：https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/
- **难度**：简单
- **标签**：数组、动态规划、一次遍历

**题意**：给定一个数组 `prices`，它的第 `i` 个元素 `prices[i]` 表示一支股票第 `i` 天的价格。你只能选择**某一天买入**并在**未来某一天卖出**。计算你能获取的**最大利润**（卖出价 - 买入价）。如果不能获利（价格一直跌），返回 `0`。
...
> 💡 与 [Day6 Benchmark](../../../learn/daily/week6/day6/README.md) 扫描并发数找饱和点同构——benchmark 扫 concurrency=1,2,4,...,64 找"throughput 增长率开始下降"的拐点，正如股票在价格序列中找"最低买入+最高卖出"的最大差值。两者都是一次遍历维护极值。
...
| 123 | [买卖股票的最佳时机 III](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iii/)（[题解](123_买卖股票的最佳时机III.md)） | 最多两次 |
| 188 | [买卖股票的最佳时机 IV](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iv/) | 最多 K 次 |

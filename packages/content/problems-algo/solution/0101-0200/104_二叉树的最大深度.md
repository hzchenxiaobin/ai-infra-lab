...
type: problem
title: 二叉树的最大深度
tags: [二叉树, 广度优先搜索, 树, 深度优先搜索]
knowledge_points: [bfs, binary-tree, dfs, tree]
updated: 2026-09-03
source: leetcode
number: 104
difficulty: easy
...
judge: none
related_learn: ["learn:w06d02", "learn:w06d07"]
---

# LeetCode 二叉树的最大深度 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的最大深度（#104，easy）
- **链接**：https://leetcode.cn/problems/maximum-depth-of-binary-tree/
- **难度**：简单
- **标签**：树、二叉树、深度优先搜索、广度优先搜索

**题意**：给定一棵二叉树的根节点 `root`，返回它的**最大深度**。二叉树的**最大深度**是指从根节点到**最远叶子节点**的最长路径上的节点数。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 111 | [二叉树的最小深度](https://leetcode.cn/problems/minimum-depth-of-binary-tree/)（[题解](111_二叉树的最小深度.md)） | 求最近叶子，BFS 更优 |
| 110 | [平衡二叉树](https://leetcode.cn/problems/balanced-binary-tree/)（[题解](110_平衡二叉树.md)） | 复用求深度，判断左右差 ≤ 1 |
| 559 | [N 叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-n-ary-tree/)（[题解](../0501-0600/559_N叉树的最大深度.md)） | 多叉树版，遍历所有孩子 |
| 199 | [二叉树的右视图](https://leetcode.cn/problems/binary-tree-right-side-view/)（[题解](199_二叉树的右视图.md)） | 层序思想的应用 |

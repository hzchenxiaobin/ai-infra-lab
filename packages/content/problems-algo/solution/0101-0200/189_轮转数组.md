...
title: 轮转数组
tags: [双指针, 数学, 数组]
knowledge_points: [array, math, two-pointers]
updated: 2026-09-03
source: leetcode
number: 189
difficulty: medium
...
judge: none
related_learn: ["learn:w01d05", "learn:w01d07"]
---
...
- **标题 / 题号**：轮转数组（#189，medium）
- **链接**：https://leetcode.cn/problems/rotate-array/
- **难度**：中等
- **标签**：数组、数学、双指针

**题意**：给定一个整数数组 `nums`，将数组中的元素向**右**轮转 `k` 个位置，其中 `k` 是非负数。要求**原地**修改数组。

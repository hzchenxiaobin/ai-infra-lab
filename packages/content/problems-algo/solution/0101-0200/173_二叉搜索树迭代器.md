...
type: problem
title: 二叉搜索树迭代器
tags: [BST, 中序遍历, 栈, 树, 设计]
knowledge_points: [bst, design, inorder-traversal, stack, tree]
updated: 2026-09-03
source: leetcode
number: 173
difficulty: medium
...
# LeetCode 二叉搜索树迭代器 题解

## 1. 题目概述

- **标题 / 题号**：二叉搜索树迭代器（#173，medium）
- **链接**：https://leetcode.cn/problems/binary-search-tree-iterator/
- **难度**：中等
- **标签**：树、BST、栈、设计、中序遍历

**题意**：实现一个**二叉搜索树（BST）迭代器**类 `BSTIterator`，按**升序**逐个访问 BST 中的节点。要求：

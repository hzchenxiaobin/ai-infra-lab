...
title: 将有序数组转换为二叉搜索树
tags: [BST, 分治, 树]
knowledge_points: [bst, divide-and-conquer, tree]
updated: 2026-09-03
source: leetcode
number: 108
difficulty: easy
...
# LeetCode 将有序数组转换为二叉搜索树 题解

## 1. 题目概述

- **标题 / 题号**：将有序数组转换为二叉搜索树（#108，easy）
- **链接**：https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/
- **难度**：简单
- **标签**：树、BST、分治

**题意**：给你一个**升序排列**的整数数组 `nums`，请将其转换为一棵**高度平衡**的二叉搜索树（BST）。高度平衡是指每个节点的左右两个子树的高度差不超过 1。
...
![示例2](https://assets.leetcode.com/uploads/2021/02/18/btree2.jpg)
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 109 | [有序链表转换二叉搜索树](https://leetcode.cn/problems/convert-sorted-list-to-binary-search-tree/)（[题解](./109_有序链表转换二叉搜索树.md)） | 把数组换成链表，最优为中序模拟 O(n)/O(log n) |
| 105 | [从前序与中序遍历序列构造二叉树](https://leetcode.cn/problems/construct-binary-tree-from-preorder-and-inorder-traversal/)（[题解](105_从前序与中序遍历序列构造二叉树.md)） | 分治构造树的思想相通 |
| 1382 | [将二叉搜索树变平衡](https://leetcode.cn/problems/balance-a-binary-search-tree/) | 先中序展开为有序数组，再用本题方法重建 |
| 94 | [二叉树的中序遍历](https://leetcode.cn/problems/binary-tree-inorder-traversal/)（[题解](../0001-0100/94_二叉树的中序遍历.md)） | BST 中序升序的理论基础 |

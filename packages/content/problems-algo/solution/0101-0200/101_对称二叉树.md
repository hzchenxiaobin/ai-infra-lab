...
- **标题 / 题号**：对称二叉树（#101，easy）
- **链接**：https://leetcode.cn/problems/symmetric-tree/
- **难度**：简单
- **标签**：树、二叉树、深度优先搜索、广度优先搜索

**题意**：给定一棵二叉树的根节点 `root`，检查它是否**轴对称**（关于过根的竖直轴左右镜像）。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 100 | [相同的树](https://leetcode.cn/problems/same-tree/)（[题解](../0001-0100/100_相同的树.md)） | 同侧配对，结构相同 |
| 226 | [翻转二叉树](https://leetcode.cn/problems/invert-binary-tree/)（[题解](../0201-0300/226_翻转二叉树.md)） | 翻转后与原树相等即对称 |

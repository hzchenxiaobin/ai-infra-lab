...
type: problem
title: 二叉树的层序遍历
tags: [二叉树, "广度优先搜索（BFS）", 树]
knowledge_points: [bfs, binary-tree, tree]
updated: 2026-09-03
source: leetcode
number: 102
difficulty: medium
...
# LeetCode 二叉树的层序遍历 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的层序遍历（#102，medium）
- **链接**：https://leetcode.cn/problems/binary-tree-level-order-traversal/
- **难度**：中等
- **标签**：树、二叉树、广度优先搜索（BFS）

**题意**：给定二叉树的根节点 `root`，返回其节点值的**层序遍历**结果。即逐层地，从左到右访问所有节点，将同一层的节点值组成一个子列表。
...
> 💡 这是 **BFS（广度优先搜索）** 的招牌题。与 [Day 4 合并链表](../0001-0100/21_合并两个有序链表.md) 的"逐个处理"不同，BFS 用**队列**逐层推进——先访问离根最近的节点，再访问下一层。层序遍历是所有"按层/按距离"问题的模板：岛屿数量、腐烂橘子、最短路径都复用这套 BFS 队列骨架。掌握它，你就拿到了图论 BFS 的入场券。
...
| 199 | [二叉树的右视图](https://leetcode.cn/problems/binary-tree-right-side-view/)（[题解](199_二叉树的右视图.md)） | BFS 取每层最右 |

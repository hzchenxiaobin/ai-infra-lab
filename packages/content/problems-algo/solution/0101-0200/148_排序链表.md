...
title: 排序链表
tags: [分治, 双指针, 归并排序, 链表]
knowledge_points: [divide-and-conquer, linked-list, merge-sort, two-pointers]
updated: 2026-09-03
source: leetcode
number: 148
difficulty: medium
...
judge: none
related_learn: ["learn:w03d05", "learn:w03d07"]
---
...
- **标题 / 题号**：排序链表（#148，medium）
- **链接**：https://leetcode.cn/problems/sort-list/
- **难度**：中等
- **标签**：链表、归并排序、分治、双指针

**题意**：给定链表的头节点 `head`，将其按**升序**排列并返回。要求时间 `O(n log n)`、空间 `O(1)`（递归栈空间不计入 / 或要求迭代）。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 148 | [排序链表](https://leetcode.cn/problems/sort-list/)（题解） | 归并排序链表 |
| 21 | [合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（[题解](../0001-0100/21_合并两个有序链表.md)） | 归并合并 |
| 23 | [合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（[题解](../0001-0100/23_合并K个升序链表.md)） | 堆/分治合并 |

...
- **标题 / 题号**：乘积最大子数组（#152，medium）
- **链接**：https://leetcode.cn/problems/maximum-product-subarray/
- **难度**：中等
- **标签**：数组、动态规划

**题意**：给定一个整数数组 `nums`，请你找出**连续子数组**（包含至少一个元素）中乘积最大的那个，返回其乘积。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 53 | [最大子数组和](https://leetcode.cn/problems/maximum-subarray/)（[题解](../0001-0100/53_最大子数组和.md)） | 加法版，只维护一个最大值 |

...
judge: none
related_learn: ["learn:w06d03", "learn:w06d07"]
---

# LeetCode 二叉树的最小深度 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的最小深度（#111，easy）
- **链接**：https://leetcode.cn/problems/minimum-depth-of-binary-tree/
- **难度**：简单
- **标签**：树、DFS、BFS

**题意**：给定一棵二叉树的根节点 `root`，返回其**最小深度**。最小深度是指从根节点到**最近叶子节点**的最短路径上的节点数量。
...
> 💡 这是 [104. 二叉树的最大深度](104_二叉树的最大深度.md) 的「镜像版」——把 `max` 换成 `min`。但有个**关键陷阱**：单侧为空时不能简单取 `min(0, 另一侧)`，因为空的一侧没有叶子。这道题同时考察 DFS 的边界处理和 BFS 的「首达即最短」特性，是树遍历的经典进阶题。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 104 | [二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/) | 镜像题，max 换 min，无单侧陷阱（[题解](104_二叉树的最大深度.md)） |
| 102 | [二叉树的层序遍历](https://leetcode.cn/problems/binary-tree-level-order-traversal/) | BFS 骨架，本题复用（[题解](102_二叉树的层序遍历.md)） |
| 110 | [平衡二叉树](https://leetcode.cn/problems/balanced-binary-tree/) | 后序 DFS 算高度，同套递归（[题解](110_平衡二叉树.md)） |
| 199 | [二叉树的右视图](https://leetcode.cn/problems/binary-tree-right-side-view/) | BFS 取每层最右（[题解](199_二叉树的右视图.md)） |

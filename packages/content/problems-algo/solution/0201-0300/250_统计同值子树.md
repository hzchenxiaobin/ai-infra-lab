...
- **标题 / 题号**：统计同值子树（#250，medium）
- **链接**：https://leetcode.cn/problems/count-univalue-subtrees/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索、后序遍历

**题意**：给定一棵二叉树的根节点 `root`，统计这棵树中**同值子树**（uni-value subtree）的数量。
...
| 236 | [二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)（[题解](./236_二叉树的最近公共祖先.md)） | 后序传递「子树是否含 p/q」，在节点处聚合判定 LCA，同套后序布尔传递骨架 |

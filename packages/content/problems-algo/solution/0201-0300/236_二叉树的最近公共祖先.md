...
# LeetCode 二叉树的最近公共祖先 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的最近公共祖先（#236，medium）
- **链接**：https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索

**题意**：给定一个二叉树，找到该树中两个指定节点的**最近公共祖先**（Lowest Common Ancestor, LCA）。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 235 | [二叉搜索树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-search-tree/)（[题解](235_二叉搜索树的最近公共祖先.md)） | BST 版 O(h) |
| 1644 | [二叉树的最近公共祖先 II](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree-ii/) | 节点可能不存在 |
| 1650 | [二叉树的最近公共祖先 III](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree-iii/) | 带父指针 |

...
title: 最接近的二叉搜索树值
tags: [BST, 二分查找, 树]
knowledge_points: [binary-search, bst, tree]
updated: 2026-09-03
source: leetcode
number: 270
difficulty: easy
...
# LeetCode 最接近的二叉搜索树值 题解

## 1. 题目概述

- **标题 / 题号**：最接近的二叉搜索树值（#270，easy）
- **链接**：https://leetcode.cn/problems/closest-binary-search-tree-value/
- **难度**：简单
- **标签**：树、BST、二分查找

**题意**：给定一棵**二叉搜索树（BST）**的根节点 `root` 和一个目标值 `target`，请返回树中**最接近 `target`** 的节点值。若有多个节点与 `target` 距离相同，返回**较小的那个值**。

...
judge: none
related_learn: ["learn:w05d01", "learn:w05d07", "learn:w07d06"]
---
...
> 💡 与 [Week7 Day6 全链路 Profiling](../../../learn/daily/week7/day6/README.md) 中的 **P50 延迟统计**同构——P50 就是中位数，用堆维护可以 O(log N) 插入 + O(1) 查中位数。Profiling 脚本中 `statistics.median()` 对应 `findMedian()`，`PhaseTimer` 的 `times` 列表对应数据流。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 295 | [数据流的中位数](https://leetcode.cn/problems/find-median-from-data-stream/)（题解） | 双堆 |

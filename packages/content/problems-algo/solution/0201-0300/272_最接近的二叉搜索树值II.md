...
title: "最接近的二叉搜索树值 II"
tags: [BST, 中序遍历, 栈, 树]
knowledge_points: [bst, inorder-traversal, stack, tree]
updated: 2026-09-03
source: leetcode
number: 272
difficulty: hard
...
# LeetCode 最接近的二叉搜索树值II 题解

## 1. 题目概述

- **标题 / 题号**：最接近的二叉搜索树值 II（#272，hard）
- **链接**：https://leetcode.cn/problems/closest-binary-search-tree-value-ii/
- **难度**：困难
- **标签**：树、BST、栈、中序遍历

**题意**：给定一棵**二叉搜索树（BST）**的根节点 `root`、一个目标值 `target` 和一个整数 `k`，请返回树中**最接近 `target`** 的 `k` 个节点值。可以按任意顺序返回。答案保证唯一。

...
title: 数组中的第K个最大元素
tags: [分治, 堆, 快速选择, 数组]
knowledge_points: [array, divide-and-conquer, heap, quickselect]
updated: 2026-09-03
source: leetcode
number: 215
difficulty: medium
...
judge: none
related_learn: ["learn:w05d01", "learn:w05d07"]
---

# LeetCode 数组中的第K个最大元素 题解

## 1. 题目概述

- **标题 / 题号**：数组中的第K个最大元素（#215，medium）
- **链接**：https://leetcode.cn/problems/kth-largest-element-in-an-array/
- **难度**：中等
- **标签**：数组、分治、快速选择、堆

**题意**：给定整数数组 `nums` 和整数 `k`，请返回数组中第 **k** 个最大的元素（按**排序后**的顺序，1-indexed，**而非**第 k 个不同的元素）。

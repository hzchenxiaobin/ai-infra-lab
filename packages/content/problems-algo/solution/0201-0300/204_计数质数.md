...
title: 计数质数
tags: [埃氏筛, 数学, 数论]
knowledge_points: [math, number-theory, sieve]
updated: 2026-09-03
source: leetcode
number: 204
difficulty: medium
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 912 | [排序数组](https://leetcode.cn/problems/sort-an-array/)（[站内题解](../0901-1000/912_排序数组.md)） | 同为"基础算法模板必背"题，筛法与快排/归并一样是手撕基本功 |

...
title: 翻转二叉树
tags: [二叉树, 树, 递归]
knowledge_points: [binary-tree, recursion, tree]
updated: 2026-09-03
source: leetcode
number: 226
difficulty: easy
...
- **标题 / 题号**：翻转二叉树（#226，easy）
- **链接**：https://leetcode.cn/problems/invert-binary-tree/
- **难度**：简单
- **标签**：树、二叉树、递归

**题意**：给定一棵二叉树的根节点 `root`，翻转这棵树，使**每个节点的左右子树互换**，返回翻转后的根节点。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 101 | [对称二叉树](https://leetcode.cn/problems/symmetric-tree/)（[题解](../0101-0200/101_对称二叉树.md)） | 判定是否镜像对称 |
| 104 | [二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/)（[题解](../0101-0200/104_二叉树的最大深度.md)） | 同样后序递归骨架 |
| 114 | [二叉树展开为链表](https://leetcode.cn/problems/flatten-binary-tree-to-linked-list/)（[题解](../0101-0200/114_二叉树展开为链表.md)） | 另一种原地修改树结构 |

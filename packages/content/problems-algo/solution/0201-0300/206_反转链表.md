...
title: 反转链表
tags: [指针操作, 递归, 链表]
knowledge_points: [linked-list, pointer-manipulation, recursion, 指针操作]
updated: 2026-09-03
source: leetcode
number: 206
difficulty: easy
...
**题意**：给你单链表的头节点 `head`，请你反转链表，并返回反转后的链表的头节点。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 92 | [反转链表 II](https://leetcode.cn/problems/reverse-linked-list-ii/)（[题解](../0001-0100/92_反转链表 II.md)） | 反转指定区间 |
| 25 | [K 个一组翻转链表](https://leetcode.cn/problems/reverse-nodes-in-k-group/)（[题解](../0001-0100/25_K个一组翻转链表.md)） | 分段翻转 |
| 24 | [两两交换链表中的节点](https://leetcode.cn/problems/swap-nodes-in-pairs/)（[题解](../0001-0100/24_两两交换链表中的节点.md)） | 成对翻转 |

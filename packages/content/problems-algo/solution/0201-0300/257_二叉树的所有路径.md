...
type: problem
title: 二叉树的所有路径
tags: [二叉树, 回溯, 树, 深度优先搜索]
knowledge_points: [backtracking, binary-tree, dfs, tree]
updated: 2026-09-03
source: leetcode
number: 257
difficulty: easy
...
# LeetCode 二叉树的所有路径 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的所有路径（#257，easy）
- **链接**：https://leetcode.cn/problems/binary-tree-paths/
- **难度**：简单
- **标签**：树、深度优先搜索、回溯、二叉树

**题意**：给定一棵二叉树的根节点 `root`，按**任意顺序**返回所有「从根节点到叶子节点」的路径。

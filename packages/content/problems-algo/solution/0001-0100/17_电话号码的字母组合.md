...
# LeetCode 电话号码的字母组合 题解

## 1. 题目概述

- **标题 / 题号**：电话号码的字母组合（#17，medium）
- **链接**：https://leetcode.cn/problems/letter-combinations-of-a-phone-number/
- **难度**：中等
- **标签**：回溯、递归、字符串

**题意**：给定一个仅包含数字 `2`–`9` 的字符串 `digits`，返回它能表示的所有字母组合。电话按键到字母的映射如下（与老式手机九宫格键盘一致）：
...
![示例1](https://pic.leetcode.cn/1752723054-mfIHZs-image.png)

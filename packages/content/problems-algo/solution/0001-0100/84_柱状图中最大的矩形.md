...
title: 柱状图中最大的矩形
tags: [单调栈, 数组, 栈]
knowledge_points: [array, monotonic-stack, stack]
updated: 2026-09-03
source: leetcode
number: 84
difficulty: hard
...
judge: none
related_learn: ["lc:topic:monotonic-stack", "learn:w04d03", "learn:w04d07"]
---

# LeetCode 柱状图中最大的矩形 题解

## 1. 题目概述

- **标题 / 题号**：柱状图中最大的矩形（#84，hard）
- **链接**：https://leetcode.cn/problems/largest-rectangle-in-histogram/
- **难度**：困难
- **标签**：栈、数组、单调栈

**题意**：给定 `n` 个非负整数，用来表示柱状图中各个柱子的高度。每个柱子彼此相邻，且宽度为 `1`。求在该柱状图中，能够勾勒出来的**矩形的最大面积**。
...
| 42 | [接雨水](https://leetcode.cn/problems/trapping-rain-water/)（[题解](42_接雨水.md)） | 单调栈求水位 |
| 496 | [下一个更大元素](https://leetcode.cn/problems/next-greater-element-i/)（[题解](../0401-0500/496_下一个更大元素 I.md)） | 单调栈模板 |

...
judge: none
related_learn: ["learn:w03d03", "learn:w03d07"]
---
...
- **标题 / 题号**：反转链表 II（#92，medium）
- **链接**：https://leetcode.cn/problems/reverse-linked-list-ii/
- **难度**：中等
- **标签**：链表

**题意**：给定单链表的头节点 `head` 和两个整数 `left` 和 `right`（`left <= right`），其中 `left` 和 `right` 是**从 1 开始**编号的位置。请**反转从位置 `left` 到位置 `right` 的节点**，并返回反转后的链表头节点。

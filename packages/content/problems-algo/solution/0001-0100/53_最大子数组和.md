...
title: 最大子数组和
tags: [分治, 动态规划, 数组, 贪心]
knowledge_points: [array, divide-and-conquer, dynamic-programming, greedy]
updated: 2026-09-03
source: leetcode
number: 53
difficulty: medium
...
judge: none
related_learn: ["lc:topic:greedy", "learn:w01d03", "learn:w01d07"]
---
...
- **标题 / 题号**：最大子数组和（#53，medium）
- **链接**：https://leetcode.cn/problems/maximum-subarray/
- **难度**：中等
- **标签**：数组、分治、动态规划、贪心

**题意**：给你一个整数数组 `nums`，找到一个具有最大和的连续子数组（子数组最少包含一个元素），返回其最大和。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 918 | [环形子数组的最大和](https://leetcode.cn/problems/maximum-sum-circular-subarray/) | 环形数组的 Kadane 变体 |
| 152 | [乘积最大子数组](https://leetcode.cn/problems/maximum-product-subarray/)（[题解](../0101-0200/152_乘积最大子数组.md)） | 维护 max/min 两状态的 Kadane |
| 53 | [最大子数组和](https://leetcode.cn/problems/maximum-subarray/)（题解） | Kadane 基础模板 |

...
title: 无重复字符的最长子串
tags: [哈希表, 字符串, 滑动窗口]
knowledge_points: [hash-table, sliding-window, string]
updated: 2026-09-03
source: leetcode
number: 3
difficulty: medium
...
judge: none
related_learn: ["learn:w02d01", "learn:w02d07"]
---

# LeetCode 无重复字符的最长子串 题解

## 1. 题目概述

- **标题 / 题号**：无重复字符的最长子串（#3，medium）
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 3 | [无重复字符的最长子串](https://leetcode.cn/problems/longest-substring-without-repeating-characters/)（题解） | 滑窗 + 哈希 |
| 438 | [找到字符串中所有字母异位词](https://leetcode.cn/problems/find-all-anagrams-in-a-string/) | 定长滑窗 + 字符计数 |
| 159 | [至多包含两个不同字符的最长子串](https://leetcode.cn/problems/longest-substring-with-at-most-two-distinct-characters/) | 变体滑窗 |

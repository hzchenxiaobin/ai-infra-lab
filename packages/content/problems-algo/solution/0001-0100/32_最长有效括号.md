...
title: 最长有效括号
tags: [动态规划, 字符串, 栈]
knowledge_points: [dynamic-programming, stack, string]
updated: 2026-09-03
source: leetcode
number: 32
difficulty: hard
...
judge: none
related_learn: ["learn:w09d02", "learn:w09d07"]
---
...
- **标题 / 题号**：最长有效括号（#32，hard）
- **链接**：https://leetcode.cn/problems/longest-valid-parentheses/
- **难度**：困难
- **标签**：栈、动态规划、字符串

**题意**：给定一个只包含 `(` 和 `)` 的字符串 `s`，找出**最长的有效（正确闭合）括号子串的长度**。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 20 | [有效括号](https://leetcode.cn/problems/valid-parentheses/)（[题解](20_有效括号.md)） | 栈基础 |
| 22 | [括号生成](https://leetcode.cn/problems/generate-parentheses/)（[题解](22_括号生成.md)） | 回溯 |

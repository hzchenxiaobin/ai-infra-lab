...
- **标题 / 题号**：组合总和（#39，medium）
- **链接**：https://leetcode.cn/problems/combination-sum/
- **难度**：中等
- **标签**：数组、回溯、剪枝

**题意**：给定一个**无重复元素**的正整数数组 `candidates` 和一个目标数 `target`，找出 `candidates` 中所有使数字之和为 `target` 的组合。`candidates` 中的数字可以**无限制重复选取**。结果不能包含重复组合。
...
| 322 | [零钱兑换](https://leetcode.cn/problems/coin-change/)（[题解](../0301-0400/322_零钱兑换.md)） | DP 版求最少硬币数 |

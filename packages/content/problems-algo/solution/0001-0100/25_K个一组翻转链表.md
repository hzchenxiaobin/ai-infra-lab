...
title: "K 个一组翻转链表"
tags: [分段处理, 翻转, 链表]
knowledge_points: [linked-list, reversal, segmented-processing, 分段处理, 翻转]
updated: 2026-09-03
source: leetcode
number: 25
difficulty: hard
...
judge: none
related_learn: ["learn:w03d03", "learn:w03d07", "learn:w05d07"]
---
...
- **标题 / 题号**：K 个一组翻转链表（#25，hard）
- **链接**：https://leetcode.cn/problems/reverse-nodes-in-k-group/
- **难度**：困难
- **标签**：链表、分段处理、翻转

**题意**：给定链表的头节点 `head`，每 **k 个节点一组**进行翻转，返回修改后的链表。**不足 k 个的组保持原有顺序**。不能改节点内部的值，只能改指针。
...
> 💡 与 [Day7 推理系统 Chunked Prefill](../../../learn/daily/week5/day7/README.md) 的模式同构：都是"把大块连续处理拆成固定大小分段处理，尾段特殊处理"。翻转链表的"不足 k 保持原序" = Chunked Prefill 的"最后一块可能不满"。
...
- [206 反转链表](../0201-0300/206_反转链表.md)：整个链表翻转，简单
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 92 | [反转链表 II](https://leetcode.cn/problems/reverse-linked-list-ii/)（[题解](92_反转链表 II.md)） | 区间翻转 |
| 206 | [反转链表](https://leetcode.cn/problems/reverse-linked-list/)（[题解](../0201-0300/206_反转链表.md)） | 基础翻转 |
| 25 | [K 个一组翻转链表](https://leetcode.cn/problems/reverse-nodes-in-k-group/)（题解） | 分段翻转 |

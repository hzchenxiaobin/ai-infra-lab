...
# LeetCode 删除排序链表中的重复元素 II 题解

## 1. 题目概述

- **标题 / 题号**：删除排序链表中的重复元素 II（#82，medium）
- **链接**：https://leetcode.cn/problems/remove-duplicates-from-sorted-list-ii/
- **难度**：中等
- **标签**：链表、双指针

**题意**：给定一个**已排序**的单链表的头节点 `head`，删除所有含有**重复数字**的节点，只保留原始链表中**没有重复出现**的数字。返回结果链表的头节点。

**与 [83 题](../0001-0100/83_删除排序链表中的重复元素.md) 的关键区别**：83 题重复的**留一个**，本题重复的**全删**。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2021/01/04/linkedlist1.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/01/04/linkedlist2.jpg)

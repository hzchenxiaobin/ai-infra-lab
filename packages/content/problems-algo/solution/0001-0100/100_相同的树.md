...
**题意**：给定两棵二叉树的根节点 `p` 和 `q`，判断它们是否**相同**。两棵树相同的定义：**结构相同**，且**对应节点的值相同**。
...
![示例2](https://assets.leetcode.com/uploads/2020/12/20/ex2.jpg)
...
![示例3](https://assets.leetcode.com/uploads/2020/12/20/ex3.jpg)
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 101 | [对称二叉树](https://leetcode.cn/problems/symmetric-tree/) | 把「左左、右右」改成「左右、右左」（[题解](../0101-0200/101_对称二叉树.md)） |
| 572 | [另一棵树的子树](https://leetcode.cn/problems/subtree-of-another-tree/) | 遍历主树每个节点，调用 isSame 判断是否匹配 |
| 226 | [翻转二叉树](https://leetcode.cn/problems/invert-binary-tree/) | 同套递归骨架，操作而非比较（[题解](../0201-0300/226_翻转二叉树.md)） |
| 104 | [二叉树的最大深度](https://leetcode.cn/problems/maximum-depth-of-binary-tree/) | 单树后序汇总（[题解](../0101-0200/104_二叉树的最大深度.md)） |
| 100 | [相同的树](https://leetcode.cn/problems/same-tree/)（题解） | 本题，双树配对递归模板 |

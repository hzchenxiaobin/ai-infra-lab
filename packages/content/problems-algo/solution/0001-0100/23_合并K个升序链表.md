...
title: "合并 K 个升序链表"
tags: [分治, "堆（优先队列）", 链表]
knowledge_points: [divide-and-conquer, heap, linked-list]
updated: 2026-09-03
source: leetcode
number: 23
difficulty: hard
...
judge: none
related_learn: ["learn:w03d05", "learn:w03d07", "learn:w07d05"]
---

# LeetCode 合并 K 个升序链表 题解

## 1. 题目概述

- **标题 / 题号**：合并 K 个升序链表（#23，hard）
- **链接**：https://leetcode.cn/problems/merge-k-sorted-lists/
- **难度**：困难
- **标签**：链表、堆（优先队列）、分治

**题意**：给定 `k` 个升序排列的链表，将它们合并为一个升序链表。
...
> 💡 与 [Week7 Day5 系统联调](../../../learn/daily/week7/day5/README.md) 中的 **Scheduler 优先级调度**同构——Scheduler 用 `heapq` 从 waiting 队列按优先级弹出请求，合并链表用最小堆从 K 个链表弹最小节点。两者都是"多路归并用堆维护全局最优"的核心模式。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 23 | [合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（题解） | 堆/分治合并 |
| 21 | [合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（[题解](21_合并两个有序链表.md)） | 双指针合并 |
| 148 | [排序链表](https://leetcode.cn/problems/sort-list/)（[题解](../0101-0200/148_排序链表.md)） | 归并排序 |

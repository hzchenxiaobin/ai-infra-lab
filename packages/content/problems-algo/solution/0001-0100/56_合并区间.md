...
title: 合并区间
tags: [排序, 数组, 贪心]
knowledge_points: [array, greedy, sorting]
updated: 2026-09-03
source: leetcode
number: 56
difficulty: medium
...
judge: none
related_learn: ["lc:topic:greedy", "learn:w01d03", "learn:w01d07", "learn:w08d01"]
---
...
- **标题 / 题号**：合并区间（#56，medium）
- **链接**：https://leetcode.cn/problems/merge-intervals/
- **难度**：中等
- **标签**：数组、排序、贪心

**题意**：给定若干区间的集合 `intervals`，合并所有重叠的区间，返回一个不重叠的区间数组。
...
> 💡 与 [Week8 Day1 项目文档完善](../../../learn/daily/week8/day1/README.md) 同构——前 7 周的代码散落在各 `weekN/dayM/` 目录，像一堆"区间"（每段代码有起止边界）。写 README 时要把它们"合并"成连贯叙述：相邻/重叠的内容合并成一段（如多周的 GEMM 优化合成一个章节），不重叠的各自独立。排序对应"按主题归类代码"，扫描合并对应"把重复概念归并、把缺口补上"。两者都是**先排序再线性归并**的核心模式。

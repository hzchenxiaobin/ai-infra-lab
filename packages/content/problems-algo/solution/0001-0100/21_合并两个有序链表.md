...
title: 合并两个有序链表
tags: [递归, 链表]
knowledge_points: [linked-list, recursion]
updated: 2026-09-03
source: leetcode
number: 21
difficulty: easy
...
judge: none
related_learn: ["learn:w03d01", "learn:w03d07"]
---

# LeetCode 合并两个有序链表 题解

## 1. 题目概述

- **标题 / 题号**：合并两个有序链表（#21，easy）
- **链接**：https://leetcode.cn/problems/merge-two-sorted-lists/
- **难度**：简单
- **标签**：链表、递归

**题意**：将两个升序链表合并为一个新的**升序**链表并返回。新链表由拼接给定的两个链表的所有节点组成（不能新建节点，只能修改 `next` 指针）。
...
> 💡 这是链表的入门模板题。它用最简单的结构引出链表题的两大核心技巧：**哑节点（dummy node）**——用一个虚拟头节点统一处理"头节点为空"的边界；**双指针逐个比较**——利用两个链表已有序的特性，每次取较小者接上。与 [Day 3 三数之和](15_三数之和.md) 的双指针不同，链表的双指针不是"左右夹逼"而是"两路归并"——这正是归并排序的合并步骤。
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 23 | [合并 K 个升序链表](https://leetcode.cn/problems/merge-k-sorted-lists/)（[题解](23_合并K个升序链表.md)） | 分治/堆合并 |
| 148 | [排序链表](https://leetcode.cn/problems/sort-list/)（[题解](../0101-0200/148_排序链表.md)） | 归并排序链表 |
| 21 | [合并两个有序链表](https://leetcode.cn/problems/merge-two-sorted-lists/)（题解） | 哑节点 + 双指针 |

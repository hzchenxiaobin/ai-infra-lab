...
title: 子数组异或查询
tags: [位运算, 前缀和, 数组]
knowledge_points: [array, bit-manipulation, prefix-sum]
updated: 2026-09-03
source: leetcode
number: 1310
difficulty: medium
...
| 304 | [二维区域和检索 - 数组不可变](https://leetcode.cn/problems/range-sum-query-2d-immutable/)（[题解](../0301-0400/304_二维区域和检索%20-%20数组不可变.md)） | 求和前缀和的二维推广，四角容斥 |

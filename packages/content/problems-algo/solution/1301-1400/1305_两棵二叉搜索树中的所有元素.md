...
type: problem
title: 两棵二叉搜索树中的所有元素
tags: [中序遍历, 二叉搜索树, 双指针, 归并, 树]
knowledge_points: [bst, inorder-traversal, merge, tree, two-pointers]
updated: 2026-09-03
source: leetcode
number: 1305
difficulty: medium
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/12/29/q2-e1.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2019/12/29/q2-e5-.png)

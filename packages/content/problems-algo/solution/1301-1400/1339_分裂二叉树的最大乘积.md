...
type: problem
title: 分裂二叉树的最大乘积
tags: [二叉树, 后序遍历, 数学, 树, "深度优先搜索（DFS）"]
knowledge_points: [binary-tree, dfs, math, postorder-traversal, tree]
updated: 2026-09-03
source: leetcode
number: 1339
difficulty: medium
...
# LeetCode 分裂二叉树的最大乘积 题解

## 1. 题目概述

- **标题 / 题号**：分裂二叉树的最大乘积（#1339，medium）
- **链接**：https://leetcode.cn/problems/maximum-product-of-splitted-binary-tree/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索（DFS）、后序遍历、数学

**题意**：给你一棵二叉树，根为 `root`。请你**删除 1 条边**，使二叉树分裂成两棵子树，且它们**子树和的乘积尽可能大**。由于答案可能很大，将结果对 $10^9 + 7$ 取模后返回。

**示例 1**：

![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/02/02/sample_1_1699.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/02/02/sample_2_1699.png)

...
title: 餐厅过滤器
tags: [排序, 数组, 模拟]
knowledge_points: [array, simulation, sorting]
updated: 2026-09-03
source: leetcode
number: 1333
difficulty: medium
...
- **标题 / 题号**：餐厅过滤器（#1333，medium）
- **链接**：https://leetcode.cn/problems/filter-restaurants-by-vegan-friendly-price-and-distance/
- **难度**：中等
- **标签**：数组、排序、模拟

**题意**：给定餐馆信息数组 `restaurants`，其中 `restaurants[i] = [idi, ratingi, veganFriendlyi, pricei, distancei]`。需要使用三个过滤器过滤餐馆：

...
type: problem
title: 获取你好友已观看的视频
tags: [哈希表, 图, 广度优先搜索, 排序]
knowledge_points: [bfs, graph, hash-table, sorting]
updated: 2026-09-03
source: leetcode
number: 1311
difficulty: medium
...
# LeetCode 获取你好友已观看的视频 题解

## 1. 题目概述

- **标题 / 题号**：获取你好友已观看的视频（#1311，medium）
- **链接**：https://leetcode.cn/problems/get-watched-videos-by-your-friends/
- **难度**：中等
- **标签**：广度优先搜索、图、哈希表、排序

**题意**：有 `n` 个人，每个人都有一个 `0` 到 `n-1` 的唯一 `id`。给你数组 `watchedVideos` 和 `friends`，其中 `watchedVideos[i]` 和 `friends[i]` 分别表示 `id = i` 的人观看过的视频列表和他的好友列表。
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/01/03/leetcode_friends_1.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/01/03/leetcode_friends_2.png)

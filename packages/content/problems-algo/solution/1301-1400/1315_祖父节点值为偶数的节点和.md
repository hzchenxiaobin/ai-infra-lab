...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/01/10/1473_ex1.png)
...
| 250 | [统计同值子树](../0201-0300/250_统计同值子树.md) | 后序传递子树判定结果，与本题的「前序/参数下传」对照——一个自底向上、一个自顶向下，覆盖树形遍历两大方向 |

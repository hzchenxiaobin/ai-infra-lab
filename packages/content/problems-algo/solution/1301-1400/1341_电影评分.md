...
type: problem
title: 电影评分
tags: ["GROUP BY", JOIN, LIMIT, "ORDER BY 排序与平局", SQL, "UNION ALL", pandas, 数据库, 日期范围过滤, 聚合]
knowledge_points: [aggregation, database, group-by, join, limit, order-by-排序与平局, pandas, sql, union-all, 日期范围过滤]
updated: 2026-09-03
source: leetcode
number: 1341
difficulty: medium

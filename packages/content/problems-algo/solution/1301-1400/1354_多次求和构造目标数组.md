...
type: problem
title: 多次求和构造目标数组
tags: ["堆（优先队列）", 数学, 数组, 贪心, 逆向思维]
knowledge_points: [array, greedy, heap, math, reverse-thinking]
updated: 2026-09-03
source: leetcode
number: 1354
difficulty: hard
...
# LeetCode 多次求和构造目标数组 题解

## 1. 题目概述

- **标题 / 题号**：多次求和构造目标数组（#1354，hard）
- **链接**：https://leetcode.cn/problems/construct-target-array-with-multiple-sums/
- **难度**：困难
- **标签**：数组、堆（优先队列）、贪心、数学、逆向思维

**题意**：给定一个整数数组 `target`。一开始你有一个数组 `A`，所有元素均为 `1`。你可以执行以下操作任意次：

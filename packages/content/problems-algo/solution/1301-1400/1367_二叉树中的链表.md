...
type: problem
title: 二叉树中的链表
tags: ["KMP 模式匹配", 二叉树, 树, "深度优先搜索（DFS）", 链表]
knowledge_points: [binary-tree, dfs, kmp, linked-list, tree]
updated: 2026-09-03
source: leetcode
number: 1367
difficulty: medium
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/02/29/sample_1_1720.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2020/02/29/sample_2_1720.png)
...
> 💡 把链表看成一条**模式串**，把二叉树的每条「根到叶方向」看成一条**文本串**——问题等价于：模式串是否作为某条文本串的**连续子串**出现。既是「树上路径匹配」，自然联想到 [28. 实现 strStr()](../0001-0100/28_找出字符串中第一个匹配项的下标.md) 的串匹配思路：暴力可过，KMP 更优雅。

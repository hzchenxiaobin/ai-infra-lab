...
title: 满足不等式的数对数目
tags: [分治, 归并排序, 树状数组]
knowledge_points: [divide-and-conquer, fenwick-tree, merge-sort]
updated: 2026-09-03
source: leetcode
number: 2426
difficulty: hard
...
# LeetCode 满足不等式的数对数目 题解

## 1. 题目概述

- **标题 / 题号**：满足不等式的数对数目（#2426，hard）
- **链接**：https://leetcode.cn/problems/number-of-pairs-satisfying-inequality/
- **难度**：困难
- **标签**：分治、归并排序、树状数组

**题意**：给你两个下标从 $0$ 开始、长度均为 $n$ 的整数数组 `nums1` 和 `nums2`，以及一个整数 `diff`。统计满足下列条件的**数对** $(i, j)$ 的数目：

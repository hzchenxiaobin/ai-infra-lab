...
tags: [差分, 数组, 模拟]
knowledge_points: [array, difference-array, simulation]
updated: 2026-09-03
source: leetcode
number: 2432
difficulty: easy
...
# LeetCode 处理用时最长的那个任务的员工 题解

## 1. 题目概述

- **标题 / 题号**：处理用时最长的那个任务的员工（#2432，easy）
- **链接**：https://leetcode.cn/problems/the-employee-that-worked-on-the-longest-task/
- **难度**：简单
- **标签**：数组、模拟、差分

**题意**：共有 $n$ 位员工，id 从 $0$ 到 $n-1$。给定二维数组 `logs`，其中 `logs[i] = [idi, leaveTimei]`：

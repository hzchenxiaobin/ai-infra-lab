...
type: problem
title: 逐层排序二叉树的最少操作数
tags: [二叉树, "广度优先搜索（BFS）", 排序, 树, 置换环]
knowledge_points: [bfs, binary-tree, sorting, tree, 置换环]
updated: 2026-09-03
source: leetcode
number: 2471
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2022/09/18/image-20220918174006-2.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/09/18/image-20220918174026-3.png)
...
![示例3](https://assets.leetcode.com/uploads/2022/09/18/image-20220918174052-4.png)

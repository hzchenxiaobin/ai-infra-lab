...
type: problem
title: 反转二叉树的奇数层
tags: [二叉树, 二叉树性质, "广度优先搜索（BFS）", 树, "深度优先搜索（DFS）"]
knowledge_points: [bfs, binary-tree, dfs, tree, 二叉树性质]
updated: 2026-09-03
source: leetcode
number: 2415
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2022/07/28/first_case1.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/07/28/second_case3.png)

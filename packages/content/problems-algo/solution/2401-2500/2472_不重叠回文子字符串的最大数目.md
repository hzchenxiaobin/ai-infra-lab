...
id: "lc:2472"
type: problem
title: 不重叠回文子字符串的最大数目
tags: [动态规划, 回文, 字符串, 贪心]
knowledge_points: [dynamic-programming, greedy, palindrome, string]
updated: 2026-09-03
source: leetcode
number: 2472
difficulty: hard
...
# LeetCode 不重叠回文子字符串的最大数目 题解

## 1. 题目概述

- **标题 / 题号**：不重叠回文子字符串的最大数目（#2472，hard）
- **链接**：https://leetcode.cn/problems/maximum-number-of-non-overlapping-palindrome-substrings/
- **难度**：困难
- **标签**：字符串、动态规划、回文、贪心

**题意**：给你一个字符串 `s` 和一个**正**整数 `k`。从 `s` 中选出一组满足下列条件且**不重叠**的子字符串：

...
# LeetCode 最大公因数等于 K 的子数组数目 题解

## 1. 题目概述

- **标题 / 题号**：最大公因数等于 K 的子数组数目（#2447，medium）
- **链接**：https://leetcode.cn/problems/number-of-subarrays-with-gcd-equal-to-k/
- **难度**：中等
- **标签**：数组、数学、数论

**题意**：给你一个整数数组 `nums` 和一个整数 `k`，统计并返回 `nums` 的**子数组**中元素的最大公因数（GCD）等于 `k` 的子数组数目。

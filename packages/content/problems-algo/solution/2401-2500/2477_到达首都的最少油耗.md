...
title: 到达首都的最少油耗
tags: [图论, 树, 深度优先搜索, 贪心]
knowledge_points: [dfs, graph, greedy, tree]
updated: 2026-09-03
source: leetcode
number: 2477
difficulty: medium
...
# LeetCode 到达首都的最少油耗 题解

## 1. 题目概述

- **标题 / 题号**：到达首都的最少油耗（#2477，medium）
- **链接**：https://leetcode.cn/problems/minimum-fuel-cost-to-report-to-the-capital/
- **难度**：中等
- **标签**：树、深度优先搜索、图论、贪心

**题意**：给定一棵 `n` 个节点的无向树，节点编号 `0` 到 `n-1`，**节点 `0` 是首都**。`roads[i] = [ai, bi]` 表示城市 `ai`、`bi` 间一条双向路，共 `n-1` 条。每个城市里有一个代表要去首都开会；每个城市有一辆车，每辆车恰好能坐 `seats` 人。相邻城市之间一辆车行驶耗 1 升汽油。代表可坐本城的车，也可坐其他城的车。求所有代表到达首都的**最少总油耗**。

**示例 1**：

![示例1](https://assets.leetcode.com/uploads/2022/09/22/a4c380025e3ff0c379525e96a7d63a3.png)
...
![示例2](https://assets.leetcode.com/uploads/2022/11/16/2.png)
...
![示例3](https://assets.leetcode.com/uploads/2022/09/27/efcf7f7be6830b8763639cfd01b690a.png)

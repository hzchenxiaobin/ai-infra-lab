...
title: 摧毁一系列目标
tags: [同余分组, 哈希表, 数组, 计数]
knowledge_points: [array, counting, hash-table, 同余分组]
updated: 2026-09-03
source: leetcode
number: 2453
difficulty: medium
...
- **标题 / 题号**：摧毁一系列目标（#2453，medium）
- **链接**：https://leetcode.cn/problems/destroy-sequential-targets/
- **难度**：中等
- **标签**：数组、哈希表、计数、同余分组

**题意**：给你一个下标从 **0** 开始的数组 `nums`，它包含若干正整数，表示数轴上你需要摧毁的目标所在的位置。同时给你一个整数 `space`。
...
| 454 | [四数相加 II](https://leetcode.cn/problems/4sum-ii/)（[题解](../0401-0500/454_四数相加%20II.md)） | 分组哈希计数再查补数，同「哈希按键聚簇 + 计数」范式 |

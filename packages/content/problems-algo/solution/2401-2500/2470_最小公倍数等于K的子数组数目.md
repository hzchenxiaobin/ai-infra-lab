...
id: "lc:2470"
type: problem
title: "最小公倍数等于 K 的子数组数目"
tags: [数学, 数组, 数论]
knowledge_points: [array, math, number-theory]
updated: 2026-09-03
source: leetcode
number: 2470
difficulty: medium
...
# LeetCode 最小公倍数等于 K 的子数组数目 题解

## 1. 题目概述

- **标题 / 题号**：最小公倍数等于 K 的子数组数目（#2470，medium）
- **链接**：https://leetcode.cn/problems/number-of-subarrays-with-lcm-equal-to-k/
- **难度**：中等
- **标签**：数组、数学、数论

**题意**：给你一个整数数组 `nums` 和一个整数 `k`，统计并返回 `nums` 的**子数组**中元素的最小公倍数（LCM）等于 `k` 的子数组数目。

...
type: problem
title: 二叉树着色游戏
tags: [二叉树, 博弈, 树, 深度优先搜索]
knowledge_points: [binary-tree, dfs, game-theory, tree]
updated: 2026-09-03
source: leetcode
number: 1145
difficulty: medium
...
- **标题 / 题号**：二叉树着色游戏（#1145，medium）
- **链接**：https://leetcode.cn/problems/binary-tree-coloring-game/
- **难度**：中等
- **标签**：树、二叉树、深度优先搜索、博弈

**题意**：两位玩家在一棵 `n` 个节点（`n` 为奇数）的二叉树上着色。节点值 `1..n` 互不相同。
...
![示例1](https://assets.leetcode.com/uploads/2019/08/01/1480-binary-tree-coloring-game.png)

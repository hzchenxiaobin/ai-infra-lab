...
type: problem
title: 最小的必要团队
tags: [位运算, 动态规划, 状态压缩, 贪心]
knowledge_points: [bit-manipulation, bitmask-dp, dynamic-programming, greedy]
updated: 2026-09-03
source: leetcode
number: 1125
difficulty: hard
...
- **标题 / 题号**：最小的必要团队（#1125，hard）
- **链接**：https://leetcode.cn/problems/smallest-sufficient-team/
- **难度**：困难
- **标签**：位运算、动态规划、状态压缩、贪心

**题意**：作为项目经理，你规划了一份需求的技能清单 `req_skills`，并打算从备选人员名单 `people` 中选出些人组成一个「必要团队」——对于 `req_skills` 中列出的**每项技能**，团队中至少有一名成员已经掌握。请你返回**任一**规模最小的必要团队，团队成员用人员编号表示。

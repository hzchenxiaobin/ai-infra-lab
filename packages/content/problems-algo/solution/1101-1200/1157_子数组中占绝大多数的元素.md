...
title: 子数组中占绝大多数的元素
tags: [二分查找, 数组, 设计, 随机化]
knowledge_points: [array, binary-search, design, randomized]
updated: 2026-09-03
source: leetcode
number: 1157
difficulty: hard
...
# LeetCode 子数组中占绝大多数的元素 题解

## 1. 题目概述

- **标题 / 题号**：子数组中占绝大多数的元素（#1157，hard）
- **链接**：https://leetcode.cn/problems/online-majority-element-in-subarray/
- **难度**：困难
- **标签**：设计、数组、二分查找、随机化

**题意**：设计一个数据结构，有效地找到给定子数组的**多数元素**。子数组的**多数元素**是在子数组中出现 `threshold` 次数或次数以上的元素。

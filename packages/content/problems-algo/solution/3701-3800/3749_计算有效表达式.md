...
type: problem
title: 计算有效表达式
tags: [分治, 哈希表, 字符串, 数学, 栈]
knowledge_points: [divide-and-conquer, hash-table, math, stack, string]
updated: 2026-09-03
source: leetcode
number: 3749
difficulty: hard
...
**题意**：给你一个字符串 `expression` 表示一个算术表达式。题目保证表达式**合法**（题名中的 *valid* 即指输入无需校验），它由以下成分构成：

...
type: problem
title: 互质树
tags: [数学, 数论, 树, 深度优先搜索, 状态维护]
knowledge_points: [dfs, math, number-theory, tree, 状态维护]
updated: 2026-09-03
source: leetcode
number: 1766
difficulty: hard
...
**题意**：给定一棵 $n$ 个节点的**树**（无环连通无向图），节点编号 $0$ 到 $n-1$，**根节点为 0**。每个节点有一个值 `nums[i]`，`edges[j] = [uj, vj]` 表示一条边。
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2021/02/20/untitled-diagram.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2021/02/20/untitled-diagram1.png)

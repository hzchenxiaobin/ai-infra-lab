...
type: problem
title: 苹果和橘子的个数
tags: [IFNULL/COALESCE, "LEFT JOIN", "NULL 处理", SQL, SUM, 外键关联, 数据库, 聚合]
knowledge_points: [aggregation, database, ifnull-coalesce, left-join, null-coalescing, null-handling, sql, sum, 外键关联]
updated: 2026-09-03
source: leetcode
number: 1715
difficulty: medium

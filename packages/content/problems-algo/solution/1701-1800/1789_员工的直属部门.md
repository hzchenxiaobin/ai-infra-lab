...
type: problem
title: 员工的直属部门
tags: ["COUNT() OVER", "GROUP BY", HAVING, SQL, UNION, WHERE, 数据库, 窗口函数]
knowledge_points: [count-over, database, group-by, having, sql, union, where, where-filter, window-function]
updated: 2026-09-03
source: leetcode
number: 1789
difficulty: easy

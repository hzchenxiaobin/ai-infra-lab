...
tags: [动态规划, "区间 DP", 字符串]
knowledge_points: [dynamic-programming, interval-dp, string]
updated: 2026-09-03
source: leetcode
number: 1771
difficulty: hard
...
# LeetCode 由子序列构造的最长回文串的长度 题解

## 1. 题目概述

- **标题 / 题号**：由子序列构造的最长回文串的长度（#1771，hard）
- **链接**：https://leetcode.cn/problems/maximize-palindrome-length-from-subsequences/
- **难度**：困难
- **标签**：字符串、动态规划、区间 DP

**题意**：给你两个字符串 `word1` 和 `word2`，按下述方法构造一个字符串：

...
type: problem
title: 数组中特殊等间距元素的和
tags: [前缀和, 动态规划, 数组, "根号分治（Sqrt Decomposition）"]
knowledge_points: [array, dynamic-programming, prefix-sum, sqrt-decomposition]
updated: 2026-09-03
source: leetcode
number: 1714
difficulty: hard
...
| 304 | [二维区域和检索 - 数组不可变](../0301-0400/304_二维区域和检索%20-%20数组不可变.md) | 二维前缀和预处理、查询 $O(1)$，同为「预计算摊销查询开销」范式（升到二维的容斥版本） |

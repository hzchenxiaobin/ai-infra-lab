...
title: 重构一棵树的方案数
tags: [图, 排序, 树, 贪心]
knowledge_points: [graph, greedy, sorting, tree]
updated: 2026-09-03
source: leetcode
number: 1719
difficulty: hard
...
# LeetCode 重构一棵树的方案数 题解

## 1. 题目概述

- **标题 / 题号**：重构一棵树的方案数（#1719，hard）
- **链接**：https://leetcode.cn/problems/number-of-ways-to-reconstruct-a-tree/
- **难度**：困难
- **标签**：树、图、贪心、排序

**题意**：给定一个数组 `pairs`，其中 `pairs[i] = [xi, yi]`，满足 `xi < yi` 且无重复元素。令 `ways` 为满足以下条件的有根树的方案数：
...
![示例1](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2021/01/09/trees2.png)
...
![示例2](https://assets.leetcode.cn/aliyun-lc-upload/uploads/2021/01/09/tree.png)
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 236 | [二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)（[题解](../0201-0300/236_二叉树的最近公共祖先.md)） | 理解祖先-后代关系的基础题，LCA 是树上祖孙链的经典应用 |

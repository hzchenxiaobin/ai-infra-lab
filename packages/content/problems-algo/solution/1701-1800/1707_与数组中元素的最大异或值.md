...
type: problem
title: 与数组中元素的最大异或值
tags: [位运算, 字典树, 数组, 离线处理]
knowledge_points: [array, bit-manipulation, offline-processing, trie]
updated: 2026-09-03
source: leetcode
number: 1707
difficulty: hard
...
# LeetCode 与数组中元素的最大异或值 题解

## 1. 题目概述

- **标题 / 题号**：与数组中元素的最大异或值（#1707，hard）
- **链接**：https://leetcode.cn/problems/maximum-xor-with-an-element-from-array/
- **难度**：困难
- **标签**：位运算、字典树、数组、离线处理

**题意**：给定一个由**非负整数**组成的数组 `nums`，以及一个查询数组 `queries`，其中 `queries[i] = [x_i, m_i]`。

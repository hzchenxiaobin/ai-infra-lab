...
type: problem
title: 未知网格中的最短路径
tags: [交互, 广度优先搜索, 深度优先搜索]
knowledge_points: [bfs, dfs, interactive, 交互]
updated: 2026-09-03
source: leetcode
number: 1778
difficulty: medium
...
# LeetCode 未知网格中的最短路径 题解

## 1. 题目概述

- **标题 / 题号**：未知网格中的最短路径（#1778，medium）
- **链接**：https://leetcode.cn/problems/shortest-path-in-a-hidden-grid/
- **难度**：中等
- **标签**：深度优先搜索、广度优先搜索、交互

**题意**：这是一道**交互题**。在一个未知的网格中，机器人从 $(0, 0)$ 出发，目标是到达网格中的**目标格**。你无法直接看到网格——只能通过 `GridMaster` 接口与机器人交互来逐步探索。

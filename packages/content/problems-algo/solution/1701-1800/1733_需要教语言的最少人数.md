...
title: 需要教语言的最少人数
tags: [哈希表, 枚举, 社交网络, 贪心]
knowledge_points: [enumeration, greedy, hash-table, 社交网络]
updated: 2026-09-03
source: leetcode
number: 1733
difficulty: medium
...
# LeetCode 需要教语言的最少人数 题解

## 1. 题目概述

- **标题 / 题号**：需要教语言的最少人数（#1733，medium）
- **链接**：https://leetcode.cn/problems/minimum-number-of-people-to-teach/
- **难度**：中等
- **标签**：贪心、枚举、哈希表、社交网络

**题意**：在一个由 $m$ 个用户组成的社交网络里，两个好友能相互沟通的条件是**他们都掌握同一门语言**。给你：

...
type: problem
title: 访问日期之间最大的空档期
tags: [COALESCE, DATEDIFF, "GROUP BY", LEAD, MAX, SQL, 哨兵默认值, 数据库, 相关子查询, 窗口函数]
knowledge_points: [coalesce, correlated-subquery, database, datediff, group-by, lead, max, sql, window-function, 哨兵默认值]
updated: 2026-09-03
source: leetcode
number: 1709
difficulty: medium

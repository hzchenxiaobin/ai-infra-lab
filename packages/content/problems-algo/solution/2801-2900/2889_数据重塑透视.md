...
type: problem
title: "数据重塑：透视"
tags: ["DataFrame 重塑", Pandas, "透视（长表转宽表）"]
knowledge_points: [pandas, pandas-pivot, pandas-reshaping]
updated: 2026-09-03
source: leetcode
number: 2889
difficulty: easy
...
- **标题 / 题号**：数据重塑：透视（#2889，easy）
- **链接**：https://leetcode.cn/problems/reshape-data-pivot/
- **难度**：简单
- **标签**：Pandas、DataFrame 重塑、透视（长表转宽表）

**题意**：编写一个解决方案，将 DataFrame `weather` 的数据**旋转（pivot）**，使得**每一行代表特定月份的温度，而每个城市都是一个单独的列**。

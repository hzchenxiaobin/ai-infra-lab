...
id: "lc:2842"
type: problem
title: "统计一个字符串的 k 子序列美丽值最大的数目"
tags: [哈希表, 排序, 数学, 组合数学, 贪心, 费马小定理]
knowledge_points: [combinatorics, fermat-little-theorem, greedy, hash-table, math, sorting]
updated: 2026-09-03
source: leetcode
number: 2842
difficulty: hard
...
# LeetCode 统计一个字符串的 k 子序列美丽值最大的数目 题解

## 1. 题目概述

- **标题 / 题号**：统计一个字符串的 k 子序列美丽值最大的数目（#2842，hard）

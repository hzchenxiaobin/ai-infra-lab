...
title: "美丽塔 I"
tags: [动态规划, 单调栈, 数组, 栈]
knowledge_points: [array, dynamic-programming, monotonic-stack, stack]
updated: 2026-09-03
source: leetcode
number: 2865
difficulty: medium
...
- **标题 / 题号**：美丽塔 I（#2865，medium）
- **链接**：https://leetcode.cn/problems/beautiful-towers-i/
- **难度**：中等
- **标签**：栈、数组、单调栈、动态规划

**题意**：给定一个包含 $n$ 个整数的数组 `heights`，表示 $n$ 座**连续的塔**中砖块的数量。你的任务是**移除一些砖块**来形成一个**山脉状**的塔排列。在这种布置中，塔高度先是**非递减**，有一个或多个连续塔达到**最大峰值**，然后**非递增**排列。

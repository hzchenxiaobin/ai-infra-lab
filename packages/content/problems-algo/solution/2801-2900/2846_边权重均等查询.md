...
type: problem
title: 边权重均等查询
tags: [倍增, 前缀和, 最近公共祖先, 树, 深度优先搜索]
knowledge_points: [binary-lifting, dfs, lca, prefix-sum, tree]
updated: 2026-09-03
source: leetcode
number: 2846
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2023/08/11/graph-6-1.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/08/11/graph-9-1.png)

...
type: problem
title: 找出最安全路径
tags: [二分查找, "堆（优先队列）", 并查集, 广度优先搜索, 矩阵]
knowledge_points: [bfs, binary-search, heap, matrix, union-find, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2812
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2023/07/02/example1.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/07/02/example2.png)
...
![示例3](https://assets.leetcode.com/uploads/2023/07/02/example3.png)

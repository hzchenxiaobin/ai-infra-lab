...
id: "lc:2817"
type: problem
title: 限制条件下元素之间的最小绝对差
tags: [二分查找, 数组, 有序集合]
knowledge_points: [array, binary-search, ordered-set]
updated: 2026-09-03
source: leetcode
number: 2817
difficulty: medium
...
# LeetCode 限制条件下元素之间的最小绝对差 题解

## 1. 题目概述

- **标题 / 题号**：限制条件下元素之间的最小绝对差（#2817，medium）
- **链接**：https://leetcode.cn/problems/minimum-absolute-difference-between-elements-with-constraint/
- **难度**：中等
- **标签**：数组、二分查找、有序集合

**题意**：给你一个下标从 **0** 开始的整数数组 `nums` 和一个整数 `x`。请你找到数组中下标距离至少为 $x$ 的两个元素的**差值绝对值**的**最小值**。

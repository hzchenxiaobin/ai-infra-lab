...
title: 统计范围内的步进数字数目
tags: [动态规划, 字符串]
knowledge_points: [dynamic-programming, string]
updated: 2026-09-03
source: leetcode
number: 2801
difficulty: hard
...
# LeetCode 统计范围内的步进数字数目 题解

## 1. 题目概述

- **标题 / 题号**：统计范围内的步进数字数目（#2801，hard）
- **链接**：https://leetcode.cn/problems/count-stepping-numbers-in-range/
- **难度**：困难
- **标签**：字符串、动态规划

**题意**：给你两个正整数 `low` 和 `high`，都用字符串表示，请你统计闭区间 $[low, high]$ 内的**步进数字**数目。

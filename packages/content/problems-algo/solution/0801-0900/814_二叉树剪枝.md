...
type: problem
title: 二叉树剪枝
tags: [DFS, 二叉树, 后序遍历, 树, 递归]
knowledge_points: [binary-tree, dfs, postorder-traversal, recursion, tree]
updated: 2026-09-03
source: leetcode
number: 814
difficulty: medium
...
- **标题 / 题号**：二叉树剪枝（#814，medium）
- **链接**：https://leetcode.cn/problems/binary-tree-pruning/
- **难度**：中等
- **标签**：树、二叉树、递归、后序遍历、DFS

**题意**：给定一棵二叉树的根节点 `root`，树中每个节点的值要么是 `0` 要么是 `1`。要求**剪除所有不包含 `1` 的子树**，返回剪枝后的根节点。

> **子树定义**：一个节点 `node` 的子树包括 `node` 本身及其所有后代。

**示例 1**：

![示例1](https://s3-lc-upload.s3.amazonaws.com/uploads/2018/04/06/1028_2.png)
...
![示例2](https://s3-lc-upload.s3.amazonaws.com/uploads/2018/04/06/1028_1.png)
...
![示例3](https://s3-lc-upload.s3.amazonaws.com/uploads/2018/04/05/1028.png)

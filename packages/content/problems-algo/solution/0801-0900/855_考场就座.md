...
title: 考场就座
tags: [有序集合, 设计, 贪心]
knowledge_points: [design, greedy, ordered-set]
updated: 2026-09-03
source: leetcode
number: 855
difficulty: medium
...
| # | 题目 | 与本题的关联 |
|---|------|-------------|
| 849 | [到最近的人的最大距离](https://leetcode.cn/problems/maximize-distance-to-closest-person/)（[题解](./849_到最近的人的最大距离.md)） | 本题的静态版，给定固定座位数组求一次最优座位，共享三类区间距离公式，用两次遍历 `O(n)` 解决 |

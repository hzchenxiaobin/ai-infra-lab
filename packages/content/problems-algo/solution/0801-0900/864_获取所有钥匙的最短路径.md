...
type: problem
title: 获取所有钥匙的最短路径
tags: [位运算, 广度优先搜索, 状态压缩, 网格图]
knowledge_points: [bfs, bit-manipulation, bitmask-dp, grid-graph]
updated: 2026-09-03
source: leetcode
number: 864
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2021/07/23/lc-keys2.jpg)
...
![示例2](https://assets.leetcode.com/uploads/2021/07/23/lc-key2.jpg)
...
![示例3](https://assets.leetcode.com/uploads/2021/07/23/lc-keys3.jpg)

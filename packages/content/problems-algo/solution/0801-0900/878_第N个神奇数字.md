...
title: 第N个神奇数字
tags: [二分查找, 容斥原理, 数学]
knowledge_points: [binary-search, inclusion-exclusion, math]
updated: 2026-09-03
source: leetcode
number: 878
difficulty: hard
...
- **标题 / 题号**：第N个神奇数字（#878，hard）
- **链接**：https://leetcode.cn/problems/nth-magical-number/
- **难度**：困难
- **标签**：数学、二分查找、容斥原理

**题意**：一个正整数如果能被 `a` **或** `b` 整除，则它是「神奇数」。给定三个整数 `n`、`a`、`b`，返回第 `n` 个神奇数。由于答案可能非常大，返回它对 $10^9 + 7$ 取模的结果。

...
title: 保持城市天际线
tags: [数组, 矩阵, 贪心]
knowledge_points: [array, greedy, matrix, 矩阵]
updated: 2026-09-03
source: leetcode
number: 807
difficulty: medium
...
- **标题 / 题号**：保持城市天际线（#807，medium）
- **链接**：https://leetcode.cn/problems/max-increase-to-keep-city-skyline/
- **难度**：中等
- **标签**：数组、贪心、矩阵

**题意**：给定一个 $n \times n$ 的矩阵 `grid`，其中 `grid[r][c]` 表示位于第 `r` 行第 `c` 列的建筑物高度。城市的**天际线**是从东、南、西、北四个主要方向观察时所有建筑物形成的外部轮廓。
...
![示例1](https://assets.leetcode.com/uploads/2021/06/21/807-ex1.png)

...
title: 情感丰富的文字
tags: [双指针, 字符串, 数组]
knowledge_points: [array, string, two-pointers]
updated: 2026-09-03
source: leetcode
number: 809
difficulty: medium
...
- **标题 / 题号**：情感丰富的文字（#809，medium）
- **链接**：https://leetcode.cn/problems/expressive-words/
- **难度**：中等
- **标签**：数组、双指针、字符串

**题意**：有时候人们会用重复写一些字母来表示额外的感受，比如 `"hello" -> "heeellooo"`, `"hi" -> "hiii"`。将相邻字母都相同的一串字符定义为**相同字母组**，例如 `"h", "eee", "ll", "ooo"`。

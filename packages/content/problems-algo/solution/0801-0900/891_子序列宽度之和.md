...
title: 子序列宽度之和
tags: [排序, 数学, 数组, 贡献法]
knowledge_points: [array, contribution-technique, math, sorting]
updated: 2026-09-03
source: leetcode
number: 891
difficulty: hard
...
- **标题 / 题号**：子序列宽度之和（#891，hard）
- **链接**：https://leetcode.cn/problems/sum-of-subsequence-widths/
- **难度**：困难
- **标签**：数组、数学、排序、贡献法

**题意**：一个序列的**宽度**定义为该序列中最大元素和最小元素的差值。给定一个整数数组 `nums`，返回 `nums` 的所有**非空子序列**的宽度之和。由于答案可能很大，返回对 $10^9 + 7$ 取余后的结果。

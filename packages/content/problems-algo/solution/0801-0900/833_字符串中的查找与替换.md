...
![示例1](https://assets.leetcode.com/uploads/2021/06/12/833-ex1.png)
...
![示例2](https://assets.leetcode.com/uploads/2021/06/12/833-ex2-1.png)
...
| 890 | [查找和替换模式](https://leetcode.cn/problems/find-and-replace-pattern/) | 同名"查找与替换"但实为模式双射匹配（[205. 同构字符串](../0201-0300/205_同构字符串.md) 的多串版），作对比避免按题名混淆 |

...
type: problem
title: "二叉树的堂兄弟节点 II"
tags: [二叉树, 哈希表, 广度优先搜索, 树, 深度优先搜索]
knowledge_points: [bfs, binary-tree, dfs, hash-table, tree]
updated: 2026-09-03
source: leetcode
number: 2641
difficulty: medium
...
# LeetCode 二叉树的堂兄弟节点 II 题解

## 1. 题目概述

- **标题 / 题号**：二叉树的堂兄弟节点 II（#2641，medium）
- **链接**：https://leetcode.cn/problems/cousins-in-binary-tree-ii/
- **难度**：中等
- **标签**：树、深度优先搜索、广度优先搜索、哈希表、二叉树

**题意**：给你一棵二叉树的根 `root`，请你将**每个节点的值**替换成该节点的所有**堂兄弟节点值之和**。
...
![示例1](https://assets.leetcode.com/uploads/2023/01/11/example11.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/01/11/diagram33.png)

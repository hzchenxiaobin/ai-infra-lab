...
type: problem
title: 复合函数
tags: [函数式编程, 右折叠, 数组, 高阶函数]
knowledge_points: [array, functional-programming, higher-order-function, 右折叠]
updated: 2026-09-03
source: leetcode
number: 2629
difficulty: easy
...
- **标题 / 题号**：复合函数（#2629，easy）
- **链接**：https://leetcode.cn/problems/function-composition/
- **难度**：简单
- **标签**：函数式编程、高阶函数、数组、右折叠

**题意**：给定一个函数数组 `[f1, f2, f3, …, fn]`，请编写并返回一个新的函数 `fn`，它是该数组的**复合函数**（function composition）。

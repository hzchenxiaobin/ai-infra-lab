...
type: problem
title: 网格图中鱼的最大数目
tags: [BFS, DFS, 图, 并查集, 数组, 矩阵, 连通分量]
knowledge_points: [array, bfs, connected-components, dfs, graph, matrix, union-find, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2658
difficulty: medium
...
![示例1](https://assets.leetcode.com/uploads/2023/03/29/example.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/03/29/example2.png)

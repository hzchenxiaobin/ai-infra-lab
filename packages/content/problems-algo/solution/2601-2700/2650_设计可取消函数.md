...
type: problem
title: 设计可取消函数
tags: [Promise, 异步, 生成器, 设计]
knowledge_points: [async, design, generator, promise]
updated: 2026-09-03
source: leetcode
number: 2650
difficulty: hard
...
- **标题 / 题号**：设计可取消函数（#2650，hard）
- **链接**：https://leetcode.cn/problems/design-cancellable-function/
- **难度**：困难
- **标签**：生成器、Promise、异步、设计

**题意**：写一个 `cancellable(generator)` 函数，接收一个**生成器对象**，返回 `[cancel, promise]`：

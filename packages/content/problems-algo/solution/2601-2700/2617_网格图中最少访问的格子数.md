...
type: problem
title: 网格图中最少访问的格子数
tags: [单调栈, "堆（优先队列）", 并查集, 广度优先搜索, 数组, 矩阵]
knowledge_points: [array, bfs, heap, matrix, monotonic-stack, union-find, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2617
difficulty: hard
...
![示例1](https://assets.leetcode.com/uploads/2023/01/25/ex1.png)
...
![示例2](https://assets.leetcode.com/uploads/2023/01/25/ex2.png)
...
![示例3](https://assets.leetcode.com/uploads/2023/01/26/ex3.png)

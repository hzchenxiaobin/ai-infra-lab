...
type: problem
title: 将对象数组转换为矩阵
tags: [JSON, 深度优先搜索, 矩阵, 递归]
knowledge_points: [dfs, json, matrix, recursion, 矩阵]
updated: 2026-09-03
source: leetcode
number: 2675
difficulty: hard
...
# LeetCode 将对象数组转换为矩阵 题解

## 1. 题目概述

- **标题 / 题号**：将对象数组转换为矩阵（#2675，hard）
...
**题意**：给定一个 **JSON 对象数组** `arr`，将其转换为一个**二维矩阵**（二维数组）。规则如下：

...
> 💡 提交后在 [LeetGPU INT8 KV-Cache Attention](https://leetgpu.com/challenges/int8-kv-cache-attention) 上记录通过耗时，重点观察 INT8 KV cache 相比 FP32 的带宽节省。完整题解见 <a target="_blank" rel="noopener" href="/problems/gpu/medium/96-int8-kv-cache-attention">INT8 KV-Cache Attention 题解</a>。

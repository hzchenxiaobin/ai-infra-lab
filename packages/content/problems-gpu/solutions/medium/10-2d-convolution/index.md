...
> 📎 完整可编译代码已整理到 <a href="./10-2d-convolution.cu" download><code>10-2d-convolution.cu</code></a>（含 host 端测试 harness，编译与运行命令见文件头注释，用于本地自测与 profiling）。
...
```bash
nvcc -O3 -arch=sm_120 10-2d-convolution.cu -o conv2d
./conv2d 4096 4096 3
./conv2d 4096 4096 5
```

...
> 📎 完整可编译代码已整理到 <a href="./63-interleave.cu" download><code>63-interleave.cu</code></a>（含 host 端测试 harness，编译与运行命令见文件头注释，用于本地自测与 profiling）。
...
nvcc -O3 -arch=sm_120 63-interleave.cu -o interleave
